...
## Corpus Check
- 391 files · ~435,919 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5807 nodes · 15245 edges · 311 communities (302 shown, 9 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1730 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a311eca9`
...
1. `CompetitionId` - 170 edges
2. `ClassDefinition` - 165 edges
3. `CompetitorId` - 161 edges
4. `Soarscore.Domain.PublishedClassDefinition` - 159 edges
5. `Soarscore.Domain.Competitions` - 129 edges
6. `Result` - 119 edges
7. `EntryId` - 89 edges
8. `Soarscore.Domain.People` - 88 edges
9. `Soarscore.SeedData` - 88 edges
10. `Soarscore.Domain` - 86 edges
...
Cohesion: 0.06
Nodes (41): ReflightRole, Entitled, Filler, Original, ReflightSelection, BetterOf, NotPermitted, Replacement (+33 more)
...
### Community 2 - ".Build"
Cohesion: 0.05
Nodes (61): ICommand, ICommandHandler, IHttpMaxRequestBodySizeFeature, WebApplication, Commands, IReadOnlyList, WebApplication, Composition (+53 more)

### Community 3 - "FakeEntryQuery"
Cohesion: 0.09
Nodes (40): CancellationToken, IClock, IEventStore, Task, BindParameterHandler, CancellationToken, IClock, IEventStore (+32 more)
...
Cohesion: 0.07
Nodes (42): CountLetters, Echo, IServiceProvider, CancellationToken, IServiceProvider, Task, Type, Dispatcher (+34 more)
...
### Community 9 - ".New"
Cohesion: 0.14
Nodes (13): FieldOp, Fact, InlineData, Theory, CompetitionDecideTests, Fact, Gen, Index (+5 more)

### Community 10 - "People/TestDoubles.cs"
Cohesion: 0.29
...
### Community 11 - "ResolvedTask"
Cohesion: 0.08
Nodes (26): Bindings, ClassDef, ExpectedRawScore, AllFlights, FlightSelection, RateTerm, Cap, CapScope (+18 more)

### Community 12 - "PrescribeDrawDecideTests"
Cohesion: 0.17
Nodes (10): IReadOnlyList, PrescribedGroup, PrescribedRound, DateTimeOffset, Dictionary, Fact, ImmutableArray, IReadOnlyDictionary (+2 more)

### Community 13 - ".Aggregate"
Cohesion: 0.15
Nodes (23): aggregate, dropped, DropPolicy, ApplyWhenResultsAtLeast, ApplyWhenRoundsCompletedAtLeast, Dimension, DropCount, ImmutableArray (+15 more)

### Community 14 - ".New"
Cohesion: 0.13
Nodes (13): Group, CompetitorRegistered, ReflightGroupAppended, Store, ArgumentException, Competition, DateTimeOffset, Fact (+5 more)

### Community 15 - "PublishClassDefinition"
Cohesion: 0.09
...
Cohesion: 0.04
Nodes (60): Soarscore.Infrastructure.Competitions, Soarscore.Infrastructure.Tests, Soarscore.Infrastructure.CompetitionClasses, Soarscore.Infrastructure.People, Soarscore.Application.Tests.Queries.Competitions, Soarscore.Application.Queries.People, Soarscore.Infrastructure, Soarscore.Application.Queries.Competitions (+52 more)
...
Cohesion: 0.05
Nodes (56): CancellationToken, IClock, IEventStore, ImmutableArray, Task, FinaliseCompetition, FinaliseCompetitionHandler, CancellationToken (+48 more)

### Community 19 - "PhaseDrawn"
Cohesion: 0.13
Nodes (16): ImmutableArray, Penalty, ReflightRuling, Round, CompetitionEvent, CompetitorWithdrawn, DrawRejected, Finalised (+8 more)
...
### Community 27 - "LookupRow"
Cohesion: 0.15
Nodes (11): Builder, Rows, CapScope, PerFlight, PerTask, ConstantTerm, Value, LookupRow (+3 more)
...
### Community 29 - ".New"
Cohesion: 0.13
Nodes (15): TaskRoundState, Annulled, Complete, Drawn, InProgress, DateTimeOffset, Fact, EntryTests (+7 more)

### Community 30 - ".Of"
Cohesion: 0.15
Nodes (7): Fact, InlineData, Theory, BindParameterDecideTests, Fact, ImmutableArray, CaptureMeasurementDecideTests

### Community 31 - "CompetitorId"
Cohesion: 0.11
...
Cohesion: 0.15
Nodes (18): FlightPlan, Amendment, At, By, NewValue, Reason, DateTimeOffset, Penalty (+10 more)

### Community 36 - "GroupId"
Cohesion: 0.14
Nodes (12): GroupId, Dictionary, Given, Group, HttpClient, HttpResponseMessage, List, ProblemDetails (+4 more)
...
### Community 40 - ".Exact"
Cohesion: 0.19
Nodes (17): IClassFixture, CancellationToken, IClock, IEventStore, Task, DrawPhaseHandler, AdoptedRules, DateTimeOffset (+9 more)

### Community 41 - ".SeedOpenEntryWithFlight"
Cohesion: 0.19
Nodes (13): CancellationToken, IClock, IEventStore, Task, CaptureMeasurementHandler, Competition, TaskResolver, DateTimeOffset (+5 more)
...
Cohesion: 0.20
Nodes (16): AccruedInfo, PenaltyDefinition, Accrual, Effects, ExclusionGroups, PenaltyEffectSpec, Dictionary, HashSet (+8 more)
...
### Community 47 - ".Interpret"
Cohesion: 0.17
Nodes (9): IReadOnlyDictionary, FlightResult, FlightResultState, NoResult, Valid, ResolvedMeasurements, ArgumentException, Fact (+1 more)

### Community 48 - "Competition"
Cohesion: 0.10
Nodes (21): DateOnly, Defect, Penalty, PenaltyRecorded, ReflightRuling, TaskRoundCoordinate, Competition, AdoptedRules (+13 more)

### Community 49 - "ScoringVocabulary.cs"
Cohesion: 0.06
Nodes (36): Comparator, EqualTo, GreaterOrEqual, GreaterThan, LessOrEqual, LessThan, TargetAssignment, AnyOrder (+28 more)
...
### Community 54 - "WithdrawCompetitorHandler"
Cohesion: 0.22
...
Cohesion: 0.24
Nodes (13): CancellationToken, IClock, IEventStore, Task, OpenFlightHandler, DateTimeOffset, Fact, FakeEventStore (+5 more)

### Community 59 - "ReflightRule"
Cohesion: 0.14
Nodes (14): Role, ReflightRule, EntitledScores, MinNewGroupSize, OthersScore, Competitors, DateTimeOffset, Dictionary (+6 more)
...
Cohesion: 0.10
Nodes (22): ResolvedSchedule, Group, Func, ImmutableArray, Group, CompetitorRefs, Id, Ordinal (+14 more)

### Community 66 - ".SeedOpenEntryWithFlight"
Cohesion: 0.17
...
### Community 68 - ".BuildCompetitionWithPenalties"
Cohesion: 0.16
...
Cohesion: 0.15
Nodes (12): DateTimeOffset, TaskRoundAnnulled, TaskRoundCompleted, TaskRoundReopened, Fact, Fact, Fact, DateTimeOffset (+4 more)

### Community 81 - ".BuildDispatcher"
Cohesion: 0.27
...
Cohesion: 0.08
Nodes (25): PromotionRule, CarryPenalties, Kind, MaxGroupSize, MinGroupSize, TopN, TopPercent, DropDimension (+17 more)
...
### Community 91 - ".DrawnCompetitionAsync"
Cohesion: 0.19
Nodes (14): CancellationToken, IClock, IEventStore, IReadOnlyList, Task, AppendReflightGroup, AppendReflightGroupHandler, Competitors (+6 more)
...
### Community 93 - "Result"
Cohesion: 0.14
Nodes (16): IReadOnlyList, Result, Code, Defects, IsFailure, IsSuccess, Message, Value (+8 more)

### Community 94 - "Soarscore.Application.Commands.People"
Cohesion: 0.20
Nodes (5): Soarscore.Application.Shared.People, Soarscore.Application.Commands.People, Soarscore.Acceptance.Tests.Support, Soarscore.Application.Queries.Scoring, Soarscore.Acceptance.Tests.Steps

### Community 95 - "PhaseAggregatorTests"
Cohesion: 0.36
...
Cohesion: 0.06
Nodes (35): minRounds, minTasks, outcomes, RoundOutcome, ImmutableArray, PhaseDefinition, Drops, Ordinal (+27 more)
...
### Community 123 - "PrescribeDrawPropertyTests"
Cohesion: 0.31
Nodes (7): Mutation, DateTimeOffset, Fact, IReadOnlyList, Rounds, PrescribeDrawPropertyTests, WithdrawnId

### Community 124 - "ScoringResultTypes.cs"
Cohesion: 0.15
Nodes (14): ImmutableArray, ImmutableDictionary, GroupResult, PenaltyApplication, SelectedFlights, TaskResult, TaskResultState, NoResult (+6 more)
...
### Community 133 - "MetricDefinition"
Cohesion: 0.13
Nodes (16): RoundingMode, Ceiling, HalfUp, Truncate, MetricDefinition, DeclaredBeforeLaunch, Kind, Name (+8 more)
...
Cohesion: 0.31
Nodes (7): IEventStore, ExpectedVersion, Guid, IReadOnlyList, List, RecordedEvent, FakeEventStore
...
### Community 145 - "GroupConstraint"
Cohesion: 0.21
Nodes (7): Ref, GroupConstraint, MinPerGroup, MinValidResults, DateTimeOffset, Fact, BindParameterPropertyTests

### Community 146 - "SystemClock"
Cohesion: 0.17
...
### Community 149 - "CompetitionModelBasedFoldTests"
Cohesion: 0.20
...
Cohesion: 0.11
Nodes (15): CompetitionProjection, AdoptedRules, AdoptedAt, Definition, SourceClassId, SourceVersion, Fact, Gen (+7 more)
...
Cohesion: 0.17
Nodes (16): IReadOnlyList, WebApplication, Queries, CancellationToken, IReadOnlyList, Task, FindPeople, FindPeopleHandler (+8 more)
...
### Community 181 - "RegisterCompetitorPropertyTests"
Cohesion: 0.24
...
### Community 204 - "Soarscore.Application.Commands.Competitions"
Cohesion: 0.15
Nodes (13): Soarscore.Application.Commands.Competitions, Soarscore.Application.Tests.Shared.Competitions, Soarscore.Application.Tests.Commands.Competitions, IClock, DateTimeOffset, FakeClock, UtcNow, DateTimeOffset (+5 more)

### Community 205 - "EndpointRouteBuilderExtensions"
Cohesion: 0.28
...
### Community 210 - "TaskRoundRecording.cs"
Cohesion: 0.23
Nodes (14): CancellationToken, Competition, Entry, IEventStore, ImmutableArray, IReadOnlyDictionary, Task, EntryGapsView (+6 more)

### Community 211 - "Finalisation"
Cohesion: 0.29
Nodes (7): Finalisation, At, By, DeclaredResults, Revision, Scope, FinalisationScope

### Community 212 - "SeedF3J"
Cohesion: 0.22
...
### Community 217 - "F5J — RC Electric Powered Thermal Duration Gliders"
Cohesion: 0.25
...
### Community 234 - ".New"
Cohesion: 0.08
Nodes (28): Id, Competition, DateOnly, CompetitionCreated, DrawAccepted, LastFlight, Competition, DateTimeOffset (+20 more)
...
### Community 246 - "NZ ALES — Generally Applicable Rules"
Cohesion: 0.33
...
### Community 251 - "DateTimeOffset"
Cohesion: 0.18
Nodes (9): DateTimeOffset, Result, ParameterBinding, At, BoundValue, By, ParameterName, PhaseOrdinal (+1 more)

### Community 252 - "ClassDefinitionIngestion"
Cohesion: 0.53
Nodes (3): JsonSerializerOptions, List, ClassDefinitionIngestion

### Community 253 - "SeedF5L"
Cohesion: 0.33
...
### Community 255 - "ICompetitionsQuery"
Cohesion: 0.14
...
### Community 256 - "SeedF3B"
Cohesion: 0.40
Nodes (5): SeedF3B, Definition, TaskA, TaskB, TaskC

### Community 259 - "IDomainEvent"
Cohesion: 0.22
Nodes (12): IDomainEvent, Store, CancellationToken, ExpectedVersion, Guid, IReadOnlyDictionary, IReadOnlyList, List (+4 more)
...
### Community 273 - "EntryEventJsonTests"
Cohesion: 0.47
Nodes (3): DateTimeOffset, Fact, EntryEventJsonTests

### Community 275 - "TaskTiming"
Cohesion: 0.24
Nodes (8): TaskTiming, Kind, MaxLaunches, PreparationTime, WorkingTime, Fact, ImmutableArray, ResolvedWorkingTimeTests
...
### Community 320 - "EntryModelBasedFoldTests"
Cohesion: 0.20
Nodes (8): Fact, Gen, GenOperation, IEnumerable, EntryModelBasedFoldTests, MeasurementModel, AmendmentCount, Metric

## Knowledge Gaps
- **1768 isolated node(s):** `context7`, `rider`, `$schema`, `.opencode/plugins/graphify.js`, `$(SoarscoreTargetFramework)` (+1763 more)
...
- **Why does `ClassDefinition` connect `ClassDefinition` to `.ScoreCompetition`, `.Build`, `FakeEntryQuery`, `GetCompetition`, `TaskDefinition`, `DrawAcceptanceEventStoreTests`, `CatalogueDrawPropertyTests`, `.New`, `ResolvedTask`, `PrescribeDrawDecideTests`, `.New`, `PublishClassDefinition`, `EntryId`, `CompetitionId`, `PhaseDrawn`, `MeasuredValue`, `Then`, `.New`, `.Of`, `CompetitorId`, `.CheckLimits`, `GroupId`, `AcceptingTheDrawSteps`, `ScoringACompetitionSteps`, `.Exact`, `.SeedOpenEntryWithFlight`, `PenaltyDefinition`, `When`, `.SeedCompetition`, `WithdrawCompetitorHandler`, `FinaliseDecideTests`, `.SeedOpenEntry`, `ReflightRule`, `ClassDefinitionPublished`, `.SeedOpenEntryWithFlight`, `IStoreFixture`, `.BuildCompetitionWithPenalties`, `.Rank`, `.CompetitionAdopting`, `.SetUpAsync`, `.BuildDrawnCompetition`, `.Validate`, `.DrawnCompetitionAsync`, `.DrawnCompetitionAsync`, `DrawAcceptanceDecideTests`, `SeedF3K`, `CompetitionReplaceTaskRoundPropertyTests`, `.BuildDispatcher`, `.SeedCompetition`, `SeeingWhatIsRecordedSteps`, `DrawAcceptancePropertyTests`, `PhaseDefinition`, `.HandleAsync`, `PrescribeDrawPropertyTests`, `ScoringResultTypes.cs`, `PublishedClassDefinition`, `SeedF5K`, `GroupConstraint`, `SystemClock`, `.SeedCompetition`, `.SeedRegisteredCompetitors`, `CompetitionModelBasedFoldTests`, `.BuildDrawnCompetition`, `TaskRoundClosurePropertyTests`, `AdoptedRules`, `PersonSummary`, `RegisterCompetitorPropertyTests`, `ClassDefinitionValidationPropertyTests`, `SeedF3J`, `.New`, `SeedF5L`, `SeedF3B`, `CreateCompetitionPropertyTests`, `RulesAmendment`, `Corpus.cs`, `ClassDefinitionEventJsonTests`, `ClassDefinitionProjectionPropertyTests`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `CompetitorId` connect `CompetitorId` to `.ScoreCompetition`, `Soarscore.Domain.PublishedClassDefinition`, `.Build`, `FakeEntryQuery`, `IDomainEvent`, `GetCompetition`, `DrawAcceptanceEventStoreTests`, `CatalogueDrawPropertyTests`, `.New`, `PrescribeDrawDecideTests`, `Competitor`, `EntryId`, `SystemClock`, `CompetitionId`, `PhaseDrawn`, `.SeedRegisteredCompetitors`, `EntryEventJsonTests`, `EntryCapturePropertyTests`, `Then`, `.New`, `.Of`, `Entry`, `AnnulEntryDecideTests`, `GroupId`, `AcceptingTheDrawSteps`, `ScoringACompetitionSteps`, `AmendMeasurementDecideTests`, `FlightOpened`, `.BuildDrawnCompetition`, `Penalty`, `OpenFlightDecideTests`, `TaskRoundClosurePropertyTests`, `.Exact`, `TaskRoundRecordingPropertyTests`, `Competition`, `When`, `.SeedCompetition`, `WithdrawCompetitorHandler`, `FinaliseDecideTests`, `ReflightRule`, `TaskRound`, `IStoreFixture`, `.BuildCompetitionWithPenalties`, `.SetUpAsync`, `.BuildDrawnCompetition`, `TaskRoundRecording.cs`, `.ComputeEntries`, `.DrawnCompetitionAsync`, `.DrawnCompetitionAsync`, `DrawAcceptanceDecideTests`, `.New`, `PrescribeDrawPropertyTests`, `.SeedCompetition`, `SeeingWhatIsRecordedSteps`, `DateTimeOffset`, `RecordEntryPenaltyDecideTests`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `CompetitionId` connect `CompetitionId` to `.LoadCurrentAsync`, `Soarscore.Domain.PublishedClassDefinition`, `.Build`, `FakeEntryQuery`, `GetCompetition`, `IDomainEvent`, `DrawAcceptanceEventStoreTests`, `.New`, `DrawingACatalogueChoicePhaseSteps`, `PublishClassDefinition`, `EntryId`, `SystemClock`, `.SeedCompetition`, `.SeedRegisteredCompetitors`, `EntryEventJsonTests`, `EntryCapturePropertyTests`, `Then`, `.Of`, `CompetitorId`, `Entry`, `AnnulEntryDecideTests`, `GroupId`, `AcceptingTheDrawSteps`, `ScoringACompetitionSteps`, `AmendMeasurementDecideTests`, `.Exact`, `.SeedOpenEntryWithFlight`, `FlightOpened`, `OpenFlightDecideTests`, `Competition`, `When`, `.SeedCompetition`, `RegisterCompetitorPropertyTests`, `WithdrawCompetitorHandler`, `.SeedOpenEntry`, `CompetitionSummary`, `.SeedOpenEntryWithFlight`, `IStoreFixture`, `.SetUpAsync`, `TaskRoundRecording.cs`, `.DrawnCompetitionAsync`, `.DrawnCompetitionAsync`, `.New`, `SeeingWhatIsRecordedSteps`, `RecordEntryPenaltyDecideTests`?**
