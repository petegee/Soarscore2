...
## Corpus Check
- 479 files · ~725,485 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6424 nodes · 16644 edges · 336 communities (323 shown, 13 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1810 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1266a662`
...
## Communities (336 total, 13 thin omitted)

### Community 0 - ".ScoreCompetition"
Cohesion: 0.06
Nodes (44): Disqualified, ReflightRole, Entitled, Filler, Original, FinalRankingKind, LastPhaseReplaces, SinglePhase (+36 more)
...
Cohesion: 0.06
Nodes (61): AfterTestRun, BeforeTestRun, CancellationToken, IClock, IEventStore, Task, BindParameterHandler, CancellationToken (+53 more)

### Community 4 - "MetricDefinition"
Cohesion: 0.07
Nodes (28): MetricDefinition, DeclaredBeforeLaunch, Kind, Name, Precision, Unit, M, ImmutableArray (+20 more)
...
Cohesion: 0.08
Nodes (12): Soarscore.Application.Shared.Entries, Soarscore.Application.Commands.Competitions, Soarscore.Application.Shared.People, Soarscore.Application.Tests.Shared.Competitions, Soarscore.Application.Tests.Queries.Entries, Soarscore.Api.Queries, Soarscore.Domain.Entries, Soarscore.Application.Queries.Entries (+4 more)
...
### Community 11 - "BindParameterDecideTests"
Cohesion: 0.21
Nodes (4): Fact, InlineData, Theory, BindParameterDecideTests

### Community 12 - "PrescribeDrawDecideTests"
Cohesion: 0.06
Nodes (43): IServiceProvider, Mutation, Round, IReadOnlyList, Draw, CreatedAt, Status, Phase (+35 more)

### Community 13 - ".Aggregate"
Cohesion: 0.11
Nodes (28): aggregate, dropped, DropPolicy, ApplyWhenResultsAtLeast, ApplyWhenRoundsCompletedAtLeast, Dimension, DropCount, ImmutableArray (+20 more)

### Community 14 - ".New"
Cohesion: 0.09
Nodes (19): Competition, DateOnly, CompetitionCreated, Store, Fact, ArgumentException, Competition, DateTimeOffset (+11 more)

### Community 15 - "CompetitionId"
Cohesion: 0.05
Nodes (80): ICommand, IHttpMaxRequestBodySizeFeature, IParsable, WebApplication, Commands, IReadOnlyList, WebApplication, Composition (+72 more)

### Community 16 - "PostgresFixture"
Cohesion: 0.04
Nodes (46): IAsyncLifetime, PostgresCatalogueDrawEventStoreTests, SqliteCatalogueDrawEventStoreTests, PostgresDrawAcceptanceEventStoreTests, SqliteDrawAcceptanceEventStoreTests, PostgresEntryCaptureEventStoreTests, SqliteEntryCaptureEventStoreTests, DateTimeOffset (+38 more)
...
Cohesion: 0.08
Nodes (39): ICommandHandler, CancellationToken, IClock, IEventStore, ImmutableArray, Task, FinaliseCompetition, FinaliseCompetitionHandler (+31 more)

### Community 19 - "PhaseDrawn"
Cohesion: 0.11
Nodes (28): DateTimeOffset, Group, ImmutableArray, Penalty, ReflightRuling, Round, CompetitionEvent, CompetitorRegistered (+20 more)
...
Cohesion: 0.12
Nodes (24): Path, HashSet, IEnumerable, ImmutableArray, IReadOnlyDictionary, IReadOnlyList, List, Phase (+16 more)
...
Cohesion: 0.13
Nodes (14): ImmutableArray, CompetitionScoreView, CompetitorFinalScoreView, DateTimeOffset, Dictionary, Given, Group, HttpClient (+6 more)
...
### Community 32 - "Entry"
Cohesion: 0.08
Nodes (31): DateTimeOffset, Func, ImmutableArray, Penalty, PenaltyRecorded, Result, Amendment, At (+23 more)
...
Cohesion: 0.13
Nodes (22): GroupNo, KeyCollection, PilotNo, RoundNo, IEventStore, Competition, Dictionary, Entry (+14 more)
...
### Community 37 - "When"
Cohesion: 0.10
Nodes (15): When, Given, HttpClient, HttpResponseMessage, IReadOnlyList, List, Task, AcceptingTheDrawSteps (+7 more)
...
Cohesion: 0.09
Nodes (36): CancellationToken, IEventStore, Task, GetCompetition, GetCompetitionHandler, DateTimeOffset, SystemClock, UtcNow (+28 more)
...
### Community 44 - "Person"
Cohesion: 0.10
Nodes (28): IQueryHandler, CancellationToken, IEventStore, Task, GetPerson, GetPersonHandler, CancellationToken, IEventStore (+20 more)
...
Cohesion: 0.04
Nodes (67): ResolvedSchedule, Group, DateOnly, DateTimeOffset, Defect, Func, ImmutableArray, Penalty (+59 more)

### Community 49 - "ScoringVocabulary.cs"
Cohesion: 0.06
Nodes (40): CapScope, PerFlight, PerTask, TargetAssignment, AnyOrder, InOrder, None, ImmutableArray (+32 more)
...
### Community 54 - "Soarscore.Application"
Cohesion: 0.11
Nodes (12): Alias, Soarscore.Application.Tests.Commands.Entries, Soarscore.Infrastructure, Soarscore.Application.Tests.Shared.Entries, Soarscore.Application, IReadOnlyList, Type, SoarscoreEventTypes (+4 more)
...
Cohesion: 0.19
Nodes (14): DateTimeOffset, Guid, ClassDefinitionProjection, ClassDefinitionSummary, CancellationToken, IReadOnlyList, Task, FindClassDefinitions (+6 more)
...
Cohesion: 0.06
Nodes (29): CompositionKind, ChooseFromCatalogue, FixedSequence, DropDimension, ByRound, ByTask, ParameterBindingPoint, BeforeFlying (+21 more)
...
Cohesion: 0.24
Nodes (11): CancellationToken, IClock, IEventStore, Task, AnnulEntryHandler, DateTimeOffset, Fact, FakeEventStore (+3 more)
...
### Community 65 - "PrescribingADrawSteps"
Cohesion: 0.17
Nodes (12): Given, HttpClient, HttpResponseMessage, IEnumerable, IReadOnlyList, List, Table, Task (+4 more)

### Community 66 - "Soarscore.Application.Queries.People"
Cohesion: 0.07
Nodes (18): Soarscore.Infrastructure.Competitions, Soarscore.Infrastructure.CompetitionClasses, Soarscore.Infrastructure.People, Soarscore.Application.Tests.Shared.People, Soarscore.Application.Queries.People, Soarscore.Application.Tests.Queries.People, Soarscore.Infrastructure.Entries, Soarscore.Application.Tests.Commands.People (+10 more)

### Community 67 - "PenaltyDefinition"
Cohesion: 0.09
Nodes (35): AccruedInfo, PenaltyDefinition, Accrual, Effects, ExclusionGroups, PenaltyEffectSpec, Dictionary, HashSet (+27 more)
...
### Community 69 - "CaptureMeasurementDecideTests"
Cohesion: 0.15
...
### Community 102 - "Story — Entry-scoped point-deduction penalties are inert"
Cohesion: 0.10
...
Cohesion: 0.09
Nodes (38): Hash, IClassFixture, CancellationToken, IClock, IEventStore, Task, PublishClassDefinition, PublishClassDefinitionHandler (+30 more)

### Community 108 - ".ReadStreamAsync"
Cohesion: 0.18
...
Cohesion: 0.03
Nodes (79): Id, ImmutableArray, PhaseDefinition, Drops, Ordinal, Promotion, Rounds, Tasks (+71 more)
...
### Community 128 - "IProjection"
Cohesion: 0.17
Nodes (15): IProjection, IDocumentOperations, MartenClassDefinitionSummaryProjection, CancellationToken, Guid, IDocumentOperations, IDocumentSession, IEvent (+7 more)
...
Cohesion: 0.15
Nodes (13): IDomainEvent, DateTimeOffset, ClassDefinitionEvent, ClassDefinitionPublished, ClassDefinitionRetired, Fact, ClassDefinitionEventJsonTests, Fact (+5 more)
...
### Community 170 - "TaskRoundClosurePropertyTests"
Cohesion: 0.18
...
### Community 210 - "SeedF5J"
Cohesion: 0.11
Nodes (16): Bands, Builder, Rows, Band, LookupRow, ImmutableArray, Bands, Rows (+8 more)
...
### Community 223 - ".ConfigureDocumentStore"
Cohesion: 0.18
Nodes (9): CancellationToken, IDocumentSession, IEvent, IReadOnlyList, Task, ClassDefinitionSummaryProjection, FisherClassDefinitionSummaryProjection, DocumentStore (+1 more)
...
### Community 237 - "CompetitionFieldPropertyTests"
Cohesion: 0.29
...
### Community 254 - "NumberOrParam"
Cohesion: 0.11
Nodes (20): JsonConverter, JsonSerializerOptions, ClassDefinitionHashing, JsonSerializerOptions, Utf8JsonReader, Utf8JsonWriter, DecimalAsStringConverter, SoarscoreEventJson (+12 more)
...
Cohesion: 0.17
Nodes (12): IReadOnlyList, Result, Code, Defects, IsFailure, IsSuccess, Message, Value (+4 more)
...
### Community 276 - ".AppendAsync"
Cohesion: 0.57
Nodes (4): CancellationToken, Guid, IReadOnlyList, StaleReadEventStore

### Community 277 - ".AppendAsync"
Cohesion: 0.57
Nodes (4): CancellationToken, Guid, IReadOnlyList, StaleReadEventStore
...
### Community 286 - "NZ ALES — Generally Applicable Rules"
Cohesion: 0.33
...
### Community 333 - "ClassDefinitionProjectionPropertyTests"
Cohesion: 0.67
Nodes (3): DateTimeOffset, Gen, ClassDefinitionProjectionPropertyTests

### Community 334 - "EntryEventJsonTests"
Cohesion: 0.47
...
## Knowledge Gaps
- **1858 isolated node(s):** `context7`, `rider`, `$schema`, `.opencode/plugins/graphify.js`, `$(SoarscoreTargetFramework)` (+1853 more)
...
- **Why does `ClassDefinition` connect `ClassDefinition` to `.ScoreCompetition`, `SeeingWhatIsRecordedSteps`, `.BuildCompetitionWithPenalties`, `FakeEntryQuery`, `.HandleAsync`, `WithdrawCompetitorHandler`, `SeedF3J`, `ClassDefinitionPublished`, `CatalogueDrawPropertyTests`, `.CheckLimits`, `.Load`, `BindParameterDecideTests`, `IQuery`, `RegisterCompetitorPropertyTests`, `.New`, `CompetitionId`, `PrescribeDrawDecideTests`, `EntryId`, `BindParameterPropertyTests`, `PhaseDrawn`, `DrawAcceptanceEventStoreTests`, `EntryModelBasedFoldTests`, `.DrawnCompetitionAsync`, `MeasuredValue`, `.LoadAsync`, `MetricDefinition`, `ClosingACompetitionSteps`, `.New`, `.Exact`, `FlightOpened`, `ReflightingAGroupSteps`, `When`, `Then`, `SystemClock`, `ScoreTerm`, `.SeedOpenEntryWithFlight`, `Competition`, `PublishedClassDefinition`, `RecordingAReflightRulingSteps`, `.SeedCompetition`, `FinaliseDecideTests`, `.SeedOpenEntry`, `.HandleAsync`, `GliderscoreFixture`, `PenaltyDefinition`, `.ScoreGroup`, `Soarscore.Application.Tests`, `.SetUpAsync`, `.CompetitionAdopting`, `CreateCompetitionPropertyTests`, `ClassDefinitionValidationPropertyTests`, `.HandleAsync`, `ClassDefinitionProjectionPropertyTests`, `.Apply`, `.BuildDrawnCompetition`, `.BuildDrawnCompetition`, `SeedF5J`, `.BuildDispatcher`, `.Minimal`, `.DrawnCompetitionAsync`, `DrawAcceptanceDecideTests`, `SeedF3K`, `CompetitionReplaceTaskRoundPropertyTests`, `AdoptedRules`, `PublishClassDefinition`, `CompetitionFieldPropertyTests`, `.SeedCompetition`, `.BuildDrawnCompetition`, `DrawAcceptancePropertyTests`, `TaskDefinition`, `.BuildCompetition`?**
  _High betweenness centrality (0.115) - this node is a cross-community bridge._
- **Why does `CompetitorId` connect `CompetitionId` to `.ScoreCompetition`, `Soarscore.Domain.PublishedClassDefinition`, `SeeingWhatIsRecordedSteps`, `FakeEntryQuery`, `.BuildCompetitionWithPenalties`, `WithdrawCompetitorHandler`, `CatalogueDrawPropertyTests`, `PrescribeDrawDecideTests`, `.New`, `EntryId`, `.LoadAsync`, `PhaseDrawn`, `DrawAcceptanceEventStoreTests`, `.DrawnCompetitionAsync`, `EntryCapturePropertyTests`, `ClosingACompetitionSteps`, `.New`, `.Exact`, `Entry`, `IEventStore`, `AnnulEntryDecideTests`, `ReflightingAGroupSteps`, `When`, `Then`, `AmendMeasurementDecideTests`, `FlightOpened`, `OpenFlightDecideTests`, `SystemClock`, `TaskRoundRecordingPropertyTests`, `Penalty`, `Competition`, `RecordingAReflightRulingSteps`, `.SeedCompetition`, `FinaliseDecideTests`, `.HandleAsync`, `PrescribingADrawSteps`, `CaptureMeasurementDecideTests`, `.SetUpAsync`, `EntryEventJsonTests`, `.BuildDrawnCompetition`, `.BuildDrawnCompetition`, `.ComputeEntries`, `GroupId`, `FakeEventStore`, `.DrawnCompetitionAsync`, `DrawAcceptanceDecideTests`, `.SeedCompetition`, `.BuildDrawnCompetition`, `TaskDefinition`, `.BuildCompetition`, `RecordEntryPenaltyDecideTests`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `Soarscore.Domain.PublishedClassDefinition` connect `Soarscore.Domain.PublishedClassDefinition` to `Soarscore.Application.Queries.People`, `PenaltyDefinition`, `Soarscore.Application.Tests`, `Soarscore.Domain`, `Soarscore.Application.Queries.Competitions`, `ClassDefinitionPublished`, `.Aggregate`, `PostgresFixture`, `ScoringVocabulary.cs`, `PublishedClassDefinition`, `PhaseDrawn`, `Soarscore.Application`, `FixtureModels.cs`, `Soarscore.Application.Queries.CompetitionClasses`, `TaskDefinition`, `Enumerations.cs`, `CompetitionProjectionTests.cs`, `NumberOrParam`?**
...
- **Should `.ScoreCompetition` be split into smaller, more focused modules?**
...
- **Should `Soarscore.Domain.PublishedClassDefinition` be split into smaller, more focused modules?**
  _Cohesion score 0.05750224618149147 - nodes in this community are weakly interconnected._
- **Should `FakeEntryQuery` be split into smaller, more focused modules?**
  _Cohesion score 0.05768132495716733 - nodes in this community are weakly interconnected._