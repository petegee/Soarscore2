...
## Corpus Check
- 554 files · ~933,533 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6533 nodes · 16873 edges · 346 communities (338 shown, 8 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1851 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `893036bf`
...
## Communities (346 total, 8 thin omitted)

### Community 0 - ".Select"
Cohesion: 0.16
Nodes (11): ReflightRole, Entitled, Filler, Original, Entry, IReadOnlyList, ReflightSelector, Fact (+3 more)
...
Cohesion: 0.18
Nodes (15): CancellationToken, IClock, IEventStore, Task, RegisterCompetitorHandler, DateTimeOffset, Fact, FakeEventStore (+7 more)

### Community 3 - ".Exact"
Cohesion: 0.06
Nodes (57): AfterTestRun, BeforeTestRun, CancellationToken, IClock, IEventStore, Task, BindParameterHandler, CancellationToken (+49 more)

### Community 4 - "PersonId"
Cohesion: 0.10
Nodes (19): CancellationToken, IClock, IEventStore, Task, ChangePersonClubAffiliationHandler, CancellationToken, IClock, IEventStore (+11 more)
...
### Community 11 - ".Build"
Cohesion: 0.11
Nodes (37): ICommand, IHttpMaxRequestBodySizeFeature, WebApplication, Commands, IReadOnlyList, WebApplication, Composition, IClock (+29 more)
...
### Community 14 - ".New"
Cohesion: 0.11
Nodes (15): Store, Store, ArgumentException, Competition, DateTimeOffset, Fact, CompetitionFoldTests, Fact (+7 more)

### Community 15 - "RegisterPerson"
Cohesion: 0.26
Nodes (15): IQueryHandler, IClock, IEventStore, RegisterPerson, RegisterPersonHandler, RenamePerson, IEventStore, GetPerson (+7 more)

### Community 16 - "Soarscore.Application"
Cohesion: 0.04
Nodes (61): Soarscore.Infrastructure.Competitions, Soarscore.Infrastructure.Tests, Soarscore.Infrastructure.CompetitionClasses, Soarscore.Infrastructure.People, Soarscore.Application.Queries.People, Soarscore.Infrastructure, Soarscore.Application, Soarscore.Infrastructure.Entries (+53 more)
...
Cohesion: 0.13
Nodes (28): ICommandHandler, CancellationToken, IClock, IEventStore, Task, FinaliseCompetition, FinaliseCompetitionHandler, CancellationToken (+20 more)

### Community 19 - "PhaseDrawn"
Cohesion: 0.11
Nodes (24): Func, DateTimeOffset, Group, ImmutableArray, Penalty, ReflightRuling, Round, CompetitionEvent (+16 more)
...
Cohesion: 0.08
Nodes (29): Exception, Ref, Parameter, AllowedValues, BoundAt, DefaultValue, Kind, Name (+21 more)
...
Cohesion: 0.17
Nodes (16): KeyCollection, Competition, Dictionary, Entry, HashSet, HttpClient, IEnumerable, ImmutableArray (+8 more)
...
### Community 40 - "IStoreFixture"
Cohesion: 0.10
Nodes (29): CancellationToken, Task, CancellationToken, IEventStore, Task, GetCompetition, GetCompetitionHandler, DateTimeOffset (+21 more)

### Community 41 - "FlightSelectorTests"
Cohesion: 0.08
Nodes (23): Bindings, ClassDef, ExpectedRawScore, ImmutableArray, IReadOnlyDictionary, FlightSelector, IReadOnlyDictionary, FlightResult (+15 more)
...
### Community 44 - "NormalisationEnginePropertyTests"
Cohesion: 0.16
...
Cohesion: 0.08
Nodes (23): DateOnly, DateTimeOffset, Defect, Penalty, PenaltyRecorded, ReflightRuling, Result, TaskRoundCoordinate (+15 more)
...
Cohesion: 0.05
Nodes (42): PromotionRule, CarryPenalties, Kind, MaxGroupSize, MinGroupSize, TopN, TopPercent, RoundComposition (+34 more)
...
### Community 66 - "Competitions/TestDoubles.cs"
Cohesion: 0.11
...
### Community 67 - "ContactDetails"
Cohesion: 0.14
Nodes (14): ContactDetails, Email, HomeCity, Phone, Fact, PersonTests, DateTimeOffset, Fact (+6 more)

### Community 68 - "PenaltyDefinition"
Cohesion: 0.29
Nodes (11): PenaltyDefinition, Accrual, Effects, ExclusionGroups, InfractionType, PenaltyEffectSpec, RecordedPenalty, SelectedFlights (+3 more)
...
### Community 76 - "CompetitionDecideTests"
Cohesion: 0.23
...
### Community 84 - "GroupId"
Cohesion: 0.18
Nodes (14): IParsable, CancellationToken, Entry, IEventStore, ImmutableArray, IReadOnlyDictionary, IReadOnlyList, Task (+6 more)

### Community 85 - ".BuildDispatcher"
Cohesion: 0.25
Nodes (12): IQuery, CancellationToken, IEventStore, Task, GetClassDefinition, GetClassDefinitionHandler, Fact, FakeClock (+4 more)
...
Cohesion: 0.04
Nodes (61): ImmutableArray, PhaseDefinition, Drops, Ordinal, Promotion, Rounds, Tasks, Validity (+53 more)

### Community 122 - "TaskRoundClosurePropertyTests"
Cohesion: 0.13
Nodes (14): closure, ClosureKind, fieldSize, DateTimeOffset, Dictionary, Gen, Group, Round (+6 more)
...
### Community 124 - ".BuildCompetition"
Cohesion: 0.18
...
### Community 138 - "TaskRound"
Cohesion: 0.07
Nodes (30): ResolvedSchedule, Round, Group, ImmutableArray, Draw, CreatedAt, Status, Finalisation (+22 more)
...
### Community 140 - "Pre-requisites (sub-agent dispatchable — gate WI-1–4)"
Cohesion: 0.13
Nodes (14): Before starting, PRE-1 — Per-comp export: comp 45, 2019 F5J Christchurch (`f5j-christchurch-2019`), PRE-2 — Per-comp export: comp 135, F5J Hawkes Bay and Team Trials (`f5j-hawkes-bay-trials`), PRE-3 — Per-comp export: comp 17, Southern Fling (`f3k-southern-fling`), PRE-4 — Per-comp export: comp 121, NZ South Island F5J (`f5j-nz-south-island`), PRE-5 — Per-comp export: comp 54, 2020 June F3K (`f3k-june-2020`), Pre-requisites (sub-agent dispatchable — gate WI-1–4), Story — Grow golden corpus from NZContests.mdb (five fixtures) (+6 more)
...
### Community 161 - "PhaseDrawPropertyTests"
Cohesion: 0.25
...
### Community 196 - "ResolvedTask"
Cohesion: 0.07
Nodes (44): CapScope, PerFlight, PerTask, TargetAssignment, AnyOrder, InOrder, None, ImmutableArray (+36 more)
...
Cohesion: 0.07
Nodes (31): Bands, Builder, JsonConverter, Rows, JsonSerializerOptions, ClassDefinitionHashing, JsonSerializerOptions, Utf8JsonReader (+23 more)
...
### Community 214 - "DrawAcceptanceEventStoreTests"
Cohesion: 0.43
...
### Community 217 - "PersonDecideTests"
Cohesion: 0.25
...
### Community 234 - ".New"
Cohesion: 0.08
Nodes (28): Id, Competition, DateOnly, CompetitionCreated, DrawAccepted, SubjectIndex, Competition, Dictionary (+20 more)
...
### Community 246 - ".LoadAsync"
Cohesion: 0.12
Nodes (13): CancellationToken, Task, CancellationToken, IClock, IEventStore, Task, PrescribeDrawHandler, CancellationToken (+5 more)
...
### Community 251 - "CompetitorId"
Cohesion: 0.27
Nodes (6): CompetitorId, Dictionary, IEnumerable, ImmutableArray, Fact, IdRoundTripPropertyTests

### Community 252 - "PrescribeDrawEventStoreTests"
Cohesion: 0.38
...
### Community 268 - "CompetitionModelBasedFoldTests"
Cohesion: 0.20
...
Cohesion: 0.18
Nodes (14): CancellationToken, IClock, IEventStore, IReadOnlyList, Task, AppendReflightGroup, AppendReflightGroupHandler, CancellationToken (+6 more)
...
### Community 286 - "Group"
Cohesion: 0.22
Nodes (12): Competition, Entry, ImmutableArray, IReadOnlyDictionary, EntryGapsView, FlightGapsView, GroupRecordingView, RecordingCore (+4 more)
...
### Community 311 - "CompetitionScoreView"
Cohesion: 0.10
Nodes (16): ImmutableArray, CancellationToken, Entry, IEventStore, IReadOnlyDictionary, Task, EntryCollector, CancellationToken (+8 more)
...
### Community 345 - "SeedNzMAles200"
Cohesion: 0.50
Nodes (3): SeedNzMAles200, Definition, TaskD

## Knowledge Gaps
- **1884 isolated node(s):** `context7`, `rider`, `$schema`, `.opencode/plugins/graphify.js`, `$(SoarscoreTargetFramework)` (+1879 more)
...
- **Why does `ClassDefinition` connect `ClassDefinition` to `SeeingWhatIsRecordedSteps`, `.HandleAsync`, `.Exact`, `.HandleAsync`, `.AppendAsync`, `ClassDefinitionPublished`, `CatalogueDrawPropertyTests`, `.CheckLimits`, `.Of`, `.Build`, `CompetitionModelBasedFoldTests`, `PrescribeDrawDecideTests`, `.New`, `MetricDefinition`, `Then`, `.DrawnCompetitionAsync`, `PhaseDrawn`, `CompetitionId`, `MeasuredValue`, `SeedNzMNdc`, `ClosingACompetitionSteps`, `.New`, `FixtureModels.cs`, `DrawPhase`, `FlightOpened`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `ScoringACompetitionSteps`, `.OpenAndCaptureFlightAsync`, `IStoreFixture`, `FlightSelectorTests`, `.ScoreGroup`, `CaptureMeasurement`, `RecordingAReflightRulingSteps`, `.SeedCompetition`, `FinaliseDecideTests`, `.MapQueries`, `.SeedOpenEntry`, `SeedF3K`, `.Rank`, `.ScoreCompetition`, `SeedF3J`, `PenaltyDefinition`, `Soarscore.SeedData`, `.SetUpAsync`, `.CompetitionAdopting`, `CreateCompetitionPropertyTests`, `ClassDefinitionValidationPropertyTests`, `CompetitionDecideTests`, `AdoptedRules`, `RecordEntryPenalty`, `ClassDefinitionProjectionPropertyTests`, `.BuildDrawnCompetition`, `.BuildDrawnCompetition`, `RulesAmendment`, `.BuildDispatcher`, `.Validate`, `DrawAcceptanceEventStoreTests`, `SeedNzMAles200`, `SystemClock`, `DrawAcceptanceDecideTests`, `GliderscoreFixture`, `CompetitionReplaceTaskRoundPropertyTests`, `.New`, `PublishClassDefinition`, `.SeedCompetition`, `CompetitionDecidePropertyTests`, `PrescribeDrawEventStoreTests`, `CompetitionFieldPropertyTests`, `TaskDefinition`, `.BuildCompetition`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `CompetitorId` connect `CompetitorId` to `Soarscore.Domain.PublishedClassDefinition`, `.HandleAsync`, `.Exact`, `.BuildGroups`, `.AppendAsync`, `SeeingWhatIsRecordedSteps`, `TaskRound`, `.Build`, `PrescribeDrawDecideTests`, `.Of`, `.New`, `.DrawnCompetitionAsync`, `Then`, `PhaseDrawn`, `Competitor`, `CompetitionId`, `EntryCapturePropertyTests`, `PrescribingADrawSteps`, `ClosingACompetitionSteps`, `.New`, `Group`, `DrawPhase`, `Entry`, `PhaseDrawPropertyTests`, `.CompareRawGrainAsync`, `AnnulEntryDecideTests`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `ScoringACompetitionSteps`, `AmendMeasurementDecideTests`, `FlightOpened`, `OpenFlightDecideTests`, `ReflightSelection`, `IStoreFixture`, `.OpenAndCaptureFlightAsync`, `TaskRoundRecordingPropertyTests`, `Competition`, `RecordingAReflightRulingSteps`, `.ScoreWith`, `.SeedCompetition`, `CompetitionScoreView`, `FinaliseDecideTests`, `.ScoreCompetition`, `.SetUpAsync`, `RecordEntryPenalty`, `.BuildDrawnCompetition`, `EntryEventJsonTests`, `.BuildDrawnCompetition`, `.ComputeEntries`, `GroupId`, `IDomainEvent`, `DrawAcceptanceEventStoreTests`, `SystemClock`, `DrawAcceptanceDecideTests`, `GliderscoreFixture`, `.New`, `PublishClassDefinition`, `.SeedCompetition`, `PrescribeDrawEventStoreTests`, `TaskRoundClosurePropertyTests`, `.BuildCompetition`, `RecordEntryPenaltyDecideTests`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `Soarscore.Domain.PublishedClassDefinition` connect `Soarscore.Domain.PublishedClassDefinition` to `PenaltyDefinition`, `ResolvedTask`, `IProjection`, `Soarscore.Domain`, `Soarscore.Application.Queries.Competitions`, `ClassDefinitionPublished`, `FlightSelectorTests`, `Soarscore.SeedData`, `.Aggregate`, `OpenEntryHandlerTests.cs`, `Soarscore.Application`, `NumberOrParam`, `PhaseDrawn`, `Soarscore.Application.Commands.CompetitionClasses`, `Enumerations.cs`, `FixtureModels.cs`?**
...
- **Should `.Exact` be split into smaller, more focused modules?**
  _Cohesion score 0.06316831683168317 - nodes in this community are weakly interconnected._
- **Should `PersonId` be split into smaller, more focused modules?**
