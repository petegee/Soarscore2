...
## Corpus Check
- 478 files · ~720,990 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6389 nodes · 16591 edges · 346 communities (332 shown, 14 thin omitted)
...
## Communities (346 total, 14 thin omitted)
...
### Community 4 - "NumberOrParam"
Cohesion: 0.04
Nodes (56): Bands, Builder, Rows, CapScope, PerFlight, PerTask, NumberOrParam, Band (+48 more)
...
Cohesion: 0.08
Nodes (11): Soarscore.Application.Tests.Commands.Entries, Soarscore.Application.Shared.Entries, Soarscore.Application.Commands.Competitions, Soarscore.Application.Commands.Entries, Soarscore.Application.Tests.Shared.Competitions, Soarscore.Application.Tests.Queries.Entries, Soarscore.Application.Queries.Entries, Soarscore.Domain (+3 more)
...
Cohesion: 0.06
Nodes (58): aggregate, closure, ClosureKind, dropped, fieldSize, ImmutableArray, DropPolicy, ApplyWhenResultsAtLeast (+50 more)

### Community 14 - ".New"
Cohesion: 0.13
Nodes (11): FakeEventStore, Store, ArgumentException, Competition, DateTimeOffset, Fact, CompetitionFoldTests, Fact (+3 more)

### Community 15 - "CompetitionId"
Cohesion: 0.06
Nodes (66): ICommand, IHttpMaxRequestBodySizeFeature, IParsable, WebApplication, Commands, IReadOnlyList, WebApplication, Composition (+58 more)

### Community 16 - "Soarscore.Application"
Cohesion: 0.04
Nodes (62): Soarscore.Infrastructure.Competitions, Soarscore.Infrastructure.Tests, Soarscore.Infrastructure.CompetitionClasses, Soarscore.Infrastructure.People, Soarscore.Application.Tests.Queries.Competitions, Soarscore.Application.Queries.People, Soarscore.Infrastructure, Soarscore.Application.Queries.Competitions (+54 more)

### Community 17 - "CapturingAScoreSteps"
Cohesion: 0.09
Nodes (14): Dictionary, Given, Group, HttpClient, HttpResponseMessage, List, Round, Table (+6 more)
...
### Community 20 - "FlagOrParam"
Cohesion: 0.29
Nodes (5): Type, FlagOrParam, Literal, Ref, Utf8JsonReader
...
### Community 23 - "Parameter"
Cohesion: 0.11
Nodes (22): Exception, Parameter, AllowedValues, BoundAt, DefaultValue, Kind, Name, Unit (+14 more)
...
### Community 29 - ".New"
Cohesion: 0.09
Nodes (22): TaskRoundState, Annulled, Complete, Drawn, InProgress, DateTimeOffset, Fact, Task (+14 more)
...
### Community 32 - "Entry"
Cohesion: 0.06
Nodes (40): DateTimeOffset, Func, ImmutableArray, Penalty, PenaltyRecorded, Result, Amendment, At (+32 more)
...
Cohesion: 0.15
Nodes (18): KeyCollection, IEventStore, Competition, Dictionary, Entry, HashSet, HttpClient, IEnumerable (+10 more)

### Community 35 - "FlightOpened"
Cohesion: 0.20
Nodes (12): Penalty, EntryAnnulled, EntryEvent, FlightOpened, MeasurementAmended, MeasurementCaptured, PenaltyRecorded, ArgumentException (+4 more)

### Community 36 - "GroupId"
Cohesion: 0.13
Nodes (13): GroupId, Dictionary, Given, Group, HttpClient, HttpResponseMessage, List, ProblemDetails (+5 more)
...
Cohesion: 0.14
Nodes (24): CancellationToken, IEventStore, Task, GetCompetition, GetCompetitionHandler, DateTimeOffset, SystemClock, UtcNow (+16 more)
...
Cohesion: 0.27
Nodes (12): IQueryHandler, CancellationToken, IEventStore, Task, GetPerson, GetPersonHandler, Fact, FakeClock (+4 more)
...
### Community 47 - ".Exact"
Cohesion: 0.05
Nodes (44): CancellationToken, Task, CancellationToken, Task, CancellationToken, Task, CancellationToken, IClock (+36 more)

### Community 48 - "Competition"
Cohesion: 0.12
Nodes (18): Defect, Penalty, ReflightRuling, TaskRoundCoordinate, Competition, AdoptedRules, EndDate, EvaluatorVersion (+10 more)

### Community 49 - "ScoringVocabulary.cs"
Cohesion: 0.11
Nodes (19): Comparator, EqualTo, GreaterOrEqual, GreaterThan, LessOrEqual, LessThan, AllOf, Children (+11 more)
...
Cohesion: 0.14
Nodes (21): CancellationToken, IEventStore, Task, RecordCompetitionPenalty, RecordCompetitionPenaltyHandler, Penalty, By, CompetitorRef (+13 more)

### Community 54 - "Soarscore.Application.Commands.People"
Cohesion: 0.15
...
Cohesion: 0.10
Nodes (18): CompositionKind, ChooseFromCatalogue, FixedSequence, MeasuredKind, Flag, Number, PenaltyAccrual, OncePerAttempt (+10 more)
...
### Community 61 - "ContactDetails"
Cohesion: 0.14
Nodes (15): ClubAffiliation, ClubName, MembershipNumber, ContactDetails, Email, HomeCity, Phone, Fact (+7 more)
...
Cohesion: 0.17
Nodes (16): GroupNo, PilotNo, RoundNo, SlotCapture, IReadOnlyList, GliderscoreFixture, ScoresRow, HttpClient (+8 more)
...
### Community 65 - "DateTimeOffset"
Cohesion: 0.21
Nodes (9): ResolvedSchedule, DateTimeOffset, ImmutableArray, Result, Group, CompetitorRefs, Id, Ordinal (+1 more)

### Community 66 - "People/TestDoubles.cs"
Cohesion: 0.12
...
Cohesion: 0.13
Nodes (25): AccruedInfo, PenaltyDefinition, Accrual, Effects, ExclusionGroups, PenaltyEffectSpec, Dictionary, HashSet (+17 more)
...
### Community 69 - ".Rank"
Cohesion: 0.26
Nodes (8): ImmutableArray, RankingEngine, ImmutableDictionary, CompetitionResult, FinalCompetitorScore, Fact, Fact, RankingEngineTests
...
### Community 77 - "PrescribingADrawSteps"
Cohesion: 0.17
...
Cohesion: 0.12
Nodes (20): IReadOnlyList, WebApplication, Queries, Competition, ImmutableArray, CompetitionView, CancellationToken, Entry (+12 more)
...
Cohesion: 0.09
Nodes (28): assignments_of(), _convertible_record_sets(), _expected_assignment(), make_record(), composite, given, parametrize, settings (+20 more)
...
Cohesion: 0.04
Nodes (50): TaskDefinition, Code, Flights, FlightValidWhen, Group, Metrics, Name, Normalise (+42 more)

### Community 122 - "TaskRound"
Cohesion: 0.17
...
### Community 129 - "Rounding"
Cohesion: 0.19
Nodes (10): RoundingMode, Ceiling, HalfUp, Truncate, Rounding, Fact, Gen, IReadOnlyDictionary (+2 more)
...
Cohesion: 0.13
Nodes (21): CancellationToken, IClock, IEventStore, Task, RegisterCompetitorHandler, CancellationToken, IClock, IEventStore (+13 more)
...
Cohesion: 0.08
Nodes (22): IConfiguration, IServiceCollection, DateTimeOffset, IClock, UtcNow, CancellationToken, DateOnly, IDocumentSessionFactory (+14 more)
...
Cohesion: 0.10
Nodes (22): IEventStore, IsBogus, DateTimeOffset, Fact, FakeEventStore, Gen, Index, RegisterCompetitorPropertyTests (+14 more)
...
Cohesion: 0.15
Nodes (15): IServiceProvider, Dictionary, Type, FakeServiceProvider, CancellationToken, Dictionary, ExpectedVersion, Guid (+7 more)
...
Cohesion: 0.21
Nodes (16): _assignment_sort_key(), check_draw_completeness(), _common_fields(), convert_records(), _decode_duration_slots(), _decode_f3k_slots(), _decode_f5k_flights(), _decode_passthrough() (+8 more)
...
Cohesion: 0.13
Nodes (21): assert_record_typed_equal(), _corrupted_documents(), default_line(), document(), _download_records(), composite, given, parametrize (+13 more)
...
Cohesion: 0.20
Nodes (32): check_urls(), csv_member_name(), duration_csv_bytes(), fetch(), fixture_csv_bytes(), make_client(), make_zip_bytes(), parametrize (+24 more)
...
### Community 196 - "MeasuredValue"
Cohesion: 0.17
Nodes (14): MeasuredValue, Flag, Kind, Number, IReadOnlyDictionary, FlightInterpreter, Intrinsic, GroupResult (+6 more)
...
### Community 210 - "Person"
Cohesion: 0.23
Nodes (8): DateTimeOffset, Defect, Result, Person, Club, Contact, Id, Name

### Community 211 - "FakeEventStore"
Cohesion: 0.26
Nodes (10): CancellationToken, ExpectedVersion, Guid, IReadOnlyDictionary, IReadOnlyList, List, RecordedEvent, Task (+2 more)
...
### Community 217 - ".RunPayoffCaptureScenarioAsync"
Cohesion: 0.46
...
### Community 223 - "AcceptanceFixture"
Cohesion: 0.18
...
### Community 234 - ".New"
Cohesion: 0.09
Nodes (23): Id, Competition, DateOnly, CompetitionCreated, DrawAccepted, Competition, Dictionary, Entries (+15 more)
...
### Community 254 - "NumberOrParamConverter"
Cohesion: 0.31
Nodes (6): JsonSerializerOptions, ClassDefinitionHashing, JsonSerializerOptions, Utf8JsonWriter, FlagOrParamConverter, NumberOrParamConverter
...
### Community 273 - "IStoreFixture"
Cohesion: 0.12
Nodes (20): CancellationToken, IClock, IEventStore, Task, AppendReflightGroupHandler, CancellationToken, Task, IStoreFixture (+12 more)

### Community 274 - "Result"
Cohesion: 0.09
Nodes (29): CancellationToken, Guid, IReadOnlyList, Task, RecordedEvent, IReadOnlyList, Result, Code (+21 more)
...
### Community 281 - "ParameterBinding"
Cohesion: 0.29
...
### Community 287 - "CompetitionFieldPropertyTests"
Cohesion: 0.29
...
### Community 318 - "CompetitionModelBasedFoldTests"
Cohesion: 0.20
...
### Community 328 - "Queries.cs"
Cohesion: 0.33
Nodes (3): Soarscore.Api.Commands, Soarscore.Api.Queries, Soarscore.Api.Routing
...
### Community 337 - "FinalRankingKind"
Cohesion: 0.50
Nodes (4): FinalRankingKind, LastPhaseReplaces, SinglePhase, SplitByPromotion

### Community 339 - "test_picker_dedupe_first_wins_and_sort_ordering_property"
Cohesion: 0.67
...
- **Why does `ClassDefinition` connect `ClassDefinition` to `.ScoreCompetition`, `.BuildCompetitionWithPenalties`, `FakeEntryQuery`, `NumberOrParam`, `CatalogueDrawPropertyTests`, `.CheckLimits`, `ResolvedTask`, `.Of`, `PrescribeDrawDecideTests`, `PhaseDefinition`, `.New`, `CompetitionId`, `CapturingAScoreSteps`, `ICommandHandler`, `PhaseDrawn`, `Parameter`, `DrawAcceptanceEventStoreTests`, `ClosingACompetitionSteps`, `.New`, `FixtureModels.cs`, `DrawPhase`, `FlightOpened`, `GroupId`, `AcceptingTheDrawSteps`, `Then`, `SystemClock`, `SeeingWhatIsRecordedSteps`, `.Exact`, `RecordingAReflightRulingSteps`, `RecordCompetitionPenalty`, `FinaliseDecideTests`, `.SeedOpenEntry`, `GliderscoreFixture`, `PenaltyDefinition`, `.SetUpAsync`, `.CompetitionAdopting`, `.BuildDrawnCompetition`, `.BuildDrawnCompetition`, `.MapQueries`, `.BuildDispatcher`, `.Validate`, `.DrawnCompetitionAsync`, `DrawAcceptanceDecideTests`, `SeedF3K`, `CompetitionReplaceTaskRoundPropertyTests`, `PublishClassDefinition`, `.SeedCompetition`, `DrawAcceptancePropertyTests`, `TaskDefinition`, `ReflightRule`, `.HandleAsync`, `ClassDefinitionPublished`, `.AppendAsync`, `.SeedCompetition`, `PublishedClassDefinition`, `MeasuredValue`, `ClassDefinitionValidationPropertyTests`, `AdoptedRules`, `.RunPayoffCaptureScenarioAsync`, `.New`, `.BuildDrawnCompetition`, `BindParameterPropertyTests`, `.Decide`, `.HandleAsync`, `RulesAmendment`, `IStoreFixture`, `CompetitionFieldPropertyTests`, `ClassDefinitionEventJsonTests`, `ClassDefinitionProjectionPropertyTests`, `CompetitionModelBasedFoldTests`, `Corpus.cs`, `CreateCompetitionPropertyTests`, `SeedF3B`, `FinalRankingKind`, `SeedF3F`, `SeedNzNAles123`, `SeedNzPRadian`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `CompetitorId` connect `CompetitionId` to `.ScoreCompetition`, `Soarscore.Domain.PublishedClassDefinition`, `.BuildCompetitionWithPenalties`, `FakeEntryQuery`, `.HandleAsync`, `CatalogueDrawPropertyTests`, `.Of`, `PrescribeDrawDecideTests`, `.New`, `CapturingAScoreSteps`, `ICommandHandler`, `PhaseDrawn`, `IStoreFixture`, `EntryCapturePropertyTests`, `DrawAcceptanceEventStoreTests`, `ClosingACompetitionSteps`, `.New`, `DrawPhase`, `Entry`, `IEventStore`, `AnnulEntryDecideTests`, `GroupId`, `AcceptingTheDrawSteps`, `Then`, `AmendMeasurementDecideTests`, `FlightOpened`, `OpenFlightDecideTests`, `ReflightSelection`, `SystemClock`, `SeeingWhatIsRecordedSteps`, `Competition`, `RecordingAReflightRulingSteps`, `RecordCompetitionPenalty`, `FinaliseDecideTests`, `GliderscoreFixture`, `DateTimeOffset`, `.SetUpAsync`, `Competitor`, `PrescribingADrawSteps`, `EntryEventJsonTests`, `.BuildDrawnCompetition`, `.BuildDrawnCompetition`, `Round`, `.MapQueries`, `FakeEventStore`, `.RunPayoffCaptureScenarioAsync`, `.DrawnCompetitionAsync`, `DrawAcceptanceDecideTests`, `.New`, `.SeedCompetition`, `.BuildDrawnCompetition`, `ReflightRule`, `RecordEntryPenaltyDecideTests`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `CompetitionId` connect `CompetitionId` to `.Decide`, `Soarscore.Domain.PublishedClassDefinition`, `.LoadCurrentAsync`, `FakeEntryQuery`, `.HandleAsync`, `.HandleAsync`, `DrawingACatalogueChoicePhaseSteps`, `.AppendAsync`, `.Of`, `.New`, `CapturingAScoreSteps`, `ICommandHandler`, `IStoreFixture`, `CompetitionSummary`, `EntryCapturePropertyTests`, `DrawAcceptanceEventStoreTests`, `ClosingACompetitionSteps`, `DrawPhase`, `Entry`, `.SeedCompetition`, `AnnulEntryDecideTests`, `GroupId`, `AcceptingTheDrawSteps`, `Then`, `AmendMeasurementDecideTests`, `SystemClock`, `FlightOpened`, `OpenFlightDecideTests`, `SeeingWhatIsRecordedSteps`, `.Exact`, `Competition`, `RecordingAReflightRulingSteps`, `RecordCompetitionPenalty`, `.SeedOpenEntry`, `GliderscoreFixture`, `.SetUpAsync`, `PrescribingADrawSteps`, `EntryEventJsonTests`, `FakeEventStore`, `.MapQueries`, `.RunPayoffCaptureScenarioAsync`, `.DrawnCompetitionAsync`, `.New`, `PublishClassDefinition`, `RecordEntryPenaltyDecideTests`?**
...
- **Should `NumberOrParam` be split into smaller, more focused modules?**
