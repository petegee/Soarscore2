# Graph Report - SoarScore2  (2026-08-27)

## Corpus Check
- 556 files · ~935,676 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6539 nodes · 16878 edges · 350 communities (339 shown, 11 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1851 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `809df3f0`
...
4. `Soarscore.Domain.PublishedClassDefinition` - 165 edges
...
## Communities (350 total, 11 thin omitted)

### Community 0 - ".Select"
Cohesion: 0.08
Nodes (25): Role, ReflightRole, Entitled, Filler, Original, ReflightSelection, BetterOf, NotPermitted (+17 more)
...
### Community 2 - ".HandleAsync"
Cohesion: 0.14
Nodes (18): IsBogus, CancellationToken, IClock, IEventStore, Task, RegisterCompetitorHandler, DateTimeOffset, Fact (+10 more)

### Community 3 - "FakeEntryQuery"
Cohesion: 0.10
Nodes (37): CancellationToken, IClock, IEventStore, Task, BindParameterHandler, CancellationToken, IClock, IEventStore (+29 more)

### Community 4 - "IStoreFixture"
Cohesion: 0.08
Nodes (30): CancellationToken, IClock, IEventStore, Task, ChangePersonContactDetails, ChangePersonContactDetailsHandler, CancellationToken, IClock (+22 more)
...
### Community 11 - "Soarscore.Application"
Cohesion: 0.09
Nodes (18): Soarscore.Infrastructure.Competitions, Soarscore.Infrastructure.Tests, Soarscore.Infrastructure.CompetitionClasses, Soarscore.Infrastructure.People, Soarscore.Application.Queries.People, Soarscore.Infrastructure, Soarscore.Application.Queries.CompetitionClasses, Soarscore.Application (+10 more)
...
Cohesion: 0.15
Nodes (24): aggregate, dropped, DropPolicy, ApplyWhenResultsAtLeast, ApplyWhenRoundsCompletedAtLeast, Dimension, DropCount, ImmutableArray (+16 more)
...
Cohesion: 0.10
Nodes (29): IQueryHandler, CancellationToken, IClock, IEventStore, Task, ChangePersonClubAffiliation, ChangePersonClubAffiliationHandler, CancellationToken (+21 more)

### Community 16 - "PostgresFixture"
Cohesion: 0.04
Nodes (43): IAsyncLifetime, PostgresCatalogueDrawEventStoreTests, PostgresCompetitionEventStoreTests, SqliteCompetitionEventStoreTests, PostgresCompetitorEventStoreTests, SqliteCompetitorEventStoreTests, PostgresDrawAcceptanceEventStoreTests, SqliteDrawAcceptanceEventStoreTests (+35 more)
...
Cohesion: 0.05
Nodes (80): ICommand, ICommandHandler, IHttpMaxRequestBodySizeFeature, WebApplication, Commands, IReadOnlyList, WebApplication, Composition (+72 more)

### Community 19 - "PhaseDrawn"
Cohesion: 0.08
Nodes (35): Func, DeclaredResult, Aggregate, CompetitorRef, Placing, Promoted, DateTimeOffset, Group (+27 more)
...
Cohesion: 0.09
Nodes (6): Soarscore.Application.Tests, Soarscore.Application.Tests.Commands.CompetitionClasses, Soarscore.Application.Tests.Shared.CompetitionClasses, Soarscore.Application.Shared.CompetitionClasses, Soarscore.Application.Commands.CompetitionClasses, Soarscore.Application.Tests.Queries.CompetitionClasses
...
### Community 27 - "PrescribingADrawSteps"
Cohesion: 0.16
...
Cohesion: 0.11
Nodes (17): Competition, ImmutableArray, CompetitionView, ImmutableArray, CompetitionScoreView, CompetitorFinalScoreView, DateTimeOffset, Dictionary (+9 more)
...
### Community 31 - "DrawPhase"
Cohesion: 0.10
Nodes (32): CancellationToken, IClock, IEventStore, Task, DrawPhaseHandler, AdoptedRules, Store, AdoptedRules (+24 more)

### Community 32 - "Entry"
Cohesion: 0.10
Nodes (26): DateTimeOffset, Func, ImmutableArray, Penalty, PenaltyRecorded, Result, Entry, Annulment (+18 more)
...
Cohesion: 0.15
Nodes (20): GroupNo, KeyCollection, PilotNo, RoundNo, IEventStore, Competition, Dictionary, Entry (+12 more)
...
Cohesion: 0.10
Nodes (16): IParsable, Guid, IFormatProvider, GroupId, Dictionary, Given, Group, HttpClient (+8 more)
...
Cohesion: 0.10
Nodes (22): Bindings, ClassDef, ExpectedRawScore, CapScope, PerFlight, PerTask, AllFlights, RateTerm (+14 more)
...
### Community 47 - "EntryId"
Cohesion: 0.09
Nodes (25): CancellationToken, IClock, IEventStore, Task, CaptureMeasurement, CaptureMeasurementHandler, CancellationToken, Entry (+17 more)
...
### Community 54 - "SoarscoreEventTypes"
Cohesion: 0.50
...
### Community 56 - "FakeClassLibraryQuery"
Cohesion: 0.44
...
Cohesion: 0.21
Nodes (14): CancellationToken, IClock, IEventStore, Task, OpenFlight, OpenFlightHandler, Competition, TaskResolver (+6 more)

### Community 59 - "Enumerations.cs"
Cohesion: 0.07
Nodes (28): PromotionRule, CarryPenalties, Kind, MaxGroupSize, MinGroupSize, TopN, TopPercent, CompositionKind (+20 more)
...
Cohesion: 0.18
Nodes (15): CancellationToken, IClock, IEventStore, Task, AnnulEntry, AnnulEntryHandler, CancellationToken, DateTimeOffset (+7 more)

### Community 63 - ".Rank"
Cohesion: 0.15
Nodes (15): Disqualified, FinalRankingKind, LastPhaseReplaces, SinglePhase, SplitByPromotion, ImmutableArray, RankingEngine, CompetitionResult (+7 more)
...
### Community 66 - "Entries/TestDoubles.cs"
Cohesion: 0.11
...
### Community 67 - "ScoringResultTypes.cs"
Cohesion: 0.09
Nodes (22): RoundingMode, Ceiling, HalfUp, Truncate, Rounding, RoundingSupport, IReadOnlyDictionary, FlightResult (+14 more)

### Community 68 - "PenaltyDefinition"
Cohesion: 0.20
Nodes (19): AccruedInfo, PenaltyDefinition, Accrual, Effects, ExclusionGroups, InfractionType, PenaltyEffectSpec, Dictionary (+11 more)
...
Cohesion: 0.18
Nodes (19): CancellationToken, Competition, Entry, IEventStore, ImmutableArray, IReadOnlyDictionary, Task, EntryGapsView (+11 more)
...
### Community 81 - "B.1.2 Classification of model aircraft"
Cohesion: 0.10
...
### Community 83 - ".Compute_against_a_hand_built_three_round_fixture_matches_hand_computed_counts"
Cohesion: 0.33
...
Cohesion: 0.20
Nodes (15): CancellationToken, IClock, IEventStore, Task, RecordReflightRulingHandler, DateTimeOffset, SystemClock, UtcNow (+7 more)
...
Cohesion: 0.23
Nodes (12): SlotCapture, IReadOnlyList, GliderscoreFixture, ScoresRow, HttpClient, IReadOnlyDictionary, IReadOnlyList, List (+4 more)

### Community 102 - "TaskRound"
Cohesion: 0.12
Nodes (16): ImmutableArray, ImmutableDictionary, PairwiseCoOccurrence, PairwiseCoOccurrenceEntry, Group, Round, IsCompleteOrAnnulled, IsFullyFlown (+8 more)
...
Cohesion: 0.15
Nodes (12): EventKind, phaseCount, roundsPerPhase, targetPhase, targetTaskRound, taskRoundsPerRound, Dictionary, Gen (+4 more)
...
Cohesion: 0.11
Nodes (23): IClassFixture, CancellationToken, IClock, IEventStore, Task, PublishClassDefinition, PublishClassDefinitionHandler, Guid (+15 more)
...
Cohesion: 0.05
Nodes (41): closure, ClosureKind, fieldSize, ImmutableArray, PhaseDefinition, Drops, Ordinal, Promotion (+33 more)

### Community 122 - "FinaliseValidityPropertyTests"
Cohesion: 0.11
Nodes (18): minRounds, minTasks, outcomes, RoundOutcome, RoundComposition, Kind, MaxRounds, RequireDistinctTaskPerRound (+10 more)
...
### Community 124 - ".SelectAndScore"
Cohesion: 0.32
Nodes (5): ImmutableArray, IReadOnlyDictionary, FlightSelector, InterpretedFlight, Metrics
...
### Community 129 - "SeeingWhatIsRecordedSteps"
Cohesion: 0.22
...
Cohesion: 0.10
Nodes (17): IConfiguration, IServiceCollection, CancellationToken, IDocumentSessionFactory, IReadOnlyList, Task, DocumentEntryQuery, DocumentStore (+9 more)

### Community 138 - "DateTimeOffset"
Cohesion: 0.15
Nodes (17): ResolvedSchedule, Round, DateTimeOffset, ImmutableArray, Result, Draw, CreatedAt, Status (+9 more)
...
Cohesion: 0.16
Nodes (10): Task, Then, When, ReplaySteps, Fixture, ComparisonReport, AllGrainsExact, Conserves (+2 more)
...
### Community 153 - "F3B.1 GENERAL RULES"
Cohesion: 0.17
...
Cohesion: 0.05
Nodes (37): TaskDefinition, Code, Flights, FlightValidWhen, Group, Metrics, Name, Normalise (+29 more)
...
### Community 161 - "AcceptanceFixture"
Cohesion: 0.18
...
### Community 171 - "F5J — RC Electric Powered Thermal Duration Gliders"
Cohesion: 0.25
...
### Community 174 - "OpenEntryHandlerTests.cs"
Cohesion: 0.31
...
### Community 175 - ".ScoreGroup"
Cohesion: 0.25
Nodes (7): ImmutableDictionary, GroupResult, ImmutableArray, ImmutableDictionary, IReadOnlyDictionary, Penalty, ScoringService
...
### Community 178 - "IServiceProvider"
Cohesion: 0.19
...
### Community 196 - "ScoringVocabulary.cs"
Cohesion: 0.08
...
Cohesion: 0.31
Nodes (8): CancellationToken, ExpectedVersion, Guid, IReadOnlyList, List, RecordedEvent, Task, FakeEventStore
...
### Community 214 - ".CreateDispatcher"
Cohesion: 0.21
...
### Community 223 - "PhaseAggregatorTests"
Cohesion: 0.36
...
### Community 234 - ".New"
Cohesion: 0.07
Nodes (31): FieldOp, Id, Competition, DateOnly, CompetitionCreated, Competition, Dictionary, Entries (+23 more)
...
### Community 246 - ".RunPayoffCaptureScenarioAsync"
Cohesion: 0.53
...
### Community 251 - "ClassDefinitionSummary"
Cohesion: 0.24
Nodes (8): DateTimeOffset, Guid, ClassDefinitionProjection, ClassDefinitionSummary, CancellationToken, IEvent, IReadOnlyList, Task

### Community 252 - ".CreateCompetitionAsync"
Cohesion: 0.47
Nodes (5): Fact, Task, DrawPhaseEventStoreTests, PostgresDrawPhaseEventStoreTests, SqliteDrawPhaseEventStoreTests
...
### Community 259 - ".Exact"
Cohesion: 0.06
Nodes (39): IEventStore, CancellationToken, IClock, IEventStore, Task, AmendMeasurementHandler, AdoptedRules, AdoptedAt (+31 more)

### Community 260 - ".CreateCompetitionAsync"
Cohesion: 0.67
Nodes (3): Fact, Task, CompetitorEventStoreTests
...
Cohesion: 0.07
Nodes (27): MetricDefinition, DeclaredBeforeLaunch, Kind, Name, Precision, Unit, ImmutableArray, SeedF5K (+19 more)

### Community 273 - ".DrawnCompetitionAsync"
Cohesion: 0.16
Nodes (15): CancellationToken, IClock, IEventStore, Task, AppendReflightGroupHandler, Competitors, CancellationToken, Competition (+7 more)

### Community 274 - "Result"
Cohesion: 0.06
Nodes (54): CancellationToken, Guid, IReadOnlyList, Task, ExpectedVersion, Any, IsAny, IsExact (+46 more)

### Community 275 - "MeasurementModel"
Cohesion: 0.67
Nodes (3): MeasurementModel, AmendmentCount, Metric

### Community 276 - "Competitor"
Cohesion: 0.33
Nodes (6): Competitor, CompetitorNumber, Id, PersonRef, RegisteredAt, WithdrawnAt

### Community 277 - "2.3 TIMING"
Cohesion: 0.40
...
### Community 280 - "F3B — RC Multi-Task Gliders"
Cohesion: 0.22
...
### Community 281 - "test_property_b_record_count_equality_and_field_identity"
Cohesion: 0.32
...
### Community 284 - "F3K.2 DEFINITION OF MODEL GLIDER"
Cohesion: 0.29
...
### Community 285 - "F3K.9 DEFINITION OF A ROUND"
Cohesion: 0.29
...
### Community 301 - "Story — Re-flight scores: aggregate destination ≠ entry's round"
Cohesion: 0.40
Nodes (4): Before starting, Story — Re-flight scores: aggregate destination ≠ entry's round, What, Why it matters
...
### Community 304 - "F3B.2 RULES FOR MULTI-TASK CONTESTS"
Cohesion: 0.18
...
### Community 305 - "F3G.2 RULES FOR MULTI-TASK CONTESTS"
Cohesion: 0.20
...
### Community 306 - "CompetitorId"
Cohesion: 0.08
Nodes (25): CompetitorId, FlightOpened, SubjectIndex, DateTimeOffset, Fact, Func, Group, ImmutableArray (+17 more)

### Community 307 - "DocumentClassLibraryQuery"
Cohesion: 0.38
...
### Community 318 - "Story — Harness replay scenarios for the five NZ fixtures"
Cohesion: 0.40
Nodes (4): Before starting, Story — Harness replay scenarios for the five NZ fixtures, What, Why it matters

### Community 319 - "f3k-southern-fling/ladder.py"
Cohesion: 0.36
...
### Community 320 - "EventKind"
Cohesion: 0.40
Nodes (5): EventKind, Annul, AppendGroup, Complete, Reopen

### Community 321 - "FakeServiceProvider"
Cohesion: 0.67
Nodes (3): Type, Dictionary, FakeServiceProvider

### Community 323 - "SeedF5J"
Cohesion: 0.09
Nodes (20): Builder, Rows, LookupRow, ImmutableArray, Rows, ImmutableArray, SeedF3J, Definition (+12 more)

### Community 324 - "Annulment"
Cohesion: 0.50
Nodes (4): Annulment, At, By, Reason

### Community 325 - "DecideFlightModel"
Cohesion: 0.32
Nodes (7): DecideFlightModel, List, DecideFlightModel, Measurements, Sequence, DecideModel, Flights

### Community 326 - "Soarscore.SeedData"
Cohesion: 0.07
Nodes (11): Soarscore.Application.Tests.Queries.Competitions, Soarscore.Application.Tests.Shared.Competitions, Soarscore.SeedData, Soarscore.Application.Tests.Commands.Competitions, JsonSerializerContext, Intrinsic, ImmutableArray, Corpus (+3 more)
...
### Community 328 - "Soarscore.Application.Queries.Competitions"
Cohesion: 0.15
Nodes (14): Soarscore.Application.Commands.Entries, Soarscore.Application.Commands.People, Soarscore.Api.Commands, Soarscore.Acceptance.Tests.Support, Soarscore.Api.Queries, Soarscore.Application.Queries.Competitions, Soarscore.Application.Queries.Scoring, Soarscore.Acceptance.Tests.Support.Gliderscore (+6 more)
...
### Community 336 - "EntryEventJsonTests"
Cohesion: 0.47
Nodes (3): DateTimeOffset, Fact, EntryEventJsonTests

### Community 337 - "F3J.11 FINAL CLASSIFICATION"
Cohesion: 0.40
...
### Community 338 - "F3J.1 GENERAL RULES"
Cohesion: 0.40
...
- **Why does `ClassDefinition` connect `ClassDefinition` to `.Select`, `SeeingWhatIsRecordedSteps`, `.HandleAsync`, `.Exact`, `FakeEntryQuery`, `WithdrawCompetitorHandler`, `.CreateCompetitionAsync`, `ClassDefinitionPublished`, `CatalogueDrawPropertyTests`, `.CheckLimits`, `.Of`, `PrescribeDrawDecideTests`, `PrescribedRound`, `.New`, `MetricDefinition`, `Then`, `CompetitionId`, `PhaseDrawn`, `.DrawnCompetitionAsync`, `EntryModelBasedFoldTests`, `MeasuredValue`, `TaskDefinition`, `ClosingACompetitionSteps`, `.New`, `FixtureModels.cs`, `DrawPhase`, `GroupId`, `AcceptingTheDrawSteps`, `ScoringACompetitionSteps`, `GetCompetition`, `ResolvedTask`, `BindParameterPropertyTests`, `.ScoreGroup`, `EntryId`, `RecordingAReflightRulingSteps`, `CompetitorId`, `RecordCompetitionPenalty`, `FinaliseDecideTests`, `OpenFlight`, `Enumerations.cs`, `SeedF3K`, `.Rank`, `.ScoreCompetition`, `SeedF5J`, `PenaltyDefinition`, `Soarscore.SeedData`, `.SetUpAsync`, `.CompetitionAdopting`, `CreateCompetitionPropertyTests`, `ClassDefinitionValidationPropertyTests`, `CreateCompetition`, `RecordEntryPenalty`, `ClassDefinitionProjectionPropertyTests`, `.Apply`, `.BuildDrawnCompetition`, `.MapQueries`, `.BuildDispatcher`, `RulesAmendment`, `.Minimal`, `.CreateDispatcher`, `SystemClock`, `GliderscoreFixture`, `CompetitionReplaceTaskRoundPropertyTests`, `.New`, `PublishClassDefinition`, `.SeedCompetition`, `.Decide`, `.RunPayoffCaptureScenarioAsync`, `DrawAcceptancePropertyTests`, `PhaseDefinition`, `FinaliseValidityPropertyTests`, `.CreateCompetitionAsync`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `CompetitorId` connect `CompetitorId` to `.Select`, `Soarscore.Domain.PublishedClassDefinition`, `.HandleAsync`, `FakeEntryQuery`, `IStoreFixture`, `WithdrawCompetitorHandler`, `SeeingWhatIsRecordedSteps`, `.Exact`, `CatalogueDrawPropertyTests`, `.AddSoarscoreInfrastructure`, `DateTimeOffset`, `.Of`, `PrescribedRound`, `PrescribeDrawDecideTests`, `.New`, `Then`, `CompetitionId`, `PhaseDrawn`, `Competitor`, `.DrawnCompetitionAsync`, `EntryCapturePropertyTests`, `PrescribingADrawSteps`, `ClosingACompetitionSteps`, `.New`, `DrawPhase`, `Entry`, `IEventStore`, `AnnulEntryDecideTests`, `GroupId`, `AcceptingTheDrawSteps`, `ScoringACompetitionSteps`, `AmendMeasurementDecideTests`, `.Apply`, `OpenFlightDecideTests`, `GetCompetition`, `TaskRoundRecordingPropertyTests`, `Competition`, `RecordingAReflightRulingSteps`, `RecordCompetitionPenalty`, `.ScoreCompetition`, `.SetUpAsync`, `RecordEntryPenalty`, `.BuildDrawnCompetition`, `EntryEventJsonTests`, `.Compute_against_a_hand_built_three_round_fixture_matches_hand_computed_counts`, `.MapQueries`, `.CreateDispatcher`, `SystemClock`, `DrawAcceptanceDecideTests`, `GliderscoreFixture`, `TaskRound`, `.New`, `.SeedCompetition`, `.RunPayoffCaptureScenarioAsync`, `PhaseDefinition`, `.CreateCompetitionAsync`, `RecordEntryPenaltyDecideTests`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `Soarscore.Domain.PublishedClassDefinition` connect `Soarscore.Domain.PublishedClassDefinition` to `ScoringResultTypes.cs`, `ScoringVocabulary.cs`, `Soarscore.SeedData`, `Soarscore.Domain`, `Soarscore.Application.Queries.Competitions`, `ClassDefinitionPublished`, `Soarscore.Application`, `.Aggregate`, `OpenEntryHandlerTests.cs`, `PostgresFixture`, `NumberOrParam`, `PhaseDrawn`, `Soarscore.Application.Commands.CompetitionClasses`, `Enumerations.cs`, `FixtureModels.cs`?**
...
- **Should `.Select` be split into smaller, more focused modules?**
...
- **Should `Soarscore.Domain.PublishedClassDefinition` be split into smaller, more focused modules?**
  _Cohesion score 0.08125854993160055 - nodes in this community are weakly interconnected._
- **Should `.HandleAsync` be split into smaller, more focused modules?**
