...
## Corpus Check
- 571 files · ~968,178 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6635 nodes · 17460 edges · 340 communities (325 shown, 15 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1875 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `573f0379`
...
1. `CompetitionId` - 189 edges
2. `CompetitorId` - 188 edges
3. `ClassDefinition` - 176 edges
4. `Soarscore.Domain.PublishedClassDefinition` - 170 edges
5. `Competition` - 148 edges
6. `Soarscore.Domain.Competitions` - 137 edges
7. `Result` - 119 edges
8. `EntryId` - 101 edges
9. `Soarscore.Domain.People` - 95 edges
10. `Soarscore.SeedData` - 93 edges
...
## Communities (340 total, 15 thin omitted)

### Community 0 - ".Select"
Cohesion: 0.18
Nodes (8): CountsFor, Role, IReadOnlyList, ReflightSelector, Fact, InlineData, Theory, ReflightSelectorTests

### Community 1 - "Soarscore.Domain.PublishedClassDefinition"
Cohesion: 0.06
Nodes (10): Soarscore.Domain.Scoring, Soarscore.Domain.Tests, Soarscore.Domain.Competitions, Soarscore.Domain.People, Soarscore.SeedData, Soarscore.Domain.PublishedClassDefinition, Soarscore.Application.Tests.Queries.Scoring, JsonSerializerContext (+2 more)

### Community 2 - "EntryOpened"
Cohesion: 0.21
Nodes (18): CancellationToken, IClock, IEventStore, Task, OpenEntryHandler, EntrySummary, Competitors, EntryOpened (+10 more)

### Community 3 - "ReflightingForAMissedRoundSteps"
Cohesion: 0.13
Nodes (11): Dictionary, Given, Group, HttpClient, HttpResponseMessage, IReadOnlyList, List, ProblemDetails (+3 more)

### Community 4 - "SystemClock"
Cohesion: 0.13
Nodes (25): CancellationToken, IEventStore, Task, GetCompetition, GetCompetitionHandler, DateTimeOffset, SystemClock, UtcNow (+17 more)
...
Cohesion: 0.09
Nodes (12): Soarscore.Application.Tests.Commands.Entries, Soarscore.Application.Shared.Entries, Soarscore.Application.Commands.Competitions, Soarscore.Application.Commands.Entries, Soarscore.Application.Tests.Shared.Competitions, Soarscore.Application.Tests.Queries.Entries, Soarscore.Domain.Entries, Soarscore.Application.Queries.Entries (+4 more)

### Community 8 - "CatalogueDrawPropertyTests"
Cohesion: 0.07
Nodes (26): MinPerGroupByRound, Remaining, Sizes, Rounds, Dictionary, IEnumerable, ImmutableArray, PhaseDraw (+18 more)
...
Cohesion: 0.17
Nodes (12): Given, HttpClient, HttpResponseMessage, IEnumerable, IReadOnlyList, List, Table, Task (+4 more)
...
### Community 14 - ".New"
Cohesion: 0.15
Nodes (9): Store, ArgumentException, DateTimeOffset, Fact, CompetitionFoldTests, Fact, InlineData, Theory (+1 more)

### Community 15 - ".BuildDispatcher"
Cohesion: 0.21
Nodes (16): IQuery, IClock, IEventStore, RenamePerson, RenamePersonHandler, CancellationToken, IEventStore, Task (+8 more)

### Community 16 - "Soarscore.Application"
Cohesion: 0.03
Nodes (66): Soarscore.Infrastructure.Competitions, Soarscore.Infrastructure.Tests, Soarscore.Infrastructure.CompetitionClasses, Soarscore.Infrastructure.People, Soarscore.Application.Tests.Queries.Competitions, Soarscore.Application.Tests.Shared.People, Soarscore.Application.Queries.People, Soarscore.Infrastructure (+58 more)

### Community 17 - "Then"
Cohesion: 0.10
Nodes (16): Then, When, Dictionary, Given, Group, HttpClient, HttpResponseMessage, List (+8 more)

### Community 18 - "IStoreFixture"
Cohesion: 0.07
Nodes (46): ICommandHandler, CancellationToken, IClock, IEventStore, ImmutableArray, Task, FinaliseCompetition, FinaliseCompetitionHandler (+38 more)

### Community 19 - "PhaseDrawn"
Cohesion: 0.09
Nodes (29): PenaltyRecorded, DateTimeOffset, Group, ImmutableArray, Penalty, ReflightRuling, Round, CompetitionEvent (+21 more)

### Community 20 - "DispatcherTests"
Cohesion: 0.20
...
Cohesion: 0.08
Nodes (18): CancellationToken, IReadOnlyList, Task, GroupId, ReflightRole, CancellationToken, IReadOnlyList, Task (+10 more)

### Community 22 - "ClassDefinition"
Cohesion: 0.13
Nodes (17): HashSet, IReadOnlyDictionary, List, Phase, Task, ClassDefinitionValidation, ClassDefinition, FaiDesignation (+9 more)

### Community 23 - "MeasuredValue"
Cohesion: 0.10
Nodes (26): Exception, Parameter, AllowedValues, BoundAt, DefaultValue, Kind, Name, Unit (+18 more)

### Community 24 - "Soarscore.Application.Commands.CompetitionClasses"
Cohesion: 0.07
Nodes (13): Soarscore.Application.Tests, Soarscore.Application.Tests.Commands.CompetitionClasses, Soarscore.Api.Commands, Soarscore.Application.Queries.CompetitionClasses, Soarscore.Application.Tests.Shared.CompetitionClasses, Soarscore.Application.Shared.CompetitionClasses, Soarscore.Application.Commands.CompetitionClasses, Soarscore.Api.Routing (+5 more)
...
Cohesion: 0.11
Nodes (16): ImmutableArray, CompetitionView, PairwiseCoOccurrenceEntry, ImmutableArray, CompetitionScoreView, DateTimeOffset, Dictionary, Given (+8 more)

### Community 29 - ".New"
Cohesion: 0.17
Nodes (10): TaskRoundState, Competitors, DateTimeOffset, Fact, ImmutableArray, InlineData, Round, RoundGroupRefs (+2 more)

### Community 30 - "GliderscoreFixture"
Cohesion: 0.15
Nodes (25): JsonElement, List, Dictionary, IReadOnlyList, CompetitionFile, CompetitionIdentity, CompetitionScoring, CompPilotRow (+17 more)

### Community 31 - "Competition"
Cohesion: 0.04
Nodes (77): ResolvedSchedule, TaskResolver, Round, Group, DateOnly, DateTimeOffset, Defect, Func (+69 more)

### Community 32 - "Entry"
Cohesion: 0.08
Nodes (35): DateTimeOffset, Func, ImmutableArray, Penalty, PenaltyRecorded, Result, Amendment, At (+27 more)
...
Cohesion: 0.18
Nodes (14): GroupNo, KeyCollection, PilotNo, RoundNo, IEventStore, Dictionary, HashSet, HttpClient (+6 more)
...
### Community 40 - "DrawPhaseHandler"
Cohesion: 0.17
Nodes (17): CancellationToken, IClock, IEventStore, Task, DrawPhaseHandler, AdoptedRules, DateTimeOffset, Fact (+9 more)
...
Cohesion: 0.12
Nodes (22): GenEntry, GenFlight, Noise, PlacedEntry, Shape, DateTimeOffset, Fact, Gen (+14 more)

### Community 47 - ".Exact"
Cohesion: 0.06
Nodes (36): CancellationToken, IClock, IEventStore, Task, CaptureMeasurementHandler, AdoptedRules, AdoptedAt, Definition (+28 more)

### Community 48 - ".BuildDispatcher"
Cohesion: 0.25
...
Cohesion: 0.21
Nodes (6): DateTimeOffset, Fact, ImmutableArray, InlineData, Theory, FinaliseDecideTests

### Community 56 - ".ScoreGroup"
Cohesion: 0.25
Nodes (7): GroupResult, ImmutableArray, ImmutableDictionary, IReadOnlyDictionary, Penalty, EmittedCell, ScoringService
...
### Community 59 - "FakeClock"
Cohesion: 0.20
Nodes (10): IClock, DateTimeOffset, FakeClock, UtcNow, DateTimeOffset, FakeClock, UtcNow, DateTimeOffset (+2 more)
...
Cohesion: 0.13
Nodes (20): CancellationToken, IClock, IEventStore, Task, AnnulEntryHandler, CancellationToken, IEventStore, Task (+12 more)

### Community 63 - "NumberOrParamConverter"
Cohesion: 0.23
Nodes (9): JsonSerializerOptions, ClassDefinitionHashing, Type, Ref, JsonSerializerOptions, Utf8JsonReader, Utf8JsonWriter, FlagOrParamConverter (+1 more)
...
Cohesion: 0.13
Nodes (22): CancellationToken, IEventStore, Task, RecordEntryPenalty, RecordEntryPenaltyHandler, Penalty, By, CompetitorRef (+14 more)
...
Cohesion: 0.06
Nodes (49): AccruedInfo, PenaltyDefinition, Accrual, Effects, ExclusionGroups, InfractionType, PenaltyEffectSpec, PenaltyAccrual (+41 more)
...
Cohesion: 0.20
Nodes (17): CancellationToken, IEventStore, ImmutableArray, IReadOnlyDictionary, Task, EntryGapsView, FlightGapsView, GetTaskRoundRecording (+9 more)
...
Cohesion: 0.07
Nodes (58): ICommand, IHttpMaxRequestBodySizeFeature, WebApplication, Commands, IReadOnlyList, WebApplication, Composition, CancellationToken (+50 more)
...
### Community 81 - ".LoadAsync"
Cohesion: 0.16
Nodes (15): CancellationToken, IClock, IEventStore, Task, AmendMeasurementHandler, CancellationToken, IEventStore, Task (+7 more)
...
Cohesion: 0.15
Nodes (18): IReadOnlyList, WebApplication, Queries, CancellationToken, IEventStore, ImmutableArray, IReadOnlyDictionary, IReadOnlyList (+10 more)
...
Cohesion: 0.12
Nodes (15): 1. Pilot assignment to groups (the draw), 2. Data the timer / helper collects, 3. Group score (`F3K.9.1`), 4. Round score, 5. Final classification (`F3K.10`), 6. Re-flights (`F3K.9.6`, `F3K.4.2`, `F3K.2.4`), F3K — RC Hand-Launch Gliders, Penalty schedule (+7 more)
...
Cohesion: 0.20
Nodes (5): IReadOnlyList, Task, Then, When, HarnessSelfCheckSteps

### Community 92 - ".DrawnCompetitionAsync"
Cohesion: 0.24
Nodes (11): CancellationToken, IClock, IEventStore, Task, RecordReflightRulingHandler, CancellationToken, Fact, List (+3 more)

### Community 93 - "ExpectedVersion"
Cohesion: 0.17
Nodes (13): ExpectedVersion, Any, IsAny, IsExact, IsNoStream, NoStream, Version, Kind (+5 more)

### Community 94 - "Comparison"
Cohesion: 0.17
Nodes (11): Comparator, AllOf, Children, Comparison, LeftMetricRef, RightMetricRef, RightValue, Predicate (+3 more)
...
### Community 102 - "ReflightRule"
Cohesion: 0.15
Nodes (14): ReflightRule, EntitledScores, MinNewGroupSize, OthersScore, ReflightSelection, Competitors, DateTimeOffset, Dictionary (+6 more)
...
Cohesion: 0.14
Nodes (13): EventKind, phaseCount, roundsPerPhase, targetPhase, targetTaskRound, taskRoundsPerRound, Dictionary, Gen (+5 more)
...
Cohesion: 0.07
Nodes (43): Hash, IClassFixture, Round2GroupRef, CancellationToken, IClock, IEventStore, Task, PublishClassDefinition (+35 more)
...
Cohesion: 0.15
Nodes (13): DrawOp, Op, DateTimeOffset, Gen, List, DrawAcceptancePropertyTests, DrawOp, Model (+5 more)
...
### Community 122 - "PrescribeDrawDecideTests"
Cohesion: 0.13
Nodes (16): Mutation, IReadOnlyList, PrescribedGroup, PrescribedRound, DateTimeOffset, Fact, ImmutableArray, IReadOnlyList (+8 more)
...
Cohesion: 0.26
Nodes (7): Competitors, DateTimeOffset, Fact, ImmutableArray, InlineData, Theory, RecordReflightRulingDecideTests
...
Cohesion: 0.09
Nodes (19): IConfiguration, IServiceCollection, DateTimeOffset, IClock, UtcNow, IDocumentSessionFactory, DocumentEntryQuery, CancellationToken (+11 more)

### Community 138 - "IServiceProvider"
Cohesion: 0.15
...
Cohesion: 0.08
Nodes (30): IsBogus, DateTimeOffset, Fact, FakeEventStore, Gen, ImmutableArray, DrawPhasePropertyTests, DateTimeOffset (+22 more)

### Community 141 - "Normalisation"
Cohesion: 0.13
Nodes (20): DropDimension, NormalisationDirection, PenaltyEffect, PhaseType, RoundingMode, WorkingTimeKind, Normalisation, Direction (+12 more)
...
Cohesion: 0.05
Nodes (43): actual, CompetitorModel, Actual, Model, FlightModel, MeasurementModel, model, Fact (+35 more)
...
### Community 152 - "ScoringVocabulary.cs"
Cohesion: 0.07
Nodes (35): CapScope, TargetAssignment, ImmutableArray, BestNFlights, Count, RankByMetric, Targets, TargetValues (+27 more)
...
Cohesion: 0.05
Nodes (47): TaskDefinition, Code, Flights, FlightValidWhen, Group, Metrics, Name, Normalise (+39 more)
...
### Community 161 - "PhaseDefinition"
Cohesion: 0.07
Nodes (27): closure, ClosureKind, fieldSize, ImmutableArray, PhaseDefinition, Drops, Ordinal, Promotion (+19 more)
...
### Community 168 - "PersonDecideTests"
Cohesion: 0.25
...
### Community 171 - "CompetitorId"
Cohesion: 0.12
Nodes (22): IParsable, CancellationToken, IClock, IEventStore, Task, RegisterCompetitorHandler, CancellationToken, IClock (+14 more)
...
### Community 175 - "DecimalAsStringConverter"
Cohesion: 0.31
Nodes (6): JsonConverter, JsonSerializerOptions, Utf8JsonReader, Utf8JsonWriter, DecimalAsStringConverter, SoarscoreEventJson
...
Cohesion: 0.17
Nodes (14): ScoreTerm, ImmutableArray, IReadOnlyDictionary, FlightSelector, IReadOnlyDictionary, FlightResult, FlightResultState, InterpretedFlight (+6 more)
...
### Community 214 - "Person"
Cohesion: 0.23
Nodes (8): DateTimeOffset, Defect, Result, Person, Club, Contact, Id, Name
...
### Community 252 - ".BuildDrawnCompetition"
Cohesion: 0.27
...
### Community 254 - "FinaliseValidityPropertyTests"
Cohesion: 0.18
Nodes (10): minRounds, minTasks, outcomes, RoundOutcome, taskRefs, DateTimeOffset, Gen, rounds (+2 more)
...
### Community 256 - "Path"
Cohesion: 0.36
Nodes (5): Path, IEnumerable, ImmutableArray, Term, test_fetch_comp_touches_network_only_through_the_kernel()
...
### Community 272 - "MetricDefinition"
Cohesion: 0.05
Nodes (36): MetricDefinition, DeclaredBeforeLaunch, Kind, Name, Precision, Unit, M, ImmutableArray (+28 more)
...
### Community 274 - ".AppendAsync"
Cohesion: 0.15
Nodes (17): CancellationToken, Guid, IReadOnlyList, Task, RecordedEvent, CancellationToken, Guid, IReadOnlyList (+9 more)
...
### Community 286 - "RankingEnginePropertyTests"
Cohesion: 0.50
Nodes (4): Disqualified, Gen, Score, RankingEnginePropertyTests

### Community 287 - ".Rank"
Cohesion: 0.24
Nodes (9): FinalRankingKind, ImmutableArray, RankingEngine, ImmutableDictionary, CompetitionResult, FinalCompetitorScore, Fact, Fact (+1 more)
...
### Community 291 - "PromotionRule"
Cohesion: 0.25
Nodes (8): PromotionRule, CarryPenalties, Kind, MaxGroupSize, MinGroupSize, TopN, TopPercent, PromotionKind

### Community 292 - "B.1.2 Classification of model aircraft"
Cohesion: 0.10
...
Cohesion: 0.11
Nodes (30): Decimal, encode(), extract_table(), _install_tolerant_parser_patch(), load_recovered_texts(), main(), merge_recovered_texts(), Loudly warn (once per affected table.column) about degraded reads. (+22 more)
...
### Community 306 - ".New"
Cohesion: 0.07
Nodes (28): FieldOp, Id, DateOnly, CompetitionCreated, DrawAccepted, Dictionary, Entries, Fact (+20 more)
...
Cohesion: 0.33
Nodes (5): Builder, Rows, LookupRow, ImmutableArray, Rows
...
### Community 328 - "SoarscoreEventTypes.cs"
Cohesion: 0.40
...
### Community 334 - "NumberOrParam"
Cohesion: 0.26
Nodes (6): Bands, FlagOrParam, Literal, NumberOrParam, Band, Bands
...
### Community 345 - "ComparisonReport"
Cohesion: 0.19
Nodes (10): Given, IEnumerable, IReadOnlyList, ComparisonReport, AllGrainsExact, Conserves, ConservationBreak, Detail (+2 more)
...
## Knowledge Gaps
- **1869 isolated node(s):** `context7`, `rider`, `$schema`, `.opencode/plugins/graphify.js`, `$(SoarscoreTargetFramework)` (+1864 more)
...
- **Why does `ClassDefinition` connect `ClassDefinition` to `Path`, `PublishedClassDefinition`, `EntryOpened`, `ReflightingForAMissedRoundSteps`, `SystemClock`, `WithdrawCompetitorHandler`, `Corpus.cs`, `ClassDefinitionPublished`, `CatalogueDrawPropertyTests`, `.CheckLimits`, `.BuildCompetition`, `.AppendAsync`, `.New`, `MetricDefinition`, `Then`, `.DrawnCompetitionAsync`, `PhaseDrawn`, `IStoreFixture`, `EntryModelBasedFoldTests`, `MeasuredValue`, `TaskDefinition`, `.HandleAsync`, `ClosingACompetitionSteps`, `.New`, `GliderscoreFixture`, `.Rank`, `Competition`, `PhaseDefinition`, `FlightOpened`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `ScoringACompetitionSteps`, `DrawPhaseHandler`, `ResolvedTask`, `BindParameterPropertyTests`, `ClassDefinitionEventJsonTests`, `.Exact`, `.BuildDispatcher`, `RecordingAReflightRulingSteps`, `.New`, `RecordCompetitionPenalty`, `FinaliseDecideTests`, `.ScoreGroup`, `ClassDefinitionProjectionPropertyTests`, `.SeedOpenEntry`, `SeedF3K`, `.ScoreCompetition`, `RecordEntryPenalty`, `PenaltyDefinition`, `.Of`, `.SetUpAsync`, `.CompetitionAdopting`, `CreateCompetitionPropertyTests`, `ClassDefinitionValidationPropertyTests`, `CompetitionId`, `.Apply`, `.BuildDrawnCompetition`, `.LoadAsync`, `.MapQueries`, `DrawAcceptanceEventStoreTests`, `.Validate`, `.DrawnCompetitionAsync`, `DrawAcceptanceDecideTests`, `ReflightRule`, `CompetitionReplaceTaskRoundPropertyTests`, `SeeingWhatIsRecordedSteps`, `PublishClassDefinition`, `.SeedCompetition`, `.BuildDrawnCompetition`, `DrawAcceptancePropertyTests`, `PrescribeDrawDecideTests`, `.BuildDrawnCompetition`, `FinaliseValidityPropertyTests`?**
  _High betweenness centrality (0.120) - this node is a cross-community bridge._
- **Why does `CompetitionId` connect `CompetitionId` to `EntryOpened`, `IProjection`, `SystemClock`, `ReflightingForAMissedRoundSteps`, `WithdrawCompetitorHandler`, `DrawingACatalogueChoicePhaseSteps`, `PrescribingADrawSteps`, `.AppendAsync`, `.New`, `CompetitionSummary`, `IStoreFixture`, `Then`, `.DrawnCompetitionAsync`, `GroupId`, `EntryCapturePropertyTests`, `.HandleAsync`, `ClosingACompetitionSteps`, `Competition`, `Entry`, `IEventStore`, `AnnulEntryDecideTests`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `ScoringACompetitionSteps`, `AmendMeasurementDecideTests`, `DrawPhaseHandler`, `FlightOpened`, `OpenFlightDecideTests`, `CompetitorId`, `.Exact`, `FindEntries`, `.New`, `RecordingAReflightRulingSteps`, `RecordCompetitionPenalty`, `.SeedOpenEntry`, `.Of`, `.SetUpAsync`, `.LoadAsync`, `.MapQueries`, `DrawAcceptanceEventStoreTests`, `.DrawnCompetitionAsync`, `ReplayDriver`, `SeeingWhatIsRecordedSteps`, `PublishClassDefinition`, `RecordEntryPenaltyDecideTests`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `CompetitorId` connect `CompetitorId` to `EntryOpened`, `ReflightingForAMissedRoundSteps`, `SystemClock`, `WithdrawCompetitorHandler`, `CatalogueDrawPropertyTests`, `.BuildCompetition`, `PrescribingADrawSteps`, `DropPolicy`, `.AppendAsync`, `.New`, `Then`, `IStoreFixture`, `PhaseDrawn`, `.DrawnCompetitionAsync`, `GroupId`, `EntryCapturePropertyTests`, `ClosingACompetitionSteps`, `.New`, `Competition`, `Entry`, `IEventStore`, `AnnulEntryDecideTests`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `ScoringACompetitionSteps`, `AmendMeasurementDecideTests`, `FlightOpened`, `OpenFlightDecideTests`, `DrawPhaseHandler`, `TaskRoundRecordingPropertyTests`, `FindEntries`, `.New`, `RecordingAReflightRulingSteps`, `RecordCompetitionPenalty`, `.ScoreCompetition`, `RecordEntryPenalty`, `PenaltyDefinition`, `.Of`, `.SetUpAsync`, `CompetitionId`, `.BuildDrawnCompetition`, `Round`, `.MapQueries`, `DrawAcceptanceEventStoreTests`, `.DrawnCompetitionAsync`, `DrawAcceptanceDecideTests`, `ReplayDriver`, `ReflightRule`, `SeeingWhatIsRecordedSteps`, `PublishClassDefinition`, `.SeedCompetition`, `.BuildDrawnCompetition`, `PrescribeDrawDecideTests`, `.BuildDrawnCompetition`, `RecordEntryPenaltyDecideTests`?**
...
- **Should `SystemClock` be split into smaller, more focused modules?**
  _Cohesion score 0.12522686025408347 - nodes in this community are weakly interconnected._