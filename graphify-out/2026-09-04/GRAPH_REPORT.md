...
## Corpus Check
- 643 files · ~1,101,695 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8038 nodes · 21790 edges · 384 communities (375 shown, 9 thin omitted)
...
## Communities (384 total, 9 thin omitted)

### Community 0 - "Competition"
Cohesion: 0.06
Nodes (27): DateOnly, DateTimeOffset, Defect, Penalty, PenaltyRecorded, ReflightRuling, Result, TaskRoundCoordinate (+19 more)
...
Cohesion: 0.20
Nodes (19): CancellationToken, IClock, IEventStore, Task, OpenEntryHandler, EntrySummary, Competitors, EntryOpened (+11 more)
...
Cohesion: 0.09
Nodes (37): IClassFixture, Round2GroupRef, CancellationToken, Competition, IEventStore, ImmutableArray, Task, CompetitionView (+29 more)
...
Cohesion: 0.06
Nodes (28): JsonConverter, JsonSerializerOptions, ClassDefinitionHashing, IReadOnlyList, JsonSerializerOptions, List, ClassDefinitionIngestion, JsonSerializerOptions (+20 more)
...
Cohesion: 0.14
Nodes (22): DropPolicy, ApplyWhenResultsAtLeast, ApplyWhenRoundsCompletedAtLeast, Dimension, DropCount, DropDimension, ByRound, ByTask (+14 more)

### Community 14 - ".New"
Cohesion: 0.08
Nodes (27): Id, Competition, DateOnly, CompetitionCreated, Competition, Dictionary, Entries, Entry (+19 more)
...
Cohesion: 0.09
Nodes (30): DurationDays, OffsetDays, Path, HashSet, IEnumerable, ImmutableArray, IReadOnlyDictionary, List (+22 more)
...
Cohesion: 0.14
Nodes (13): Soarscore.Infrastructure.Tests, Soarscore.Application.Commands.Entries, Soarscore.Application.Commands.People, Soarscore.Api.Commands, Soarscore.Acceptance.Tests.Support, Soarscore.Infrastructure, Soarscore.Api.Queries, Soarscore.Application.Queries.Competitions (+5 more)
...
### Community 32 - "Entry"
Cohesion: 0.09
Nodes (29): DateTimeOffset, Func, ImmutableArray, Penalty, PenaltyRecorded, Result, Entry, Annulment (+21 more)
...
Cohesion: 0.13
Nodes (20): Amendment, At, By, NewValue, Reason, DateTimeOffset, Penalty, EntryAnnulled (+12 more)
...
### Community 41 - "CaptureMeasurementDecideTests"
Cohesion: 0.32
...
Cohesion: 0.08
Nodes (38): DeclaredResult, Aggregate, CompetitorRef, Placing, Promoted, DateTimeOffset, Group, ImmutableArray (+30 more)
...
Cohesion: 0.13
Nodes (16): Contributes, StandingsSnapshot, CompetitionId, Dictionary, Given, Group, HashSet, HttpClient (+8 more)
...
Cohesion: 0.10
Nodes (31): ScoringTeamDefined, ScoringTeamMembershipAssigned, TeamClassificationConfigured, ProtectionGroup, Id, Name, ProtectionGroupMembership, CompetitorRef (+23 more)
...
Cohesion: 0.14
Nodes (11): Fact, InlineData, Theory, PhaseDrawnDecideTests, Mutation, DeleteMember, DuplicateMember, MoveBetweenGroups (+3 more)
...
Cohesion: 0.07
Nodes (64): ICommand, IHttpMaxRequestBodySizeFeature, IParsable, WebApplication, Commands, IReadOnlyList, WebApplication, Composition (+56 more)
...
### Community 93 - ".Create"
Cohesion: 0.08
Nodes (25): EventKind, phaseCount, roundsPerPhase, targetPhase, targetTaskRound, taskRoundsPerRound, Competition, DateTimeOffset (+17 more)
...
Cohesion: 0.08
Nodes (38): CountLetters, Echo, CancellationToken, IServiceProvider, Task, Type, Dispatcher, ICommand (+30 more)
...
Cohesion: 0.28
Nodes (10): RecordedEvent, IDomainEvent, CancellationToken, ExpectedVersion, Guid, IReadOnlyList, List, RecordedEvent (+2 more)
...
### Community 139 - "ReflightSelection"
Cohesion: 0.15
...
Cohesion: 0.04
Nodes (68): ImmutableArray, PhaseDefinition, Drops, Ordinal, Promotion, Rounds, Tasks, TieBreaks (+60 more)
...
### Community 170 - "Enumerations.cs"
Cohesion: 0.07
Nodes (26): RoundComposition, Kind, MaxRounds, RequireDistinctTaskPerRound, TasksPerRound, CompositionKind, ChooseFromCatalogue, FixedSequence (+18 more)
...
Cohesion: 0.07
Nodes (35): Bindings, ClassDef, ExpectedRawScore, AllFlights, FlightSelection, RateTerm, Cap, CapScope (+27 more)
...
Cohesion: 0.11
Nodes (22): IEventStore, CancellationToken, Entry, IEventStore, Task, Version, EntryLoader, Store (+14 more)
...
### Community 217 - "CompetitorId"
Cohesion: 0.11
Nodes (16): CompetitorFinalScoreView, Competition, Entry, ImmutableArray, IReadOnlyDictionary, EntryGapsView, FlightGapsView, GroupRecordingView (+8 more)
...
### Community 223 - "F3B.2 RULES FOR MULTI-TASK CONTESTS"
Cohesion: 0.18
...
Cohesion: 0.09
Nodes (23): Other, Competition, TaskResolver, GroupResult, ImmutableArray, ImmutableDictionary, IReadOnlyDictionary, Penalty (+15 more)
...
### Community 259 - "F3G.2 RULES FOR MULTI-TASK CONTESTS"
Cohesion: 0.20
...
Cohesion: 0.26
Nodes (12): IQuery, CancellationToken, IEventStore, Task, GetTaskRoundRecording, GetTaskRoundRecordingHandler, TaskRoundRecordingView, Fact (+4 more)
...
Cohesion: 0.09
Nodes (23): CancellationToken, IClock, IEventStore, Task, AssignGroupSpotsHandler, AdoptedRules, AdoptedAt, Definition (+15 more)
...
Cohesion: 0.04
Nodes (55): Bands, Builder, Rows, CapScope, PerFlight, PerTask, TargetAssignment, AnyOrder (+47 more)
...
Cohesion: 0.03
Nodes (59): IAsyncLifetime, PostgresBindParameterEventStoreTests, SqliteBindParameterEventStoreTests, PostgresCatalogueDrawEventStoreTests, SqliteCatalogueDrawEventStoreTests, PostgresCompetitorEventStoreTests, SqliteCompetitorEventStoreTests, PostgresDrawAcceptanceEventStoreTests (+51 more)
...
### Community 338 - "Story — F5K fixture from the GliderScore server DB export"
Cohesion: 0.33
Nodes (5): Before starting, Plan, Story — F5K fixture from the GliderScore server DB export, What, Why it matters

### Community 339 - ".DescribeContributors"
Cohesion: 0.40
Nodes (4): Func, Placing, Ref, Score

### Community 340 - "Competitor"
Cohesion: 0.33
...
Cohesion: 0.05
Nodes (20): Soarscore.Infrastructure.Competitions, Soarscore.Application.Tests.Commands.Entries, Soarscore.Application.Tests, Soarscore.Infrastructure.CompetitionClasses, Soarscore.Infrastructure.People, Soarscore.Application.Tests.Shared.People, Soarscore.Application.Queries.People, Soarscore.Application.Tests.Queries.Entries (+12 more)
...
### Community 358 - "Rounding"
Cohesion: 0.21
Nodes (7): RoundingMode, Ceiling, HalfUp, Truncate, Rounding, RoundingSupport, M
...
Cohesion: 0.06
Nodes (42): CancellationToken, Task, CancellationToken, Task, CancellationToken, Task, CancellationToken, Task (+34 more)
...
### Community 374 - "test_picker_dedupe_first_wins_and_sort_ordering_property"
Cohesion: 0.67
...
### Community 378 - "SeedAggregate"
Cohesion: 0.67
Nodes (3): SeedAggregate, Definition, TaskA

### Community 379 - "SeedF3F"
Cohesion: 0.67
...
## Knowledge Gaps
- **2261 isolated node(s):** `context7`, `rider`, `$schema`, `.opencode/plugins/graphify.js`, `$(SoarscoreTargetFramework)` (+2256 more)
...
- **Why does `ClassDefinition` connect `ClassDefinition` to `FakeEntryQuery`, `ReflightingForAMissedRoundSteps`, `SystemClock`, `CatalogueDrawPropertyTests`, `.CheckLimits`, `ScoringTeamCommandHandlerTests`, `.New`, `.Of`, `EntryId`, `IStoreFixture`, `DrawAcceptanceEventStoreTests`, `Corpus.cs`, `MeasuredValue`, `ClosingACompetitionSteps`, `.New`, `GliderscoreFixture`, `FlightOpened`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `ScoringACompetitionSteps`, `PenaltyDefinition`, `PhaseDrawn`, `RecordingAReflightRulingSteps`, `ScoringTeamsSteps`, `FinaliseDecideTests`, `.All_seven_team_events_round_trip_through_the_real_store_and_replay_to_the_expected_state`, `.SeedOpenEntry`, `SeedF5K`, `.HandleAsync`, `.BuildCompetition`, `GroupSpotsPropertyTests`, `.CompetitionAdopting`, `CompetitionId`, `.BuildDrawnCompetition`, `.HandleAsync`, `ScoringServicePropertyTests`, `.Validate`, `.DrawnCompetitionAsync`, `.Create`, `DrawAcceptanceDecideTests`, `IDispatcher`, `PublishClassDefinition`, `RecordCompetitionPenaltyDecideTests`, `.ScoreCompetition`, `PrescribeDrawDecideTests`, `WithdrawCompetitorHandler`, `SeedF3K`, `.BuildDrawnCompetition`, `EntryModelBasedFoldTests`, `TaskDefinition`, `PrescribeDrawPropertyTests`, `PublishedClassDefinition`, `Enumerations.cs`, `DrawAcceptancePropertyTests`, `ResolvedTask`, `ClassDefinitionValidationPropertyTests`, `.Apply`, `SeeingWhatIsRecordedSteps`, `.DrawnCompetitionAsync`, `SeedF5kNdc`, `.BuildCompetition`, `PersonId`, `.SetUpAsync`, `AdoptedRules`, `DrawPhase`, `SeedNzF3kNdc`, `RecordEntryPenaltyDecideTests`, `SeedF3J`, `NumberOrParam`, `.SeedEntryUnderF5K`, `.MapQueries`, `PostgresFixture`, `.BuildDispatcher`, `CompetitionResult`, `RegisterCompetitorPropertyTests`, `.SeedOpenEntryWithFlight`, `GroupId`, `ClassDefinitionPublished`, `ClassDefinitionEventJsonTests`, `SeedF3B`, `ClassDefinitionProjectionPropertyTests`, `SeedNzMAles200`, `SeedNzMNdc`, `RulesAmendment`, `SeedAggregate`, `SeedF3F`, `SeedNzNAles123`, `SeedNzPRadian`, `SeedX5j`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `CompetitorId` connect `CompetitorId` to `Competition`, `Soarscore.Domain.PublishedClassDefinition`, `FakeEntryQuery`, `ReflightingForAMissedRoundSteps`, `SystemClock`, `CatalogueDrawPropertyTests`, `ScoringTeamCommandHandlerTests`, `PrescribingADrawSteps`, `.New`, `.SeedWired`, `EntryId`, `IStoreFixture`, `ScoringTeamId`, `DrawAcceptanceEventStoreTests`, `EntryCapturePropertyTests`, `ClosingACompetitionSteps`, `.New`, `Entry`, `Comparator`, `FlightOpened`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `ScoringACompetitionSteps`, `AmendMeasurementDecideTests`, `.Exact`, `CaptureMeasurementDecideTests`, `TaskRoundRecordingPropertyTests`, `PhaseDrawn`, `RecordingAReflightRulingSteps`, `ScoringTeamsSteps`, `.All_seven_team_events_round_trip_through_the_real_store_and_replay_to_the_expected_state`, `.SeedScoredTeamCompetition`, `.BuildCompetition`, `GroupSpotsPropertyTests`, `TeamsDecideTests`, `CompetitionId`, `.BuildDrawnCompetition`, `.ComputeEntries`, `ScoringServicePropertyTests`, `.DrawnCompetitionAsync`, `.Create`, `DrawAcceptanceDecideTests`, `ReplayDriver`, `IDispatcher`, `RecordCompetitionPenaltyDecideTests`, `.ScoreCompetition`, `PrescribeDrawDecideTests`, `WithdrawCompetitorHandler`, `.Classify`, `ReflightSelection`, `.BuildDrawnCompetition`, `TaskDefinition`, `PrescribeDrawPropertyTests`, `OpenFlightDecideTests`, `DrawProtectionPropertyTests`, `SeeingWhatIsRecordedSteps`, `TeamClassificationEngineTests`, `TeamClassificationPropertyTests`, `.DrawnCompetitionAsync`, `.BuildCompetition`, `TaskRoundClosurePropertyTests`, `AssigningSpotsSteps`, `PersonId`, `.BuildDrawnCompetition`, `FindEntries`, `.SetUpAsync`, `AdoptedRules`, `.BuildGroups`, `DrawPhase`, `RecordEntryPenaltyDecideTests`, `PhaseDrawPropertyTests`, `AnnulEntryDecideTests`, `.MapQueries`, `.BuildDrawnCompetition`, `IEntryQuery`, `TaskRound`, `GroupId`, `.DescribeContributors`, `Competitor`, `EntryEventJsonTests`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `CompetitionId` connect `CompetitionId` to `Competition`, `Soarscore.Domain.PublishedClassDefinition`, `FakeEntryQuery`, `IProjection`, `SystemClock`, `PersonId`, `WithdrawCompetitorHandler`, `ScoringTeamCommandHandlerTests`, `FindEntries`, `.New`, `.SeedWired`, `IStoreFixture`, `.SetUpAsync`, `AdoptedRules`, `DrawAcceptanceEventStoreTests`, `EntryCapturePropertyTests`, `DrawPhase`, `Entry`, `RecordEntryPenaltyDecideTests`, `Comparator`, `FlightOpened`, `OpenFlightDecideTests`, `AmendMeasurementDecideTests`, `.Exact`, `CaptureMeasurementDecideTests`, `AnnulEntryDecideTests`, `.MapQueries`, `.SeedOpenEntry`, `.SeedScoredTeamCompetition`, `.HandleAsync`, `IEntryQuery`, `CompetitionSummary`, `RegisterCompetitorPropertyTests`, `.SeedOpenEntryWithFlight`, `GroupId`, `FakeEventStore`, `CompetitorId`, `.DrawnCompetitionAsync`, `EntryEventJsonTests`, `ReplayDriver`, `IDispatcher`, `Result`, `PublishClassDefinition`, `.DrawnCompetitionAsync`?**
...
- **Should `Soarscore.Domain.PublishedClassDefinition` be split into smaller, more focused modules?**
  _Cohesion score 0.05825768866007316 - nodes in this community are weakly interconnected._
