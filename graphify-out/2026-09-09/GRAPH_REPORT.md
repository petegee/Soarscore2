...
6. `Result` - 132 edges
7. `Soarscore.Domain` - 118 edges
8. `EntryId` - 113 edges
9. `Soarscore.Domain.People` - 113 edges
...
Cohesion: 0.07
Nodes (40): GenEntry, GenFlight, Noise, PlacedEntry, Shape, Competition, Entry, ImmutableArray (+32 more)
