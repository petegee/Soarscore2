...
## Corpus Check
- 702 files · ~1,212,826 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8844 nodes · 24493 edges · 403 communities (392 shown, 11 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 2603 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0c5471f0`
...
- Work items
- IStoreFixture
- TaskRoundLifecycleEventStoreTests
...
4. `Soarscore.Domain.PublishedClassDefinition` - 220 edges
5. `Soarscore.Domain.Competitions` - 193 edges
6. `Result` - 136 edges
7. `EntryId` - 127 edges
8. `Soarscore.SeedData` - 127 edges
...
## Communities (403 total, 11 thin omitted)

### Community 0 - ".LoadAsync"
Cohesion: 0.09
Nodes (23): CancellationToken, IClock, IEventStore, ImmutableArray, Task, FinaliseCompetitionHandler, CancellationToken, IEventStore (+15 more)

### Community 1 - "Soarscore.Domain.PublishedClassDefinition"
Cohesion: 0.06
Nodes (8): Soarscore.Domain.Scoring, Soarscore.Domain.Tests, Soarscore.SeedData, Soarscore.Domain.Entries, Soarscore.Domain.PublishedClassDefinition, JsonSerializerContext, ClassDefinitionContext, TapeMapping
...
Cohesion: 0.10
Nodes (20): Class, AllFlights, PendingFlightDiagnostic, Fact, Gen, Metric, Task, Value (+12 more)
...
Cohesion: 0.06
Nodes (38): Bands, JsonConverter, JsonSerializerOptions, ClassDefinitionHashing, ScoreTerm, Predicate, JsonSerializerOptions, Utf8JsonReader (+30 more)
...
Cohesion: 0.11
Nodes (18): CancellationToken, IClock, IEventStore, Task, RegisterPerson, RegisterPersonHandler, Guid, IFormatProvider (+10 more)
...
Cohesion: 0.10
Nodes (19): ParameterBinding, At, BoundValue, By, ParameterName, PhaseOrdinal, RoundOrdinal, ImmutableArray (+11 more)

### Community 16 - ".Of"
Cohesion: 0.09
Nodes (19): Bindings, ClassDef, ExpectedRawScore, AllOf, Children, LastNFlights, Predicate, ResolvedTask (+11 more)

### Community 17 - "EntryId"
Cohesion: 0.10
Nodes (16): Guid, EntryId, When, CompetitionId, Dictionary, Given, Group, HttpClient (+8 more)

### Community 18 - "CompetitionId"
Cohesion: 0.07
Nodes (70): ICommand, ICommandHandler, IHttpMaxRequestBodySizeFeature, WebApplication, Commands, IReadOnlyList, WebApplication, Composition (+62 more)
...
Cohesion: 0.11
Nodes (19): Path, HashSet, IEnumerable, ImmutableArray, IReadOnlyDictionary, List, Phase, Task (+11 more)
...
Cohesion: 0.11
Nodes (8): Soarscore.Application.Tests.Commands.CompetitionClasses, Soarscore.Application.Queries.CompetitionClasses, Soarscore.Application.Tests.Shared.CompetitionClasses, Soarscore.Application.Shared.CompetitionClasses, Soarscore.Application.Tests.Queries.CompetitionClasses, ClassDefinitionStreamId, PostgresClassDefinitionEventStoreTests, SqliteClassDefinitionEventStoreTests
...
Cohesion: 0.10
Nodes (20): DecideActual, DecideModel, FlagValue, MetricIndex, NumericValue, Pick, PlannedCapture, StepKind (+12 more)

### Community 27 - "Soarscore.Application.Queries.Competitions"
Cohesion: 0.13
Nodes (16): Soarscore.Application.Commands.Entries, Soarscore.Acceptance.Tests, Soarscore.Application.Commands.People, Soarscore.Api.Commands, Soarscore.Acceptance.Tests.Support, Soarscore.Api.Queries, Soarscore.Application.Queries.Competitions, Soarscore.Application.Queries.Scoring (+8 more)
...
Cohesion: 0.09
Nodes (33): Given, IReadOnlyList, JsonSerializerOptions, List, FixtureLoader, Dictionary, IReadOnlyList, JsonElement (+25 more)
...
Cohesion: 0.11
Nodes (32): ConservationRow, Mismatches, CompetitorFinalScoreView, StandingsCompared, Competition, Dictionary, Entry, Func (+24 more)

### Community 35 - "Entry"
Cohesion: 0.05
Nodes (53): FlightPlan, DateTimeOffset, Defect, Func, ImmutableArray, Penalty, PenaltyRecorded, Result (+45 more)
...
Cohesion: 0.07
Nodes (47): IParsable, IsBogus, CancellationToken, IClock, IEventStore, Task, AddProtectionGroupMemberHandler, CancellationToken (+39 more)
...
### Community 49 - "DeclareInstrumentsHandler"
Cohesion: 0.17
...
Cohesion: 0.05
Nodes (41): closure, ClosureKind, ImmutableArray, PhaseDefinition, Drops, Ordinal, Promotion, Rounds (+33 more)
...
### Community 61 - "Then"
Cohesion: 0.10
Nodes (16): Then, CompetitionId, Dictionary, Given, Group, HttpClient, HttpResponseMessage, ImmutableArray (+8 more)

### Community 62 - "Normalisation"
Cohesion: 0.19
Nodes (13): NormalisationDirection, HigherIsBetter, LowerIsBetter, Normalisation, Direction, Round, WinnerScore, state (+5 more)

### Community 63 - "Result"
Cohesion: 0.07
Nodes (31): CancellationToken, Task, CancellationToken, Task, CancellationToken, Task, CancellationToken, IEventStore (+23 more)
...
Cohesion: 0.08
Nodes (33): ISet, TargetAssignment, AnyOrder, InOrder, None, ImmutableArray, BestNFlights, Count (+25 more)

### Community 66 - "Competition"
Cohesion: 0.07
Nodes (30): DateOnly, DateTimeOffset, Defect, IEnumerable, Penalty, PenaltyRecorded, ReflightRuling, Result (+22 more)
...
### Community 69 - "RecordEntryPenaltyDecideTests"
Cohesion: 0.26
...
Cohesion: 0.09
Nodes (26): minRounds, minTasks, outcomes, RoundOutcome, TaskRoundAnnulled, TaskRoundCompleted, TaskRoundReopened, taskRefs (+18 more)
...
### Community 84 - "TaskRoundLifecycleEventStoreTests"
Cohesion: 0.14
Nodes (22): CancellationToken, Competition, Func, IClock, IEventStore, Task, AnnulTaskRoundHandler, CompleteTaskRoundHandler (+14 more)
...
Cohesion: 0.07
Nodes (26): Assumed Value, Competition, Competition Class, Competitor, Contribution Eligibility, Draw, Entry, Finalisation (+18 more)
...
### Community 92 - "CompetitorId"
Cohesion: 0.04
Nodes (39): Other, ImmutableArray, ImmutableDictionary, PairwiseCoOccurrence, PairwiseCoOccurrenceEntry, Guid, IFormatProvider, CompetitorId (+31 more)

### Community 93 - ".New"
Cohesion: 0.05
Nodes (40): Competition, DateOnly, CompetitionCreated, CompetitorRegistered, DrawAccepted, Store, FakeEventStore, Store (+32 more)

### Community 94 - "GetCompetition"
Cohesion: 0.16
Nodes (19): CancellationToken, Competition, IEventStore, ImmutableArray, Task, CompetitionView, GetCompetition, GetCompetitionHandler (+11 more)
...
Cohesion: 0.17
Nodes (17): Instrument, Kept, ReflightRows, SlotCapture, TapeFileName, GliderscoreFixture, ScoresRow, HttpClient (+9 more)
...
Cohesion: 0.06
Nodes (49): Hash, CancellationToken, IClock, IEventStore, Task, PublishClassDefinition, PublishClassDefinitionHandler, CancellationToken (+41 more)
...
Cohesion: 0.11
Nodes (18): ImmutableArray, SeedTapeNzAlesM10m, Definition, Marks, ImmutableArray, SeedTapeNzF3JSide, Definition, Marks (+10 more)
...
### Community 125 - "AdoptedRules"
Cohesion: 0.08
Nodes (21): CancellationToken, Task, AdoptedRules, AdoptedAt, Definition, SourceClassId, SourceVersion, DateTimeOffset (+13 more)
...
Cohesion: 0.07
Nodes (32): PeopleProjection, DateTimeOffset, Defect, Result, ClubAffiliation, ClubName, MembershipNumber, Person (+24 more)
...
### Community 133 - "RecordCompetitionPenalty"
Cohesion: 0.20
...
Cohesion: 0.20
Nodes (13): RoundOrdinal, TaskCode, Competitors, DateTimeOffset, Dictionary, Fact, GroupByRound, IReadOnlyDictionary (+5 more)
...
Cohesion: 0.10
Nodes (24): MinEnforcement, Shall, Should, ConstantTerm, Value, GroupConstraint, MinEnforcement, MinValidResults (+16 more)
...
### Community 170 - "Story — F5J Christchurch parallel-run witness (the guaranteed divergence)"
Cohesion: 0.11
Nodes (17): Before starting, Blocker (2026-09-10 — parks the story; WI-3 measured-first run), Cross-story contract — `kanban/in-progress/tape-points-landing-seeds.md`, Plan, Scope guards and standing constraints, Settled decisions (2026-09-07, Pete; decision 2 rewritten 2026-09-08), Story — F5J Christchurch parallel-run witness (the guaranteed divergence), Testing approach (+9 more)
...
### Community 178 - ".BuildCompetition"
Cohesion: 0.18
...
Cohesion: 0.10
Nodes (20): Code anchors (re-verify before implementation), Cross-story contract, Implementation boundaries, Jerilderie evidence retained from the first plan, New domain concept - approved in principle, wording for review, Owner decisions (2026-09-08, superseding the earlier set), Plan, Requirements cross-check (+12 more)
...
### Community 200 - "FakeEventStore"
Cohesion: 0.09
Nodes (33): Id, Competitors, Competition, Dictionary, Entries, Entry, Competition, DateTimeOffset (+25 more)
...
### Community 205 - "WithdrawCompetitorHandler"
Cohesion: 0.23
...
### Community 210 - ".MapQueries"
Cohesion: 0.18
Nodes (15): IQuery, IReadOnlyList, WebApplication, Queries, CancellationToken, Entry, IEventStore, ImmutableArray (+7 more)
...
Cohesion: 0.16
Nodes (8): Scale, ReadingScale, Marks, OffScaleReading, ReadingSet, Unit, ScaleMark, InvalidOperationException
...
Cohesion: 0.17
Nodes (10): Role, Competitors, DateTimeOffset, Dictionary, Entries, Fact, ImmutableArray, IReadOnlyList (+2 more)
...
### Community 257 - "CaptureMeasurementDecideTests"
Cohesion: 0.32
...
Cohesion: 0.15
Nodes (16): DeclaredInstrument, Instrument, Metric, ImmutableArray, ImmutableDictionary, IReadOnlyDictionary, Penalty, Result (+8 more)

### Community 260 - "SystemClock"
Cohesion: 0.13
Nodes (22): CancellationToken, IClock, IEventStore, Task, AppendReflightGroupHandler, DateTimeOffset, SystemClock, UtcNow (+14 more)
...
Cohesion: 0.04
Nodes (56): DrawOp, FieldOp, IReadOnlyCollection, OpKind, Ops, SpotBase, Competition, Entry (+48 more)

### Community 276 - "DrawAcceptanceEventStoreTests"
Cohesion: 0.45
Nodes (5): CancellationToken, Fact, Task, DrawAcceptanceEventStoreTests, Ct
...
Cohesion: 0.12
Nodes (27): CancellationToken, IClock, IEventStore, Task, DrawPhaseHandler, AdoptedRules, DateTimeOffset, Fact (+19 more)

### Community 285 - "IClassFixture"
Cohesion: 0.19
...
### Community 287 - ".Rank"
Cohesion: 0.11
Nodes (28): Cells, Disq, IList, Position, Entry, AdditionalFullRound, BestDroppedScore, ClassificationRounds (+20 more)
...
Cohesion: 0.28
Nodes (7): IServiceProvider, Type, Dictionary, Type, FakeServiceProvider, Dictionary, FakeServiceProvider
...
Cohesion: 0.15
Nodes (14): Rows, ImmutableArray, Result, ComposedReadingScale, Awards, ReadingAward, TapeComposition, LookupRow (+6 more)

### Community 301 - "IDomainEvent"
Cohesion: 0.30
...
Cohesion: 0.03
Nodes (70): Soarscore.Infrastructure.Competitions, Soarscore.Application.Tests.Commands.Entries, Soarscore.Infrastructure.Tests, Soarscore.Infrastructure.CompetitionClasses, Soarscore.Infrastructure.People, Soarscore.Application.Queries.People, Soarscore.Infrastructure, Soarscore.Application.Tests.Shared.Entries (+62 more)
...
### Community 320 - "TapeAmendmentDecideTests"
Cohesion: 0.39
...
### Community 324 - "FakeEventStore"
Cohesion: 0.12
Nodes (19): IClock, IEventStore, DateTimeOffset, FakeClock, UtcNow, CancellationToken, DateTimeOffset, Dictionary (+11 more)
...
### Community 326 - ".CreateDispatcher"
Cohesion: 0.10
Nodes (33): CountLetters, Echo, CancellationToken, IServiceProvider, Task, Type, Dispatcher, ICommand (+25 more)

### Community 327 - "F5JSeed75mGateTests"
Cohesion: 0.36
Nodes (5): Dictionary, Fact, InlineData, Theory, F5JSeed75mGateTests

### Community 328 - "TeamContributionState"
Cohesion: 0.17
...
Cohesion: 0.06
Nodes (41): ResolvedSchedule, Round, Func, ImmutableArray, Draw, CreatedAt, Status, Group (+33 more)
...
### Community 339 - ".SeedEntryWithTwoFlightsAsync"
Cohesion: 0.50
...
### Community 343 - "TaskRoundRecordingView"
Cohesion: 0.26
Nodes (10): CancellationToken, IEventStore, Task, DeclaredMetricView, GetTaskRoundRecording, GetTaskRoundRecordingHandler, TaskRoundRecordingView, DateTimeOffset (+2 more)
...
### Community 345 - "Soarscore.Domain.People"
Cohesion: 0.09
Nodes (11): Alias, Soarscore.Application.Tests, Soarscore.Domain.People, Soarscore.Application.Shared.People, Soarscore.Application.Tests.Shared.People, Soarscore.Application.Tests.Queries.People, Soarscore.Application.Tests.Commands.People, Soarscore.Application.Tests.Queries.Scoring (+3 more)
...
Cohesion: 0.09
Nodes (22): CountsFor, ReflightSelection, BetterOf, NotPermitted, Replacement, UndefinedRequiresRuling, Entry, IReadOnlyList (+14 more)
...
### Community 354 - ".GeneratedPair"
Cohesion: 0.33
Nodes (5): Tape, Fact, ImmutableArray, IReadOnlyList, TapeCompositionPropertyTests

### Community 355 - "ScoringResultTypes.cs"
Cohesion: 0.13
Nodes (19): ImmutableArray, ImmutableDictionary, TieBreakDirective, CompetitionResult, PendingTieBreaks, FinalCompetitorScore, FlightResultState, NoResult (+11 more)
...
Cohesion: 0.05
Nodes (35): MetricDefinition, DeclaredBeforeLaunch, Kind, Name, Precision, Unit, WhenNotRecorded, ImmutableArray (+27 more)

### Community 360 - ".SearchAsync"
Cohesion: 0.29
...
### Community 364 - ".Apply"
Cohesion: 0.09
Nodes (35): DateTimeOffset, Group, ReflightRuling, CompetitorWithdrawn, DrawRejected, InstrumentDeclarationCorrected, InstrumentsDeclared, ProtectionGroupDefined (+27 more)

### Community 365 - "F3K.2 DEFINITION OF MODEL GLIDER"
Cohesion: 0.29
...
Cohesion: 0.04
Nodes (44): TaskDefinition, Code, Flights, FlightValidWhen, Group, Metrics, Name, Normalise (+36 more)
...
### Community 369 - "F3K.9 DEFINITION OF A ROUND"
Cohesion: 0.29
...
### Community 371 - "MeasuredKind"
Cohesion: 0.33
Nodes (3): MeasuredKind, Flag, Number

### Community 372 - "fetch_catalogue"
Cohesion: 0.33
...
### Community 378 - "NZ Soaring — Generally Applicable Rules"
Cohesion: 0.25
...
### Community 393 - "test_picker_dedupe_first_wins_and_sort_ordering_property"
Cohesion: 0.67
...
## Knowledge Gaps
- **2445 isolated node(s):** `context7`, `rider`, `$schema`, `.opencode/plugins/graphify.js`, `$(SoarscoreTargetFramework)` (+2440 more)
...
- **Why does `ClassDefinition` connect `ClassDefinition` to `FakeEntryQuery`, `ReflightingForAMissedRoundSteps`, `MetricAbsenceFixtures`, `CatalogueDrawPropertyTests`, `CompetitionDecidePropertyTests`, `PhaseDrawn`, `.Of`, `EntryId`, `CompetitionId`, `DeclaredTeamResult`, `.CheckLimits`, `TapeLandingScaleProofTests`, `MeasuredValue`, `.HandleAsync`, `ClosingACompetitionSteps`, `.New`, `FixtureModels.cs`, `ScoringServicePropertyTests`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `ScoringACompetitionSteps`, `FakeEventStore`, `RegisterCompetitorHandler`, `PenaltyDefinition`, `DeclareInstrumentsHandler`, `RecordingAReflightRulingSteps`, `ScoringTeamsSteps`, `PhaseDefinition`, `OpenFlight`, `Then`, `.CompetitionAdopting`, `ScoringTeamCommandHandlerTests`, `.BuildDrawnCompetition`, `.HandleAsync`, `IStoreFixture`, `TaskRoundLifecycleEventStoreTests`, `.Validate`, `CompetitorId`, `.New`, `GetCompetition`, `GliderscoreFixture`, `CaptureMeasurementHandler`, `PublishClassDefinition`, `RecordCompetitionPenaltyDecideTests`, `AdoptedRules`, `RecordCompetitionPenalty`, `SeedF3K`, `EntryModelBasedFoldTests`, `FinaliseDecideTests`, `PrescribeDrawDecideTests`, `GroupConstraint`, `Enumerations.cs`, `.BuildCompetition`, `SeedF5kNdc`, `.DefinitionWith`, `FakeEventStore`, `ClassDefinitionValidationPropertyTests`, `WithdrawCompetitorHandler`, `.MapQueries`, `ReadingScale`, `.CreateDispatcher`, `.DefinitionWith`, `CompetitionReplaceTaskRoundPropertyTests`, `SeeingWhatIsRecordedSteps`, `.DrawnCompetitionAsync`, `.BuildCompetition`, `.ScoreCompetition`, `SystemClock`, `ClassDefinitionPublished`, `.SetUpAsync`, `GroupSpotsPropertyTests`, `DrawAcceptanceEventStoreTests`, `DrawPhase`, `IClassFixture`, `BindParameterPropertyTests`, `Corpus.cs`, `SeedF5K`, `.CreateDispatcher`, `RecordEntryPenalty`, `.Apply`, `BindParameterDecideTests`, `.SeedEntryWithTwoFlightsAsync`, `PublishedClassDefinition`, `.Select`, `SeedNzF3kNdc`, `MetricDefinition`, `.Load`, `.Apply`, `TaskDefinition`, `CreateCompetitionPropertyTests`, `ParallelRunSteps`, `RulesAmendment`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `CompetitorId` connect `CompetitorId` to `Soarscore.Domain.PublishedClassDefinition`, `FakeEntryQuery`, `ReflightingForAMissedRoundSteps`, `CatalogueDrawPropertyTests`, `PersonId`, `.SeedWired`, `EntryId`, `CompetitionId`, `DeclaredTeamResult`, `EntryCapturePropertyTests`, `ClosingACompetitionSteps`, `.New`, `ScoringServicePropertyTests`, `Comparator`, `Entry`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `ScoringACompetitionSteps`, `AmendMeasurementDecideTests`, `FakeEventStore`, `RegisterCompetitorHandler`, `TaskRoundRecordingPropertyTests`, `AnnulEntryDecideTests`, `RecordingAReflightRulingSteps`, `ScoringTeamsSteps`, `Then`, `Competition`, `RecordEntryPenaltyDecideTests`, `TeamsDecideTests`, `ScoringTeamCommandHandlerTests`, `.BuildDrawnCompetition`, `IStoreFixture`, `TaskRoundLifecycleEventStoreTests`, `.New`, `GetCompetition`, `DrawAcceptanceDecideTests`, `GliderscoreFixture`, `RecordCompetitionPenaltyDecideTests`, `AdoptedRules`, `RecordCompetitionPenalty`, `.SeedScoredTeamCompetition`, `TeamStanding`, `F5JChristchurchTapeReadingExamplesTests`, `PrescribeDrawDecideTests`, `.BuildCompetition`, `OpenFlightDecideTests`, `.BuildCompetition`, `.DefinitionWith`, `FakeEventStore`, `WithdrawCompetitorHandler`, `.MapQueries`, `.CreateDispatcher`, `.DefinitionWith`, `DrawProtectionPropertyTests`, `SeeingWhatIsRecordedSteps`, `ScoringTeamId`, `TeamClassificationPropertyTests`, `.DrawnCompetitionAsync`, `.BuildCompetition`, `AssigningSpotsSteps`, `CaptureMeasurementDecideTests`, `SystemClock`, `.BuildDrawnCompetition`, `.Classify`, `.SetUpAsync`, `GroupSpotsPropertyTests`, `DrawAcceptanceEventStoreTests`, `.BuildGroups`, `DrawPhase`, `IClassFixture`, `PhaseDrawPropertyTests`, `ProtectedPair`, `RecordingAGliderscoreFixtureSteps`, `TapeAmendmentDecideTests`, `.CreateDispatcher`, `TeamContributionState`, `.BuildDrawnCompetition`, `RecordEntryPenalty`, `ImmutableArray`, `.Select`, `Competitor`, `.Apply`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `Soarscore.Domain.PublishedClassDefinition` connect `Soarscore.Domain.PublishedClassDefinition` to `Soarscore.Domain.Competitions`, `NumberOrParam`, `IProjection`, `.Aggregate`, `SeedF3K`, `ClassDefinitionPublished`, `.CheckLimits`, `Soarscore.Application.Queries.CompetitionClasses`, `Soarscore.Application.Queries.Competitions`, `FixtureModels.cs`, `.Rank`, `GroupConstraint`, `Enumerations.cs`, `PenaltyDefinition`, `LookupRow`, `SeedF5kNdc`, `Soarscore.Application`, `Corpus.cs`, `SeedF5K`, `ScoreTerm`, `PublishedClassDefinition`, `Soarscore.Domain.People`, `SeedNzF3kNdc`, `ScoringResultTypes.cs`, `MetricDefinition`, `PublishClassDefinition`, `.Apply`, `TaskDefinition`, `TapeDefinition`?**
...
- **Should `FakeEntryQuery` be split into smaller, more focused modules?**
  _Cohesion score 0.13617767387492694 - nodes in this community are weakly interconnected._