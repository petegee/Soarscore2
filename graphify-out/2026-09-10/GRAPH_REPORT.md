...
## Corpus Check
- 705 files · ~1,219,492 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8894 nodes · 24626 edges · 411 communities (398 shown, 13 thin omitted)
...
## Communities (411 total, 13 thin omitted)

### Community 0 - "Result"
Cohesion: 0.06
Nodes (37): CancellationToken, Task, CancellationToken, IClock, IEventStore, Task, ClearScoringTeamMembershipHandler, CancellationToken (+29 more)

### Community 1 - "Soarscore.Domain.PublishedClassDefinition"
Cohesion: 0.05
Nodes (9): Soarscore.Domain.Scoring, Soarscore.Domain.Tests, Soarscore.Domain.Competitions, Soarscore.SeedData, Soarscore.Application.Tests.Queries.Entries, Soarscore.Domain.Entries, Soarscore.Domain.PublishedClassDefinition, Intrinsic (+1 more)
...
Cohesion: 0.08
Nodes (9): Soarscore.Application.Shared.Entries, Soarscore.Application.Commands.Competitions, Soarscore.Application.Tests.Shared.Competitions, Soarscore.Application.Queries.Entries, Soarscore.Domain, Soarscore.Application.Tests.Commands.Competitions, Soarscore.Application.Shared.Competitions, EntryCollector (+1 more)
...
Cohesion: 0.09
Nodes (31): IParsable, CancellationToken, IClock, IEventStore, Task, RegisterCompetitorHandler, CancellationToken, IClock (+23 more)
...
Cohesion: 0.09
Nodes (16): Bindings, ClassDef, ExpectedRawScore, Competition, TaskResolver, ResolvedTask, ResolvedTiming, ArgumentException (+8 more)

### Community 17 - "EntryId"
Cohesion: 0.09
Nodes (18): Guid, EntryId, When, CompetitionId, Dictionary, Given, Group, HttpClient (+10 more)

### Community 18 - "CompetitionId"
Cohesion: 0.08
Nodes (63): ICommand, IHttpMaxRequestBodySizeFeature, WebApplication, IReadOnlyList, WebApplication, IClock, IEventStore, AcceptDraw (+55 more)
...
Cohesion: 0.07
Nodes (20): Soarscore.Infrastructure.Competitions, Soarscore.Infrastructure.CompetitionClasses, Soarscore.Infrastructure.People, Soarscore.Application.Tests.Shared.People, Soarscore.Application.Queries.People, Soarscore.Api.Commands, Soarscore.Api.Queries, Soarscore.Application.Tests.Queries.People (+12 more)

### Community 25 - "FakeEntryQuery"
Cohesion: 0.23
Nodes (10): AdoptedRules, DateTimeOffset, Fact, FakeEventStore, InlineData, Store, Task, Theory (+2 more)
...
### Community 27 - "Soarscore.Application"
Cohesion: 0.10
Nodes (17): Soarscore.Infrastructure.Tests, Soarscore.Application.Commands.Entries, Soarscore.Acceptance.Tests, Soarscore.Application.Commands.People, Soarscore.Acceptance.Tests.Support, Soarscore.Infrastructure, Soarscore.Application.Queries.Competitions, Soarscore.Application.Queries.Scoring (+9 more)
...
### Community 38 - "Then"
Cohesion: 0.11
Nodes (14): RecordEntryPenalty, Then, CompetitionId, DateTimeOffset, Dictionary, Given, Group, HttpClient (+6 more)
...
### Community 49 - "Defect"
Cohesion: 0.13
Nodes (5): Defect, Penalty, PenaltyRecorded, TaskRoundCoordinate, Defect
...
### Community 55 - "MetricDefinition"
Cohesion: 0.06
Nodes (30): Id, ConstantTerm, Value, LastFlight, MetricDefinition, DeclaredBeforeLaunch, Kind, Name (+22 more)
...
### Community 63 - ".ReadStreamAsync"
Cohesion: 0.10
Nodes (25): CancellationToken, Guid, IReadOnlyList, Task, ExpectedVersion, Any, IsAny, IsExact (+17 more)
...
Cohesion: 0.09
Nodes (30): ISet, TargetAssignment, AnyOrder, InOrder, None, ImmutableArray, BestNFlights, Count (+22 more)

### Community 66 - "Competition"
Cohesion: 0.09
Nodes (21): IEnumerable, ReflightRuling, Competition, AdoptedRules, DeclaredInstruments, EndDate, EvaluatorVersion, Finalisations (+13 more)
...
### Community 78 - ".MapQueries"
Cohesion: 0.09
Nodes (34): IQueryHandler, IReadOnlyList, WebApplication, IClock, IEventStore, RenamePerson, RenamePersonHandler, CancellationToken (+26 more)
...
Cohesion: 0.06
Nodes (50): ICommandHandler, CancellationToken, IClock, IEventStore, ImmutableArray, Task, FinaliseCompetition, FinaliseCompetitionHandler (+42 more)
...
Cohesion: 0.09
Nodes (21): CancellationToken, IClock, IEventStore, Task, AssignGroupSpotsHandler, Guid, IFormatProvider, GroupId (+13 more)

### Community 93 - ".New"
Cohesion: 0.05
Nodes (50): Scope, Competition, DateOnly, CompetitionCreated, CompetitorRegistered, DrawAccepted, InfractionType, SubjectIndex (+42 more)

### Community 94 - "PhaseDefinition"
Cohesion: 0.09
Nodes (23): ImmutableArray, PhaseDefinition, Drops, Ordinal, Promotion, Rounds, Tasks, TieBreaks (+15 more)
...
Cohesion: 0.08
Nodes (39): Hash, IQuery, CancellationToken, IClock, IEventStore, Task, PublishClassDefinition, PublishClassDefinitionHandler (+31 more)
...
### Community 124 - "DateTimeOffset"
Cohesion: 0.13
Nodes (11): DateTimeOffset, Result, InstrumentDeclaration, At, By, Instruments, InstrumentDeclarationCorrection, At (+3 more)
...
Cohesion: 0.09
Nodes (22): IReadOnlyList, PrescribedGroup, PrescribedRound, CompetitionId, Given, HttpClient, HttpResponseMessage, IEnumerable (+14 more)
...
Cohesion: 0.11
Nodes (20): Annulment, DateTimeOffset, Penalty, EntryAnnulled, EntryEvent, FlightOpened, MeasurementAmended, MeasurementCaptured (+12 more)
...
### Community 214 - "Soarscore.Domain.People"
Cohesion: 0.12
Nodes (6): Soarscore.Application.Tests.Commands.Entries, Soarscore.Application.Tests, Soarscore.Domain.People, Soarscore.Application.Shared.People, Soarscore.Application.Tests.Shared.Entries, Soarscore.Application.Tests.Queries.Scoring
...
Cohesion: 0.22
Nodes (9): DateTimeOffset, Fact, ImmutableArray, IReadOnlyList, Shape, BelowMinimum, Singleton, Valid (+1 more)
...
Cohesion: 0.11
Nodes (22): IClassFixture, Round2GroupRef, CancellationToken, IClock, IEventStore, Task, AppendReflightGroupHandler, Competitors (+14 more)
...
### Community 269 - "Soarscore.Application.Queries.CompetitionClasses"
Cohesion: 0.07
...
### Community 273 - "CompetitionDecideTests"
Cohesion: 0.23
...
Cohesion: 0.10
Nodes (35): CancellationToken, IClock, IEventStore, Task, BindParameterHandler, DateOnly, CompetitionSummary, CancellationToken (+27 more)

### Community 285 - "PrescribeDrawPropertyTests"
Cohesion: 0.17
...
Cohesion: 0.15
Nodes (13): ImmutableArray, Result, ComposedReadingScale, Awards, Tape, ReadingAward, TapeComposition, LookupRow (+5 more)

### Community 301 - "f3k-southern-fling/ladder.py"
Cohesion: 0.20
...
Cohesion: 0.03
Nodes (58): IAsyncLifetime, PostgresBindParameterEventStoreTests, SqliteBindParameterEventStoreTests, PostgresCatalogueDrawEventStoreTests, SqliteCatalogueDrawEventStoreTests, PostgresCompetitionEventStoreTests, SqliteCompetitionEventStoreTests, PostgresCompetitorEventStoreTests (+50 more)
...
### Community 320 - ".From"
Cohesion: 0.16
Nodes (10): ClassDefinitionProjection, Guid, ClassDefinitionStreamId, DateTimeOffset, Fact, Gen, ClassDefinitionProjectionPropertyTests, ArgumentException (+2 more)
...
### Community 330 - ".ScoreWith"
Cohesion: 0.21
Nodes (8): DateTimeOffset, Fact, Func, Group, ImmutableArray, NormalisationGroupIsolationPropertyTests, World, World

### Community 331 - "RecordEntryPenaltyHandler"
Cohesion: 0.20
Nodes (12): IEventStore, RecordEntryPenaltyHandler, CancellationToken, DateTimeOffset, Fact, FakeEventStore, Guid, IReadOnlyList (+4 more)
...
Cohesion: 0.08
Nodes (25): ResolvedSchedule, Round, Func, ImmutableArray, Draw, CreatedAt, Status, Group (+17 more)
...
### Community 339 - "NumberOrParam"
Cohesion: 0.07
Nodes (27): Bands, Rows, NumberOrParam, Band, PiecewiseTerm, Bands, MetricRef, Origin (+19 more)
...
### Community 347 - "DeclaredInstrument"
Cohesion: 0.29
Nodes (7): DeclaredInstrument, Instrument, Metric, Scale, Fact, Task, InstrumentDeclarationEventStoreTests
...
### Community 350 - "RecordingAReflightRulingSteps"
Cohesion: 0.05
Nodes (37): CountsFor, Role, ReflightRole, Entitled, Filler, Original, ReflightSelection, BetterOf (+29 more)
...
### Community 354 - "Story — Resolve FlightSelector's task gate vs FlightInterpreter's per-flight zeroing"
Cohesion: 0.14
Nodes (13): (a) Verbatim rule — flight penalty b is flight-scoped; the SeedF5K encoding stands, Acceptance, (b) Combination semantics — the task gate judges countable flights only, Before starting, (c) BestN interplay — a zeroed flight ranks by score 0: confirmed intended, Finding for WI-2/WI-3 — ClampAndRecompute can un-zero a flight, House-rule 2 cross-reference, Plan (+5 more)

### Community 355 - "RankingEnginePropertyTests"
Cohesion: 0.24
Nodes (12): Cells, Disq, IList, Position, Entry, Fact, Gen, ImmutableArray (+4 more)

### Community 356 - ".LoadCurrentAsync"
Cohesion: 0.26
...
Cohesion: 0.20
Nodes (9): Competitor, CompetitorNumber, Id, PersonRef, RegisteredAt, WithdrawnAt, Dictionary, Group (+1 more)

### Community 364 - "PhaseDrawn"
Cohesion: 0.06
Nodes (54): DateTimeOffset, Group, ImmutableArray, IReadOnlyList, Penalty, ReflightRuling, Round, CompetitionEvent (+46 more)
...
Cohesion: 0.04
Nodes (46): TaskDefinition, Code, Flights, FlightValidWhen, Group, Metrics, Name, Normalise (+38 more)
...
### Community 371 - "TapeAmendmentDecideTests"
Cohesion: 0.37
...
Cohesion: 0.07
Nodes (32): Task, Then, When, ParallelRunSteps, Competition, HashSet, HttpClient, IReadOnlyList (+24 more)
...
### Community 399 - "DocumentClassLibraryQuery"
Cohesion: 0.38
...
### Community 403 - ".TaskWithParameterisedWorkingTime"
Cohesion: 0.53
...
### Community 407 - "FlightResultState"
Cohesion: 0.50
...
## Knowledge Gaps
- **2465 isolated node(s):** `context7`, `rider`, `$schema`, `.opencode/plugins/graphify.js`, `$(SoarscoreTargetFramework)` (+2460 more)
...
- **Why does `ClassDefinition` connect `ClassDefinition` to `EntryOpened`, `ReflightingForAMissedRoundSteps`, `MetricAbsenceFixtures`, `CatalogueDrawPropertyTests`, `CompetitorId`, `AdoptedRules`, `ResolvedTask`, `EntryId`, `CompetitionId`, `DeclaredTeamResult`, `.CheckLimits`, `TapeLandingScaleProofTests`, `MeasuredValue`, `FakeEntryQuery`, `ClosingACompetitionSteps`, `.New`, `FixtureModels.cs`, `DrawPhase`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `Then`, `.SeedCompetition`, `PenaltyDefinition`, `DeclareInstrumentsHandler`, `ScoringTeamsSteps`, `MetricDefinition`, `OpenFlight`, `LandingTapeDeclaredScaleSteps`, `FakeEventStore`, `.CompetitionAdopting`, `ScoringTeamCommandHandlerTests`, `.MapQueries`, `.BuildDrawnCompetition`, `.HandleAsync`, `ICommandHandler`, `.Validate`, `GroupId`, `.New`, `PhaseDefinition`, `GliderscoreFixture`, `CaptureMeasurement`, `PublishClassDefinition`, `RecordEntryPenaltyDecideTests`, `RecordCompetitionPenaltyDecideTests`, `SeedF3K`, `EntryModelBasedFoldTests`, `FinaliseDecideTests`, `PrescribeDrawDecideTests`, `FlightOpened`, `GroupScoreView`, `.BuildCompetition`, `SeedF5kNdc`, `.DefinitionWith`, `.OpenFlownEntry`, `ClassDefinitionValidationPropertyTests`, `.SeedCompetition`, `IDispatcher`, `.DefinitionWith`, `CompetitionReplaceTaskRoundPropertyTests`, `SeeingWhatIsRecordedSteps`, `.DrawnCompetitionAsync`, `ReflightRule`, `.ScoreCompetition`, `IClassFixture`, `PublishedClassDefinition`, `CompetitionDecideTests`, `.SetUpAsync`, `GroupSpotsPropertyTests`, `SystemClock`, `PrescribeDrawPropertyTests`, `.Rank`, `BindParameterPropertyTests`, `Corpus.cs`, `.From`, `ClassDefinitionPublished`, `.ScoreWith`, `RecordEntryPenaltyHandler`, `.Apply`, `.Of`, `NumberOrParam`, `.SeedOneFlownEntry`, `DeclaredInstrument`, `RecordingAReflightRulingSteps`, `SeedNzF3kNdc`, `.BuildDispatcher`, `SeedF5K`, `.Load`, `PhaseDrawn`, `TaskDefinition`, `SeedF3J`, `CreateCompetitionPropertyTests`, `.CompareAsync`, `RulesAmendment`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `CompetitorId` connect `CompetitorId` to `Result`, `Soarscore.Domain.PublishedClassDefinition`, `EntryOpened`, `ReflightingForAMissedRoundSteps`, `CatalogueDrawPropertyTests`, `.SeedWired`, `EntryId`, `CompetitionId`, `DeclaredTeamResult`, `EntryCapturePropertyTests`, `ClosingACompetitionSteps`, `.New`, `DrawPhase`, `IEventStore`, `Entry`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `Then`, `AmendMeasurementDecideTests`, `FakeClock`, `TaskRoundRecordingPropertyTests`, `AnnulEntryDecideTests`, `Defect`, `ScoringTeamsSteps`, `LandingTapeDeclaredScaleSteps`, `Competition`, `TeamsDecideTests`, `ScoringTeamCommandHandlerTests`, `.MapQueries`, `.BuildDrawnCompetition`, `ICommandHandler`, `GroupId`, `.New`, `PhaseDefinition`, `DrawAcceptanceDecideTests`, `GliderscoreFixture`, `RecordEntryPenaltyDecideTests`, `DateTimeOffset`, `RecordCompetitionPenaltyDecideTests`, `.SeedScoredTeamCompetition`, `.Classify`, `F5JChristchurchTapeReadingExamplesTests`, `FinaliseDecideTests`, `PrescribeDrawDecideTests`, `.BuildCompetition`, `OpenFlightDecideTests`, `FlightOpened`, `GroupScoreView`, `.BuildCompetition`, `.DefinitionWith`, `.OpenFlownEntry`, `.SeedCompetition`, `IDomainEvent`, `IDispatcher`, `.DefinitionWith`, `DrawProtectionPropertyTests`, `SeeingWhatIsRecordedSteps`, `TeamClassificationEngineTests`, `CompetitionResult`, `.DrawnCompetitionAsync`, `ReflightRule`, `AssigningSpotsSteps`, `.ScoreCompetition`, `IClassFixture`, `.BuildDrawnCompetition`, `.SetUpAsync`, `GroupSpotsPropertyTests`, `Round`, `.BuildGroups`, `SystemClock`, `PrescribeDrawPropertyTests`, `PhaseDrawPropertyTests`, `FindEntries`, `ProtectedPair`, `RecordingAGliderscoreFixtureSteps`, `.ScoreWith`, `ImmutableArray`, `.Of`, `.SeedOneFlownEntry`, `RecordingAReflightRulingSteps`, `Competitor`, `PhaseDrawn`, `TapeAmendmentDecideTests`, `.ComputeGroupViews`, `Fact`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `Result` connect `Result` to `EntryOpened`, `IClassFixture`, `Soarscore.Domain`, `.SeedScoredTeamCompetition`, `CompetitorId`, `.SeedWired`, `ResolvedTask`, `PublishedClassDefinition`, `CompetitionId`, `.SetUpAsync`, `SystemClock`, `FindCompetitions`, `DrawPhase`, `JasperFxEventStore`, `FakeClock`, `FindEntries`, `.SeedCompetition`, `GroupScoreView`, `PersonSummary`, `Defect`, `DeclareInstrumentsHandler`, `ProtectedPair`, `OpenFlight`, `FakeEventStore`, `.ReadStreamAsync`, `Dispatcher`, `RecordEntryPenaltyHandler`, `ScoringTeamCommandHandlerTests`, `.MapQueries`, `ImmutableArray`, `.HandleAsync`, `IDomainEvent`, `ICommandHandler`, `IDispatcher`, `.HandleAsync`, `GroupId`, `FakeEventStore`, `RecordingAReflightRulingSteps`, `.New`, `CaptureMeasurement`, `FakeEventStore`, `PublishClassDefinition`, `RecordEntryPenaltyDecideTests`, `MartenEventStore`, `FisherEventStore`, `.DrawnCompetitionAsync`, `ClassDefinitionSummary`, `EndpointRouteBuilderExtensions`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **What connects `context7`, `rider`, `$schema` to the rest of the system?**
  _2465 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Soarscore.Domain.PublishedClassDefinition` be split into smaller, more focused modules?**
  _Cohesion score 0.05175909361955874 - nodes in this community are weakly interconnected._
