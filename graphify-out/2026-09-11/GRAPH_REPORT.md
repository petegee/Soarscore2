...
## Corpus Check
- 722 files · ~1,249,834 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9167 nodes · 25458 edges · 409 communities (401 shown, 8 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 2700 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1086a706`
...
3. `ClassDefinition` - 230 edges
4. `Soarscore.Domain.PublishedClassDefinition` - 228 edges
...
## Communities (409 total, 8 thin omitted)

### Community 0 - "PrescribeDrawDecideTests"
Cohesion: 0.05
Nodes (45): Mutation, IReadOnlyList, PrescribedGroup, PrescribedRound, CompetitionId, Given, HttpClient, HttpResponseMessage (+37 more)

### Community 1 - "Soarscore.Domain.PublishedClassDefinition"
Cohesion: 0.05
Nodes (12): Soarscore.Domain.Scoring, Soarscore.Domain.Tests, Soarscore.Domain.Competitions, Soarscore.Domain.People, Soarscore.SeedData, Soarscore.Domain.Entries, Soarscore.Domain.PublishedClassDefinition, Soarscore.Application.Tests.Queries.Scoring (+4 more)

### Community 2 - "FakeEntryQuery"
Cohesion: 0.15
Nodes (25): CancellationToken, IClock, IEventStore, Task, OpenEntryHandler, EntrySummary, CancellationToken, IReadOnlyList (+17 more)
...
Cohesion: 0.12
Nodes (32): check_common_audit_fields(), exact_sleep_factory(), execute_op(), FakeClock, FakeTransport, granular_sleep_factory(), make_client(), _parse_utc() (+24 more)
...
Cohesion: 0.06
Nodes (36): Bindings, ClassDef, ExpectedRawScore, ISet, AllFlights, FlightSelection, LastNFlights, Predicate (+28 more)
...
Cohesion: 0.05
Nodes (78): ICommand, IHttpMaxRequestBodySizeFeature, IQuery, WebApplication, Commands, IReadOnlyList, WebApplication, Composition (+70 more)

### Community 19 - "ResolvingATieBreakSteps"
Cohesion: 0.11
Nodes (17): ImmutableArray, PendingTieBreaksView, PendingTieBreakView, ImmutableArray, CompetitionScoreView, CompetitionId, Dictionary, Given (+9 more)
...
Cohesion: 0.06
Nodes (19): Soarscore.Infrastructure.Competitions, Soarscore.Application.Tests, Soarscore.Infrastructure.CompetitionClasses, Soarscore.Infrastructure.People, Soarscore.Application.Tests.Shared.People, Soarscore.Application.Queries.People, Soarscore.Infrastructure, Soarscore.Api.Queries (+11 more)

### Community 25 - "PhaseDrawn"
Cohesion: 0.05
Nodes (56): DateTimeOffset, Group, ImmutableArray, IReadOnlyList, Penalty, ReflightRuling, Round, TieBreakOutcome (+48 more)

### Community 26 - "EntryCapturePropertyTests"
Cohesion: 0.09
Nodes (21): DecideActual, DecideModel, FlagValue, MetricIndex, NumericValue, Pick, MeasuredKind, Flag (+13 more)
...
### Community 29 - ".New"
Cohesion: 0.10
Nodes (21): TaskRoundState, Annulled, Complete, Drawn, InProgress, DateTimeOffset, Fact, EntryTests (+13 more)
...
### Community 31 - ".Group"
Cohesion: 0.11
Nodes (15): DeclaredResult, Aggregate, CompetitorRef, Placing, Promoted, Store, ArgumentException, Competition (+7 more)

### Community 32 - "GroupId"
Cohesion: 0.05
Nodes (44): Scope, GroupId, ReflightRole, Entitled, Filler, Original, DateTimeOffset, EntryOpened (+36 more)
...
### Community 35 - "Entry"
Cohesion: 0.05
Nodes (53): DateTimeOffset, Defect, Func, ImmutableArray, Penalty, PenaltyRecorded, Result, Amendment (+45 more)
...
Cohesion: 0.13
Nodes (24): Round2GroupRef, CancellationToken, IClock, IEventStore, Task, DrawPhaseHandler, AdoptedRules, DateTimeOffset (+16 more)
...
### Community 55 - "Competition"
Cohesion: 0.09
Nodes (24): IEnumerable, Penalty, PenaltyRecorded, ReflightRuling, Competition, AdoptedRules, DeclaredInstruments, EndDate (+16 more)

### Community 56 - ".OpenFlightWith"
Cohesion: 0.27
Nodes (4): ScoreTerm, ConditionalTerm, Else, ImmutableArray
...
### Community 66 - "Defect"
Cohesion: 0.12
Nodes (5): Defect, TaskRoundCoordinate, TieBreakOutcome, TieBreakOutcomePlacing, Defect
...
Cohesion: 0.14
Nodes (22): CancellationToken, IClock, IEventStore, Task, RenamePerson, RenamePersonHandler, CancellationToken, IEventStore (+14 more)
...
Cohesion: 0.07
Nodes (45): ICommandHandler, CancellationToken, IClock, IEventStore, ImmutableArray, Task, FinaliseCompetition, FinaliseCompetitionHandler (+37 more)
...
Cohesion: 0.15
Nodes (16): CancellationToken, IClock, IEventStore, Task, AmendMeasurementHandler, Competition, TaskResolver, CancellationToken (+8 more)

### Community 93 - ".New"
Cohesion: 0.05
Nodes (52): FieldOp, RoundOrdinal, Func, Competition, DateOnly, CompetitionCreated, TaskCode, EntryQuery (+44 more)

### Community 94 - "ReflightDestinationTests"
Cohesion: 0.34
...
Cohesion: 0.15
Nodes (13): Penalty, By, CompetitorRef, InfractionType, Scope, TaskRound, TaskRoundCoordinate, DateTimeOffset (+5 more)
...
Cohesion: 0.08
Nodes (34): NormalisationDirection, HigherIsBetter, LowerIsBetter, RoundingMode, Ceiling, HalfUp, Truncate, Normalisation (+26 more)
...
Cohesion: 0.07
Nodes (30): Predicate, Comparator, EqualTo, GreaterOrEqual, GreaterThan, LessOrEqual, LessThan, TargetAssignment (+22 more)
...
Cohesion: 0.12
Nodes (21): IJasperFxProjection, IProjection, IDocumentOperations, IDocumentSession, ClassDefinitionSummaryProjection, FisherClassDefinitionSummaryProjection, MartenClassDefinitionSummaryProjection, DocumentStore (+13 more)
...
### Community 145 - ".LoadAsync"
Cohesion: 0.11
Nodes (22): IQueryHandler, CancellationToken, IEventStore, Task, GetPendingTieBreaksHandler, CancellationToken, Entry, IEventStore (+14 more)
...
Cohesion: 0.07
Nodes (8): Soarscore.Application.Tests.Commands.CompetitionClasses, Soarscore.Application.Tests.Queries.Competitions, Soarscore.Application.Queries.CompetitionClasses, Soarscore.Application.Tests.Shared.CompetitionClasses, Soarscore.Application.Shared.CompetitionClasses, Soarscore.Application.Tests.Queries.CompetitionClasses, Fact, ClassDefinitionHashingTests
...
Cohesion: 0.05
Nodes (40): PromotionRule, CarryPenalties, Kind, MaxGroupSize, MinGroupSize, TopN, TopPercent, RoundComposition (+32 more)
...
### Community 170 - ".Capture_order_does_not_change_the_folded_entry"
Cohesion: 0.20
...
### Community 174 - "CaptureMeasurement"
Cohesion: 0.07
Nodes (36): CancellationToken, IClock, IEventStore, Task, CorrectInstrumentDeclarationHandler, CancellationToken, IClock, IEventStore (+28 more)
...
Cohesion: 0.13
Nodes (17): BigSecond, MaxPairwise, MaxRoundViolations, PairCount, MinPerGroup, DateTimeOffset, Dictionary, Fact (+9 more)
...
### Community 254 - "RecordEntryPenaltyDecideTests"
Cohesion: 0.26
...
Cohesion: 0.11
Nodes (22): IClassFixture, CancellationToken, IClock, IEventStore, Task, AppendReflightGroupHandler, Competitors, CancellationToken (+14 more)
...
### Community 269 - "CaptureMeasurementDecideTests"
Cohesion: 0.32
...
Cohesion: 0.12
Nodes (27): CancellationToken, IEventStore, Task, GetCompetition, GetCompetitionHandler, DateTimeOffset, SystemClock, UtcNow (+19 more)
...
### Community 305 - "DeclaredInstrument"
Cohesion: 0.32
Nodes (9): DeclaredInstrument, Instrument, Metric, Scale, ImmutableArray, IReadOnlyDictionary, FlightInterpreter, Intrinsic (+1 more)

### Community 306 - "CompetitionResult"
Cohesion: 0.18
Nodes (10): ImmutableArray, ImmutableDictionary, TieBreakDirective, CompetitionResult, PendingTieBreaks, PendingTieBreak, PhaseScores, BestDroppedAggregate (+2 more)
...
Cohesion: 0.04
Nodes (54): IAsyncLifetime, PostgresCatalogueDrawEventStoreTests, SqliteCatalogueDrawEventStoreTests, PostgresCompetitorEventStoreTests, SqliteCompetitorEventStoreTests, PostgresDrawAcceptanceEventStoreTests, SqliteDrawAcceptanceEventStoreTests, PostgresDrawPhaseEventStoreTests (+46 more)
...
Cohesion: 0.07
Nodes (25): IConfiguration, IServiceCollection, DateTimeOffset, IClock, UtcNow, CancellationToken, IDocumentSessionFactory, IReadOnlyList (+17 more)

### Community 320 - "ExpectedVersion"
Cohesion: 0.17
...
Cohesion: 0.15
Nodes (20): CancellationToken, IEventStore, Task, RecordEntryPenalty, RecordEntryPenaltyHandler, PenaltyScope, Competition, Entry (+12 more)
...
### Community 334 - "ImmutableArray"
Cohesion: 0.08
Nodes (32): ResolvedSchedule, Round, ImmutableArray, Group, CompetitorRefs, Id, Ordinal, InstrumentDeclaration (+24 more)
...
Cohesion: 0.08
Nodes (21): CancellationToken, Task, CompetitionProjection, AdoptedRules, AdoptedAt, Definition, SourceClassId, SourceVersion (+13 more)
...
Cohesion: 0.18
Nodes (10): CompetitorFinalScoreView, TeamContributionState, Contributor, Disqualified, EligibleNotCounting, Ineligible, NoScoreYet, HashSet (+2 more)
...
### Community 344 - "Soarscore.Application.Tests.Shared.Entries"
Cohesion: 0.29
...
Cohesion: 0.09
Nodes (29): Id, Competition, Dictionary, Entries, Entry, Store, Competition, DateTimeOffset (+21 more)
...
Cohesion: 0.16
Nodes (10): Guid, IFormatProvider, ScoringTeam, Id, Name, ScoringTeamId, ScoringTeamMembership, CompetitorRef (+2 more)
...
### Community 356 - "IDomainEvent"
Cohesion: 0.19
Nodes (14): RecordedEvent, IDomainEvent, CancellationToken, Guid, IReadOnlyList, StaleReadEventStore, CancellationToken, Guid (+6 more)
...
### Community 358 - "F3B.2 RULES FOR MULTI-TASK CONTESTS"
Cohesion: 0.18
...
### Community 363 - "Competitor"
Cohesion: 0.33
Nodes (6): Competitor, CompetitorNumber, Id, PersonRef, RegisteredAt, WithdrawnAt

### Community 364 - "Competition.cs"
Cohesion: 0.08
Nodes (27): DeclaredTeamContributor, CompetitorRef, Placing, Score, DeclaredTeamResult, BestIndividualPlacing, Contributors, Name (+19 more)

### Community 365 - "F3G.2 RULES FOR MULTI-TASK CONTESTS"
Cohesion: 0.20
...
Cohesion: 0.16
Nodes (12): Rows, LookupRow, LookupTerm, MetricRef, Rows, Fact, ImmutableArray, IReadOnlyList (+4 more)
...
### Community 374 - "DecideFlightModel"
Cohesion: 0.32
...
### Community 377 - "PenaltyAccrual"
Cohesion: 0.67
Nodes (3): PenaltyAccrual, OncePerAttempt, PerOccurrence

### Community 378 - "NZMAA Flying Rules, Section 5: Soaring — March 2024 (extracted source text)"
Cohesion: 0.29
...
### Community 380 - "A.5 PLENARY MEETING"
Cohesion: 0.33
...
### Community 391 - "F5 Electric Soaring — Generally Applicable Rules"
Cohesion: 0.29
...
### Community 396 - "EventKind"
Cohesion: 0.40
Nodes (5): EventKind, Annul, AppendGroup, Complete, Reopen

### Community 397 - ".MapQueries"
Cohesion: 0.13
Nodes (20): IReadOnlyList, WebApplication, Queries, DateTimeOffset, Guid, ClassDefinitionSummary, CancellationToken, IReadOnlyList (+12 more)

### Community 398 - "composite"
Cohesion: 0.50
Nodes (4): _action_candidates(), _audit_plans(), composite, _throttle_scenarios()
...
Cohesion: 0.08
Nodes (31): CancellationToken, Guid, IReadOnlyList, Task, CancellationToken, Entry, IEventStore, Task (+23 more)
...
### Community 417 - "MeasurementModel"
Cohesion: 0.67
Nodes (3): MeasurementModel, AmendmentCount, Metric

## Knowledge Gaps
- **2523 isolated node(s):** `context7`, `rider`, `$schema`, `.opencode/plugins/graphify.js`, `$(SoarscoreTargetFramework)` (+2518 more)
...
- **Why does `ClassDefinition` connect `ClassDefinition` to `PrescribeDrawDecideTests`, `FakeEntryQuery`, `ReflightingForAMissedRoundSteps`, `MetricAbsenceFixtures`, `CatalogueDrawPropertyTests`, `.Exact`, `ResolvedTask`, `EntryId`, `CompetitionId`, `.CheckLimits`, `TapeLandingScaleProofTests`, `MeasuredValue`, `PhaseDrawn`, `ClosingACompetitionSteps`, `.New`, `FixtureModels.cs`, `.Group`, `GroupId`, `CompetitionView`, `AcceptingTheDrawSteps`, `Then`, `DrawPhase`, `PenaltyDefinition`, `SeeingWhatIsRecordedSteps`, `RecordingAReflightRulingSteps`, `ScoringTeamsSteps`, `OpenFlight`, `LandingTapeDeclaredScaleSteps`, `FakeEventStore`, `.CompetitionAdopting`, `ScoringTeamCommandHandlerTests`, `.BuildDrawnCompetition`, `RecordCompetitionPenalty`, `ICommandHandler`, `.Validate`, `.HandleAsync`, `.New`, `DrawAcceptanceDecideTests`, `GliderscoreFixture`, `PublishClassDefinition`, `RecordCompetitionPenaltyDecideTests`, `.BuildDrawnCompetition`, `IStoreFixture`, `EntryModelBasedFoldTests`, `FinaliseDecideTests`, `GroupConstraint`, `.BuildCompetition`, `Enumerations.cs`, `CaptureMeasurement`, `SeedF3K`, `.SeedCompetition`, `ClassDefinitionValidationPropertyTests`, `.DrawnCompetitionAsync`, `WithdrawCompetitorHandler`, `IDispatcher`, `.DefinitionWith`, `CompetitionReplaceTaskRoundPropertyTests`, `TeamsEventStoreTests`, `.DrawnCompetitionAsync`, `DrawAcceptancePropertyTests`, `.ScoreCompetition`, `IClassFixture`, `ClassDefinitionPublished`, `.SetUpAsync`, `GroupSpotsPropertyTests`, `SystemClock`, `SeedF5K`, `.BuildDrawnCompetition`, `BindParameterPropertyTests`, `Corpus.cs`, `.CompareAsync`, `RecordEntryPenalty`, `AdoptedRules`, `.Of`, `PublishedClassDefinition`, `FakeEventStore`, `SeedF5kNdc`, `.Select`, `MetricDefinition`, `Competition.cs`, `TaskDefinition`, `.Decide`, `CreateCompetitionPropertyTests`, `.MapQueries`, `.Load`?**
  _High betweenness centrality (0.153) - this node is a cross-community bridge._
- **Why does `CompetitorId` connect `CompetitorId` to `PrescribeDrawDecideTests`, `FakeEntryQuery`, `ReflightingForAMissedRoundSteps`, `CatalogueDrawPropertyTests`, `.SeedWired`, `EntryId`, `CompetitionId`, `ResolvingATieBreakSteps`, `PhaseDrawn`, `EntryCapturePropertyTests`, `ClosingACompetitionSteps`, `.New`, `.Group`, `GroupId`, `IEventStore`, `Entry`, `CompetitionView`, `AcceptingTheDrawSteps`, `Then`, `AmendMeasurementDecideTests`, `FakeClock`, `DrawPhase`, `SeeingWhatIsRecordedSteps`, `AnnulEntryDecideTests`, `.ComputeGroupViews`, `RecordingAReflightRulingSteps`, `ScoringTeamsSteps`, `LandingTapeDeclaredScaleSteps`, `FakeEventStore`, `Defect`, `TeamsDecideTests`, `ScoringTeamCommandHandlerTests`, `.BuildDrawnCompetition`, `RecordCompetitionPenalty`, `ICommandHandler`, `.New`, `ReflightDestinationTests`, `DrawAcceptanceDecideTests`, `GliderscoreFixture`, `TeamClassificationEngineTests`, `RecordCompetitionPenaltyDecideTests`, `DateTimeOffset`, `.BuildDrawnCompetition`, `.SeedScoredTeamCompetition`, `IStoreFixture`, `F5JChristchurchTapeReadingExamplesTests`, `.LoadAsync`, `.BuildCompetition`, `OpenFlightDecideTests`, `.DrawnCompetitionAsync`, `WithdrawCompetitorHandler`, `IDispatcher`, `.DefinitionWith`, `DrawProtectionPropertyTests`, `TeamClassificationPropertyTests`, `.DrawnCompetitionAsync`, `RecordEntryPenaltyDecideTests`, `AssigningSpotsSteps`, `.ScoreCompetition`, `IClassFixture`, `.BuildDrawnCompetition`, `CaptureMeasurementDecideTests`, `.SetUpAsync`, `GroupSpotsPropertyTests`, `.ComputeEntries`, `.BuildGroups`, `SystemClock`, `PhaseDrawPropertyTests`, `.BuildDrawnCompetition`, `.Classify`, `CompetitionResult`, `ProtectedPair`, `RecordingAGliderscoreFixtureSteps`, `ImmutableArray`, `AdoptedRules`, `TeamContributionState`, `FakeEventStore`, `.Select`, `ScoringTeamId`, `TapeAmendmentDecideTests`, `Competitor`, `Competition.cs`, `.FindAsync`, `.FlyReadingsAsync`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `Soarscore.Domain.PublishedClassDefinition` connect `Soarscore.Domain.PublishedClassDefinition` to `Soarscore.Domain`, `NumberOrParam`, `IProjection`, `.Aggregate`, `ClassDefinitionPublished`, `Soarscore.Application`, `PhaseDrawn`, `Soarscore.Application.Queries.Competitions`, `FixtureModels.cs`, `.Rank`, `Soarscore.Application.Queries.CompetitionClasses`, `Enumerations.cs`, `PenaltyDefinition`, `ReadingScale`, `PostgresFixture`, `Corpus.cs`, `PublishedClassDefinition`, `Soarscore.Application.Tests.Shared.Entries`, `Competition.cs`, `TaskDefinition`, `TieBreakDirective`?**
...
- **Should `Soarscore.Domain.PublishedClassDefinition` be split into smaller, more focused modules?**
  _Cohesion score 0.048754789272030655 - nodes in this community are weakly interconnected._
