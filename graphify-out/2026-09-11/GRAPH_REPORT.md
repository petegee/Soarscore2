...
## Corpus Check
- 727 files · ~1,252,428 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9227 nodes · 25591 edges · 416 communities (407 shown, 9 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 2704 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b7c069bf`
...
- ClearScoringTeamMembershipHandler
...
## Communities (416 total, 9 thin omitted)

### Community 0 - "PrescribeDrawDecideTests"
Cohesion: 0.06
Nodes (36): Mutation, IReadOnlyList, PrescribedGroup, PrescribedRound, CompetitionId, Given, HttpClient, HttpResponseMessage (+28 more)

### Community 1 - "Soarscore.Domain.PublishedClassDefinition"
Cohesion: 0.05
Nodes (7): Soarscore.Domain.Scoring, Soarscore.Domain.Tests, Soarscore.Domain.Competitions, Soarscore.Domain.People, Soarscore.SeedData, Soarscore.Domain.PublishedClassDefinition, Intrinsic
...
Cohesion: 0.08
Nodes (7): Soarscore.Application.Commands.Competitions, Soarscore.Application.Shared.People, Soarscore.Application.Tests.Queries.Competitions, Soarscore.Application.Tests.Shared.Competitions, Soarscore.Domain, Soarscore.Application.Tests.Commands.Competitions, Soarscore.Application.Shared.Competitions
...
Cohesion: 0.08
Nodes (33): CancellationToken, IClock, IEventStore, Task, RegisterCompetitorHandler, CancellationToken, IClock, IEventStore (+25 more)
...
### Community 15 - "PhaseDefinition"
Cohesion: 0.06
Nodes (37): ImmutableArray, PhaseDefinition, Drops, Ordinal, Promotion, Rounds, Tasks, TieBreaks (+29 more)

### Community 16 - ".SelectAndScore"
Cohesion: 0.08
Nodes (32): ISet, TargetAssignment, AnyOrder, InOrder, None, ImmutableArray, AllOf, Children (+24 more)
...
Cohesion: 0.05
Nodes (75): ClassCorpusSeederHost, ICommand, IHttpMaxRequestBodySizeFeature, IParsable, WebApplication, Commands, IReadOnlyList, WebApplication (+67 more)

### Community 19 - "ResolvingATieBreakSteps"
Cohesion: 0.12
Nodes (13): PendingTieBreaksView, CompetitionId, Dictionary, Given, Group, HttpClient, HttpResponseMessage, List (+5 more)
...
Cohesion: 0.09
Nodes (31): Exception, Parameter, AllowedValues, BoundAt, DefaultValue, Kind, Name, Unit (+23 more)
...
### Community 25 - "PhaseDrawn"
Cohesion: 0.09
Nodes (35): DateTimeOffset, Group, ImmutableArray, IReadOnlyList, Penalty, ReflightRuling, Round, TieBreakOutcome (+27 more)

### Community 26 - "EntryCapturePropertyTests"
Cohesion: 0.07
Nodes (30): DecideActual, DecideFlightModel, DecideModel, FlagValue, FlightPlan, MetricIndex, NumericValue, Pick (+22 more)
...
### Community 31 - "FlightOpened"
Cohesion: 0.13
Nodes (18): IDomainEvent, DateTimeOffset, Penalty, EntryAnnulled, EntryEvent, FlightOpened, MeasurementAmended, MeasurementCaptured (+10 more)
...
### Community 38 - "When"
Cohesion: 0.13
Nodes (13): When, CompetitionId, DateTimeOffset, Dictionary, Given, Group, HttpClient, HttpResponseMessage (+5 more)
...
Cohesion: 0.07
Nodes (49): Round2GroupRef, CancellationToken, IClock, IEventStore, Task, DrawPhaseHandler, CancellationToken, Competition (+41 more)
...
Cohesion: 0.12
Nodes (29): AccruedInfo, PenaltyScope, PenaltyDefinition, Accrual, Effects, ExclusionGroups, PermittedScopes, PenaltyEffectSpec (+21 more)
...
### Community 46 - "EntryId"
Cohesion: 0.17
Nodes (9): Guid, EntryId, CompetitionId, Given, HttpClient, List, Task, SeeingWhatIsRecordedSteps (+1 more)
...
Cohesion: 0.12
Nodes (15): Bindings, ClassDef, ExpectedRawScore, Competition, TaskResolver, AllFlights, ScoreTerm, ResolvedTask (+7 more)
...
Cohesion: 0.17
Nodes (17): CancellationToken, IClock, IEventStore, Task, OpenFlightHandler, CancellationToken, DateTimeOffset, Fact (+9 more)
...
Cohesion: 0.09
Nodes (23): ExpectedVersion, Any, IsAny, IsExact, IsNoStream, NoStream, Version, Kind (+15 more)
...
Cohesion: 0.04
Nodes (57): ResolvedSchedule, DateOnly, DateTimeOffset, Defect, Func, IEnumerable, ImmutableArray, Penalty (+49 more)
...
Cohesion: 0.09
Nodes (33): IQueryHandler, CancellationToken, IClock, IEventStore, Task, ChangePersonClubAffiliationHandler, CancellationToken, IClock (+25 more)
...
Cohesion: 0.06
Nodes (54): ICommandHandler, CancellationToken, IClock, IEventStore, ImmutableArray, Task, FinaliseCompetition, FinaliseCompetitionHandler (+46 more)
...
### Community 93 - ".New"
Cohesion: 0.06
Nodes (37): Id, Competition, DateOnly, CompetitionCreated, DrawAccepted, Competition, Dictionary, Entries (+29 more)

### Community 94 - ".BuildCompetition"
Cohesion: 0.17
...
Cohesion: 0.06
Nodes (52): Hash, CancellationToken, IClock, IEventStore, Task, PublishClassDefinition, PublishClassDefinitionHandler, CancellationToken (+44 more)
...
Cohesion: 0.10
Nodes (19): Penalty, By, CompetitorRef, InfractionType, Scope, TaskRound, TaskRoundCoordinate, DateTimeOffset (+11 more)
...
Cohesion: 0.11
Nodes (27): IQuery, IReadOnlyList, WebApplication, Queries, CancellationToken, Entry, IEventStore, ImmutableArray (+19 more)
...
Cohesion: 0.10
Nodes (19): actual, Actual, Model, model, Competition, Fact, Gen, GenOperation (+11 more)
...
Cohesion: 0.09
Nodes (8): Soarscore.Application.Seeding, Soarscore.Application.Tests.Commands.CompetitionClasses, Soarscore.Application.Tests.Seeding, Soarscore.Application.Queries.CompetitionClasses, Soarscore.Application.Tests.Shared.CompetitionClasses, Soarscore.Application.Shared.CompetitionClasses, Soarscore.Api.Seeding, Soarscore.Application.Tests.Queries.CompetitionClasses
...
Cohesion: 0.05
Nodes (36): CapScope, PerFlight, PerTask, CompositionKind, ChooseFromCatalogue, FixedSequence, DropDimension, ByRound (+28 more)
...
### Community 180 - ".PostCommandRawAsync"
Cohesion: 0.25
...
### Community 212 - ".AppendAsync"
Cohesion: 0.09
Nodes (23): CancellationToken, Task, CancellationToken, Task, CancellationToken, Task, CancellationToken, IClock (+15 more)
...
### Community 214 - "CompetitionSummary"
Cohesion: 0.19
...
Cohesion: 0.11
Nodes (18): EventKind, phaseCount, roundsPerPhase, targetPhase, targetTaskRound, taskRoundsPerRound, Dictionary, Fact (+10 more)
...
Cohesion: 0.06
Nodes (43): DeclaredTeamContributor, CompetitorRef, Placing, Score, DeclaredTeamResult, BestIndividualPlacing, Contributors, Name (+35 more)
...
Cohesion: 0.13
Nodes (22): DeclaredInstrument, Instrument, Metric, Scale, ImmutableArray, ImmutableDictionary, TieBreakDirective, CompetitionResult (+14 more)

### Community 260 - "IClassFixture"
Cohesion: 0.11
Nodes (21): IClassFixture, CancellationToken, IClock, IEventStore, Task, AppendReflightGroupHandler, CancellationToken, Entry (+13 more)
...
Cohesion: 0.10
Nodes (31): CancellationToken, Competition, Entry, Group, IEventStore, ImmutableArray, IReadOnlyDictionary, IReadOnlySet (+23 more)

### Community 275 - "GroupSpotsPropertyTests"
Cohesion: 0.10
Nodes (23): IReadOnlyCollection, Ops, SpotBase, Competition, DateTimeOffset, Dictionary, Fact, FieldSize (+15 more)
...
### Community 297 - ".BuildDrawnCompetition"
Cohesion: 0.27
...
Cohesion: 0.03
Nodes (72): Soarscore.Infrastructure.Competitions, Soarscore.Infrastructure.Tests, Soarscore.Infrastructure.CompetitionClasses, Soarscore.Infrastructure.People, Soarscore.Application.Queries.People, Soarscore.Infrastructure, Soarscore.Application.Queries.Competitions, Soarscore.Application (+64 more)
...
### Community 326 - "IServiceProvider"
Cohesion: 0.15
...
Cohesion: 0.14
Nodes (21): CancellationToken, IEventStore, Task, RecordEntryPenalty, RecordEntryPenaltyHandler, PenaltyScope, Competition, Entry (+13 more)
...
### Community 334 - ".Declared_reading_and_distance_round_trip_with_instruments_intact"
Cohesion: 0.51
...
### Community 336 - "AdoptedRules"
Cohesion: 0.10
Nodes (22): CancellationToken, IClock, IEventStore, Task, AssignGroupSpotsHandler, AdoptedRules, AdoptedAt, Definition (+14 more)
...
### Community 341 - "TeamContributionState"
Cohesion: 0.17
...
Cohesion: 0.08
Nodes (26): CountsFor, Role, ReflightRole, Entitled, Filler, Original, ReflightSelection, BetterOf (+18 more)
...
Cohesion: 0.15
Nodes (11): 1. Pilot assignment to groups (the draw), 2. Data the timer / helper collects, 3. Group score, 4. Round & final score, 5. Re-flights, F5 Electric Soaring — Generally Applicable Rules, Source references, CIAM General Rules — 2026 Edition (extracted source text) (+3 more)

### Community 354 - "ScoringTeamId"
Cohesion: 0.32
...
### Community 356 - "F3B — RC Multi-Task Gliders"
Cohesion: 0.22
...
### Community 358 - "Amendment"
Cohesion: 0.22
Nodes (9): Amendment, At, By, Instrument, NewValue, Reason, DateTimeOffset, Gen (+1 more)

### Community 359 - "MetricDefinition"
Cohesion: 0.04
Nodes (46): MetricDefinition, DeclaredBeforeLaunch, Kind, Name, Precision, Unit, WhenNotRecorded, ImmutableArray (+38 more)

### Community 360 - "FakeClassLibraryQuery"
Cohesion: 0.44
...
### Community 363 - "SeedF5J"
Cohesion: 0.22
Nodes (8): ImmutableArray, SeedF5J, Definition, FlightMetrics, FlyoffTaskD, LandingRows, StartHeightBands, TaskD

### Community 364 - "Competition.cs"
Cohesion: 0.05
Nodes (40): Round, DeclaredResult, Aggregate, CompetitorRef, Placing, Promoted, Draw, CreatedAt (+32 more)
...
Cohesion: 0.05
Nodes (45): TaskDefinition, Code, Flights, FlightValidWhen, Group, Metrics, Name, Normalise (+37 more)
...
### Community 368 - ".SeedFinalisableTeamCompetition"
Cohesion: 0.25
...
### Community 370 - "TieBreakDirective"
Cohesion: 0.39
...
Cohesion: 0.11
Nodes (16): Rows, ScoreTerm, ConstantTerm, Value, LookupRow, LookupTerm, MetricRef, Rows (+8 more)
...
### Community 381 - "F3J.11 FINAL CLASSIFICATION"
Cohesion: 0.40
...
### Community 382 - "CompetitionFieldPropertyTests"
Cohesion: 0.29
Nodes (7): FieldOp, Gen, Index, CompetitionFieldPropertyTests, FieldOp, Register, Withdraw
...
### Community 384 - "F3J.1 GENERAL RULES"
Cohesion: 0.40
...
### Community 386 - "F3J.2 THE FLYING SITE"
Cohesion: 0.40
...
### Community 388 - "ReflightDestinationPropertyTests"
Cohesion: 0.43
Nodes (3): DateTimeOffset, Fact, ReflightDestinationPropertyTests

### Community 389 - "F3J.8 LAUNCHING"
Cohesion: 0.25
...
### Community 391 - "Story — Seed the class corpus into a deployment at startup"
Cohesion: 0.33
Nodes (5): Before starting, Design notes (settled while raising), Story — Seed the class corpus into a deployment at startup, What, Why it matters
...
### Community 396 - "ClearScoringTeamMembershipHandler"
Cohesion: 0.33
Nodes (5): CancellationToken, IClock, IEventStore, Task, ClearScoringTeamMembershipHandler
...
### Community 400 - "F3J.6 ORGANISATION OF THE FLYING"
Cohesion: 0.50
...
### Community 402 - "F3J.13 ADVISORY INFORMATION"
Cohesion: 0.50
Nodes (4): F3J.13.1 Organisational Requirements, F3J.13.2 Time-keeper Duties, F3J.13.3 Groups, F3J.13 ADVISORY INFORMATION

### Community 403 - "Result"
Cohesion: 0.08
Nodes (39): CancellationToken, Guid, IReadOnlyList, Task, RecordedEvent, IReadOnlyList, Result, Advisories (+31 more)

### Community 406 - "F3J.9 LANDING"
Cohesion: 0.50
...
### Community 409 - ".Publishing_then_optionally_retiring_preserves_identity_fields_and_models_RetiredAt_correctly"
Cohesion: 0.40
Nodes (4): DateTimeOffset, Fact, Gen, ClassDefinitionProjectionPropertyTests

### Community 410 - "SeedF3B"
Cohesion: 0.40
...
### Community 413 - ".GenOp"
Cohesion: 0.67
Nodes (3): OpKind, Gen, Op

### Community 414 - "2.5 CONTESTS"
Cohesion: 0.67
...
## Knowledge Gaps
- **2531 isolated node(s):** `context7`, `rider`, `$schema`, `.opencode/plugins/graphify.js`, `Soarscore.Api.Seeding` (+2526 more)
...
- **Why does `ClassDefinition` connect `ClassDefinition` to `PrescribeDrawDecideTests`, `FakeEntryQuery`, `ReflightingForAMissedRoundSteps`, `MetricAbsenceFixtures`, `CatalogueDrawPropertyTests`, `CompetitorId`, `.HandleAsync`, `PhaseDefinition`, `CapturingAScoreSteps`, `CompetitionId`, `.CheckLimits`, `TapeLandingScaleProofTests`, `MeasuredValue`, `PhaseDrawn`, `Then`, `.New`, `GliderscoreFixture`, `FlightOpened`, `ScoringServicePropertyTests`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `When`, `SystemClock`, `PenaltyDefinition`, `EntryId`, `RecordingAReflightRulingSteps`, `ScoringTeamsSteps`, `ResolvedTask`, `.SeedAsync`, `OpenFlight`, `LandingTapeDeclaredScaleSteps`, `FakeEventStore`, `.CompetitionAdopting`, `ScoringTeamCommandHandlerTests`, `.BuildDrawnCompetition`, `.SeedCompetition`, `IStoreFixture`, `.Validate`, `.Exact`, `.New`, `.BuildCompetition`, `ReplayDriver`, `PublishClassDefinition`, `RecordCompetitionPenaltyDecideTests`, `CaptureMeasurement`, `.BuildDrawnCompetition`, `BindParameterDecideTests`, `.MapQueries`, `EntryModelBasedFoldTests`, `FinaliseDecideTests`, `.BuildCompetition`, `Enumerations.cs`, `.BuildCompetition`, `DeclareInstrumentsHandler`, `SeedF3K`, `Competitor`, `ClassDefinitionValidationPropertyTests`, `.DrawnCompetitionAsync`, `.AppendAsync`, `IDispatcher`, `.DefinitionWith`, `CompetitionReplaceTaskRoundPropertyTests`, `.All_seven_team_events_round_trip_through_the_real_store_and_replay_to_the_expected_state`, `.DrawnCompetitionAsync`, `DrawAcceptancePropertyTests`, `.ScoreCompetition`, `IClassFixture`, `ClassDefinitionPublished`, `.SetUpAsync`, `GroupSpotsPropertyTests`, `.DefinitionWith`, `SeedF5K`, `.BuildDrawnCompetition`, `BindParameterPropertyTests`, `Soarscore.Application.Tests`, `.CompareAsync`, `.Apply`, `.SeedEntryUnderF5K`, `.Declared_reading_and_distance_round_trip_with_instruments_intact`, `AdoptedRules`, `PublishedClassDefinition`, `.OpenFlownEntry`, `.Apply`, `.Select`, `MetricDefinition`, `SeedF5J`, `Competition.cs`, `SeedingTheClassCatalogueSteps`, `TaskDefinition`, `CompetitionFieldPropertyTests`, `CreateCompetitionPropertyTests`, `.Publishing_then_optionally_retiring_preserves_identity_fields_and_models_RetiredAt_correctly`, `SeedF3B`, `.Load`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `CompetitorId` connect `CompetitorId` to `PrescribeDrawDecideTests`, `FakeEntryQuery`, `ReflightingForAMissedRoundSteps`, `CatalogueDrawPropertyTests`, `.SeedWired`, `PhaseDefinition`, `CapturingAScoreSteps`, `CompetitionId`, `ResolvingATieBreakSteps`, `PhaseDrawn`, `EntryCapturePropertyTests`, `Then`, `.New`, `FlightOpened`, `ScoringServicePropertyTests`, `IEventStore`, `Entry`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `When`, `AmendMeasurementDecideTests`, `FakeClock`, `SystemClock`, `EntryId`, `AnnulEntryDecideTests`, `TaskRoundRecordingPropertyTests`, `RecordingAReflightRulingSteps`, `ScoringTeamsSteps`, `LandingTapeDeclaredScaleSteps`, `FakeEventStore`, `Competition`, `TeamsDecideTests`, `ScoringTeamCommandHandlerTests`, `.BuildDrawnCompetition`, `.SeedCompetition`, `IStoreFixture`, `.New`, `.BuildCompetition`, `DrawAcceptanceDecideTests`, `ReplayDriver`, `TeamClassificationEngineTests`, `RecordCompetitionPenaltyDecideTests`, `FakeEventStore`, `.BuildDrawnCompetition`, `.SeedScoredTeamCompetition`, `F5JChristchurchTapeReadingExamplesTests`, `.MapQueries`, `.BuildCompetition`, `OpenFlightDecideTests`, `.BuildCompetition`, `Competitor`, `.DrawnCompetitionAsync`, `.AppendAsync`, `IDispatcher`, `.DefinitionWith`, `DrawProtectionPropertyTests`, `TeamClassificationPropertyTests`, `.All_seven_team_events_round_trip_through_the_real_store_and_replay_to_the_expected_state`, `.DrawnCompetitionAsync`, `AssigningSpotsSteps`, `IClassFixture`, `.BuildDrawnCompetition`, `.SetUpAsync`, `GroupSpotsPropertyTests`, `.ComputeEntries`, `.BuildGroups`, `.DefinitionWith`, `PhaseDrawPropertyTests`, `.BuildDrawnCompetition`, `.Classify`, `FindEntries`, `ProtectedPair`, `RecordingAGliderscoreFixtureSteps`, `AdoptedRules`, `.Of`, `TeamContributionState`, `.OpenFlownEntry`, `.Select`, `TapeAmendmentDecideTests`, `Competition.cs`, `.SeedFinalisableTeamCompetition`, `ReflightDestinationPropertyTests`, `.FlyReadingsAsync`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `CompetitionId` connect `CompetitionId` to `FakeEntryQuery`, `FakeEventStore`, `IClassFixture`, `.SeedScoredTeamCompetition`, `CompetitorId`, `ClearScoringTeamMembershipHandler`, `.SeedWired`, `.HandleAsync`, `.MapQueries`, `.SetUpAsync`, `EntryCapturePropertyTests`, `FlightOpened`, `IEventStore`, `Entry`, `OpenFlightDecideTests`, `AmendMeasurementDecideTests`, `FakeClock`, `SystemClock`, `DeclareInstrumentsHandler`, `AnnulEntryDecideTests`, `FindEntries`, `ProtectedPair`, `OpenFlight`, `FakeEventStore`, `Competition`, `ScoringTeamCommandHandlerTests`, `.Declared_reading_and_distance_round_trip_with_instruments_intact`, `AdoptedRules`, `.DrawnCompetitionAsync`, `.SeedCompetition`, `.AppendAsync`, `IStoreFixture`, `CompetitionSummary`, `.Of`, `IDispatcher`, `.OpenFlownEntry`, `.Exact`, `.New`, `ReplayDriver`, `TapeAmendmentDecideTests`, `PublishClassDefinition`, `Competition.cs`, `RecordCompetitionPenaltyDecideTests`, `.SeedFinalisableTeamCompetition`, `.DrawnCompetitionAsync`, `.LoadCurrentAsync`, `CaptureMeasurement`?**
