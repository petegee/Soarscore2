...
## Corpus Check
- 781 files · ~1,294,186 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9950 nodes · 27989 edges · 449 communities (439 shown, 10 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 3031 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `34aa8330`
...
- .SetUpAsync
- ReadingScale
- .Compute_against_a_hand_built_three_round_fixture_matches_hand_computed_counts
- Work items
...
3. `Soarscore.Domain.PublishedClassDefinition` - 239 edges
4. `ClassDefinition` - 236 edges
5. `Soarscore.Domain.Competitions` - 215 edges
6. `Soarscore.Domain.People` - 161 edges
7. `Result` - 154 edges
8. `Soarscore.Domain` - 147 edges
9. `EntryId` - 140 edges
10. `Soarscore.SeedData` - 136 edges
...
## Communities (449 total, 10 thin omitted)

### Community 0 - "Entry"
Cohesion: 0.04
Nodes (61): EntryProjection, DateTimeOffset, Func, ImmutableArray, Penalty, PenaltyRecorded, Result, Amendment (+53 more)
...
Cohesion: 0.10
Nodes (30): Events, JsonDerivedTypeAttribute, IReadOnlyDictionary, EventLogNames, EventLogSummariser, CancellationToken, Guid, IEventStore (+22 more)
...
Cohesion: 0.07
Nodes (28): Class, ScoreTerm, ConstantTerm, Value, PendingFlightDiagnostic, Dictionary, Fact, InlineData (+20 more)
...
Cohesion: 0.08
Nodes (11): Soarscore.Domain.Competitions, Soarscore.Application.Shared.Entries, Soarscore.Application.Commands.Competitions, Soarscore.Application.Tests.Queries.Competitions, Soarscore.Application.Tests.Shared.Competitions, Soarscore.Application.Queries.Entries, Soarscore.Domain, Soarscore.Application.Tests.Commands.Competitions (+3 more)
...
Cohesion: 0.18
Nodes (11): JsonSerializerOptions, ClassDefinitionHashing, FlagOrParam, Ref, JsonSerializerOptions, Utf8JsonReader, Utf8JsonWriter, FlagOrParamConverter (+3 more)

### Community 10 - "Defect"
Cohesion: 0.12
Nodes (6): Defect, ReflightRuling, TaskRoundCoordinate, TieBreakOutcome, TieBreakOutcomePlacing, Defect

### Community 11 - "CompetitorRegistered"
Cohesion: 0.10
Nodes (28): CancellationToken, IClock, IEventStore, Task, RegisterCompetitorHandler, CancellationToken, IClock, IEventStore (+20 more)
...
Cohesion: 0.08
Nodes (37): PenaltyRecorded, DateTimeOffset, Group, ImmutableArray, IReadOnlyList, Penalty, ReflightRuling, Round (+29 more)

### Community 16 - "CompetitionCreated"
Cohesion: 0.09
Nodes (22): Alice, Bob, EntryOne, EntryTwo, DateOnly, CompetitionCreated, ArgumentException, Competition (+14 more)

### Community 17 - "EntryId"
Cohesion: 0.09
Nodes (17): Guid, EntryId, CompetitionId, Dictionary, Given, Group, HttpClient, HttpResponseMessage (+9 more)

### Community 18 - "CompetitionId"
Cohesion: 0.04
Nodes (93): ClassCorpusSeederHost, ICommand, IHttpMaxRequestBodySizeFeature, IParsable, JwtBearerOptions, WebApplication, Commands, IConfiguration (+85 more)
...
Cohesion: 0.32
Nodes (3): IReadOnlyList, Fact, ClassDefinitionIngestionTests

### Community 21 - "TapeLandingScaleProofTests"
Cohesion: 0.15
Nodes (10): LandingTable, ScaleMark, DateTimeOffset, Dictionary, Fact, InvalidOperationException, IReadOnlyList, LandingTable (+2 more)
...
Cohesion: 0.08
Nodes (9): Soarscore.Application.Tests.Auth, Soarscore.Application.Shared.People, Soarscore.Api.Auth, Soarscore.Application.Tests.Shared.People, Soarscore.Application.Queries.People, Soarscore.Application.Auth, Soarscore.Application.Auth.Policies, Soarscore.Application.Tests.Queries.People (+1 more)
...
### Community 31 - "Competition.cs"
Cohesion: 0.07
Nodes (35): ResolvedSchedule, Round, Func, ImmutableArray, Draw, CreatedAt, Status, Finalisation (+27 more)
...
### Community 35 - "IPeopleQuery"
Cohesion: 0.08
Nodes (29): IConfiguration, IReadOnlyList, AuthMode, Mock, None, Oidc, AuthSettings, Audience (+21 more)
...
### Community 38 - "Then"
Cohesion: 0.10
Nodes (18): Competition, ImmutableArray, CompetitionView, ImmutableArray, CompetitionScoreView, Then, CompetitionId, DateTimeOffset (+10 more)
...
### Community 40 - ".Exact"
Cohesion: 0.10
Nodes (35): CancellationToken, IClock, IEventStore, Task, AddProtectionGroupMemberHandler, CancellationToken, IClock, IEventStore (+27 more)

### Community 41 - ".ComputeEntries"
Cohesion: 0.39
Nodes (4): ImmutableArray, ImmutableDictionary, PairwiseCoOccurrence, PairwiseCoOccurrenceEntry
...
Cohesion: 0.15
Nodes (23): AccruedInfo, PenaltyScope, PenaltyDefinition, Accrual, Effects, ExclusionGroups, PermittedScopes, PenaltyEffectSpec (+15 more)
...
Cohesion: 0.11
Nodes (19): CompetitorFinalScoreView, Contributes, StandingsSnapshot, CompetitionId, Competitor, Dictionary, Given, Group (+11 more)
...
Cohesion: 0.05
Nodes (54): Bindings, ClassDef, ExpectedRawScore, ISet, ImmutableArray, AllFlights, AllOf, Children (+46 more)

### Community 56 - ".SeedAsync"
Cohesion: 0.11
Nodes (23): DirectoryNotFoundException, EventStore, IHostedService, CancellationToken, IConfiguration, ILogger, IServiceScopeFactory, Task (+15 more)
...
Cohesion: 0.20
Nodes (14): CancellationToken, IClock, IEventStore, Task, OpenFlightHandler, Competition, TaskResolver, DateTimeOffset (+6 more)
...
### Community 62 - "PersonId"
Cohesion: 0.09
Nodes (30): CancellationToken, IClock, IEventStore, Task, GrantRole, GrantRoleHandler, CancellationToken, IClock (+22 more)
...
Cohesion: 0.16
Nodes (16): First, Second, Entries, Id, People, Store, CancellationToken, ExpectedVersion (+8 more)
...
Cohesion: 0.09
Nodes (33): ICommandHandler, CancellationToken, IClock, IEventStore, Task, AssignScoringTeamMembershipHandler, CancellationToken, IClock (+25 more)

### Community 78 - "Result"
Cohesion: 0.04
Nodes (71): PersonId, ISelfPersonCommand, PersonRef, CancellationToken, IClock, IEventStore, PersonId, Task (+63 more)
...
Cohesion: 0.17
Nodes (17): Cut, Halt, OrderKey, Policy, Strict, Cells, Disq, Fact (+9 more)
...
### Community 83 - "RegisterCompetitorPropertyTests"
Cohesion: 0.24
Nodes (7): IsBogus, DateTimeOffset, Fact, FakeEventStore, Gen, Index, RegisterCompetitorPropertyTests

### Community 84 - "SystemClock"
Cohesion: 0.05
Nodes (58): CancellationToken, IClock, IEventStore, Task, AppendReflightGroupHandler, CancellationToken, IClock, IEventStore (+50 more)
...
### Community 92 - "Person"
Cohesion: 0.09
Nodes (16): ImmutableHashSet, DateTimeOffset, Defect, ImmutableArray, Result, Person, Club, Contact (+8 more)

### Community 93 - ".BuildDrawnCompetition"
Cohesion: 0.27
...
Cohesion: 0.08
Nodes (41): IEventStore, Provider, IReadOnlyList, AuthBootstrap, LinkSignIn, PersonIdentityMatch, IReadOnlyList, PersonSummary (+33 more)
...
Cohesion: 0.05
Nodes (63): Hash, IClassFixture, IQuery, Round2GroupRef, CancellationToken, IClock, IEventStore, Task (+55 more)
...
Cohesion: 0.11
Nodes (23): NormalisationDirection, HigherIsBetter, LowerIsBetter, Normalisation, Direction, Round, WinnerScore, ImmutableArray (+15 more)
...
### Community 129 - ".New"
Cohesion: 0.07
Nodes (38): PeopleProjection, ClubAffiliation, ClubName, MembershipNumber, ContactDetails, Email, HomeCity, Phone (+30 more)
...
Cohesion: 0.05
Nodes (49): IQueryHandler, CancellationToken, IClock, IEventStore, ImmutableArray, Task, FinaliseCompetition, FinaliseCompetitionHandler (+41 more)

### Community 138 - ".SeedOpenEntryWithFlight"
Cohesion: 0.17
...
Cohesion: 0.11
Nodes (19): IProjection, PersonIdentityProjection, CancellationToken, IDocumentOperations, IDocumentSession, IEvent, IReadOnlyList, Task (+11 more)

### Community 140 - "CaptureMeasurement"
Cohesion: 0.10
Nodes (25): IEntryScopedCommand, EntryRef, CancellationToken, IClock, IEventStore, Task, CaptureMeasurement, CaptureMeasurementHandler (+17 more)
...
Cohesion: 0.20
Nodes (8): Fact, Gen, GenOperation, IEnumerable, EntryModelBasedFoldTests, MeasurementModel, AmendmentCount, Metric
...
### Community 152 - "Competition"
Cohesion: 0.12
Nodes (13): DeclaredResult, Aggregate, CompetitorRef, Placing, Promoted, Competition, DateTimeOffset, Fact (+5 more)
...
Cohesion: 0.05
Nodes (44): ClaimsPrincipal, CancellationToken, IReadOnlyList, PersonId, Task, HttpCurrentUser, Email, IsAuthenticated (+36 more)
...
### Community 163 - "NumberOrParam"
Cohesion: 0.17
Nodes (9): Bands, Rows, Literal, NumberOrParam, Band, Builder, ImmutableArray, Bands (+1 more)
...
Cohesion: 0.09
Nodes (23): Penalty, Competition, AdoptedRules, CapturePolicy, DeclaredInstruments, EndDate, EvaluatorVersion, Finalisations (+15 more)
...
### Community 171 - ".Of"
Cohesion: 0.10
Nodes (10): Fact, InlineData, Theory, BindParameterDecideTests, ArgumentException, Fact, FlightInterpreterTests, Fact (+2 more)
...
### Community 190 - "B.1.2 Classification of model aircraft"
Cohesion: 0.11
...
### Community 200 - "DeclaredInstrument"
Cohesion: 0.13
Nodes (14): IEnumerable, DeclaredInstrument, Instrument, Metric, InstrumentDeclaration, At, By, Instruments (+6 more)
...
### Community 218 - "AcceptanceFixture"
Cohesion: 0.16
...
Cohesion: 0.06
Nodes (44): ICommandPolicy, AuthzOutcome, CancellationToken, ICurrentUser, IServiceProvider, Task, AuthenticatedPolicy, AuthzOutcome (+36 more)
...
Cohesion: 0.29
Nodes (6): Microsoft.AspNetCore.Authentication.JwtBearer, Microsoft.AspNetCore.OpenApi, Microsoft.IdentityModel.JsonWebTokens, Swashbuckle.AspNetCore.SwaggerUI, Microsoft.NET.Sdk.Web, $(SoarscoreTargetFramework)
...
Cohesion: 0.06
Nodes (36): FieldOp, IReadOnlyCollection, OpKind, Ops, SpotBase, GroupSpotView, Op, Fact (+28 more)
...
### Community 254 - ".Every_mapped_command_and_query_resolves_its_handler_from_DI"
Cohesion: 0.12
...
Cohesion: 0.25
Nodes (6): ReadingScale, Marks, OffScaleReading, ReadingSet, Unit, TapeMapping

### Community 276 - ".Compute_against_a_hand_built_three_round_fixture_matches_hand_computed_counts"
Cohesion: 0.33
Nodes (5): Dictionary, Fact, Group, Round, PairwiseCoOccurrenceTests
...
### Community 287 - ".Rank"
Cohesion: 0.24
Nodes (8): BestDroppedScore, QualifyingPosition, SourcePhaseOrdinal, ImmutableArray, TieBreakContext, Display, Fact, RankingEngineTests
...
Cohesion: 0.20
Nodes (11): CompetitorId, Rounds, Dictionary, Fact, Field, Gen, IEnumerable, ImmutableArray (+3 more)

### Community 291 - ".OpenFlightWith"
Cohesion: 0.32
Nodes (3): ConditionalTerm, Else, ImmutableArray
...
### Community 293 - "ReflightRule"
Cohesion: 0.09
Nodes (21): ReflightRule, EntitledScores, MinNewGroupSize, OthersScore, Competition, DateTimeOffset, Dictionary, Entries (+13 more)
...
### Community 297 - ".BaseDefinition"
Cohesion: 0.30
Nodes (3): ClassDefinitionIngestionFixtures, Fact, ClassDefinitionIngestionPropertyTests
...
Cohesion: 0.13
Nodes (16): Scale, ImmutableArray, Result, ComposedReadingScale, Awards, Tape, ReadingAward, TapeComposition (+8 more)
...
Cohesion: 0.09
Nodes (19): IServiceCollection, DateTimeOffset, IClock, UtcNow, CancellationToken, IDocumentSessionFactory, IReadOnlyList, Task (+11 more)
...
### Community 326 - "DateTimeOffset"
Cohesion: 0.17
Nodes (3): DateTimeOffset, Result, Phase
...
### Community 331 - "Soarscore.Application.Tests.Shared.Entries"
Cohesion: 0.29
...
### Community 333 - ".ScoreGroup"
Cohesion: 0.11
Nodes (21): Other, GroupResult, ImmutableArray, ImmutableDictionary, IReadOnlyDictionary, Penalty, Result, TaskRoundCoordinate (+13 more)
...
Cohesion: 0.06
Nodes (53): FakeServiceProvider, IServiceProvider, AuthzOutcome, CancellationToken, ICurrentUser, IServiceProvider, Task, CapturePolicyPolicy (+45 more)
...
### Community 346 - ".ComputeGroupViews"
Cohesion: 0.27
...
### Community 348 - "RecordEntryPenaltyDecideTests"
Cohesion: 0.05
...
### Community 349 - "DecimalAsStringConverter"
Cohesion: 0.27
...
### Community 352 - "AdoptedRules"
Cohesion: 0.09
Nodes (17): AdoptedRules, AdoptedAt, Definition, SourceClassId, SourceVersion, AdoptedRules, EntryQuery, FakeEventStore (+9 more)
...
Cohesion: 0.07
Nodes (45): CancellationToken, IClock, IEventStore, Task, DrawPhaseHandler, CancellationToken, Task, CancellationToken (+37 more)

### Community 355 - "TieBreakDirective"
Cohesion: 0.11
Nodes (23): Entry, ClassificationRounds, EqualPlaces, TieBreakDirective, UndefinedRequiresRuling, ImmutableDictionary, List, RankingEngine (+15 more)
...
### Community 357 - "F3B — RC Multi-Task Gliders"
Cohesion: 0.22
...
Cohesion: 0.04
Nodes (64): TaskDefinition, Code, Flights, FlightValidWhen, Group, Metrics, Name, Normalise (+56 more)
...
### Community 384 - "F3G.2 RULES FOR MULTI-TASK CONTESTS"
Cohesion: 0.20
...
### Community 386 - "F3K.9 DEFINITION OF A ROUND"
Cohesion: 0.29
...
### Community 387 - "PromotionRule"
Cohesion: 0.29
Nodes (7): PromotionRule, CarryPenalties, Kind, MaxGroupSize, MinGroupSize, TopN, TopPercent

### Community 388 - "A.5 PLENARY MEETING"
Cohesion: 0.33
...
Cohesion: 0.03
Nodes (76): Soarscore.Infrastructure.Competitions, Soarscore.Application.Seeding, Soarscore.Infrastructure.Tests, Soarscore.Application.Tests.Seeding, Soarscore.Infrastructure.CompetitionClasses, Soarscore.Infrastructure.People, Soarscore.Infrastructure, Soarscore.Application.Queries.CompetitionClasses (+68 more)

### Community 390 - "ClassDefinitionIngestion"
Cohesion: 0.53
...
Cohesion: 0.14
Nodes (18): DateTimeOffset, Guid, ClassDefinitionProjection, ClassDefinitionSummary, CancellationToken, IReadOnlyList, Task, FindClassDefinitions (+10 more)

### Community 398 - "SeedF5J"
Cohesion: 0.22
...
### Community 407 - "F3J.1 GENERAL RULES"
Cohesion: 0.40
...
Cohesion: 0.20
Nodes (10): FinalRankingKind, LastPhaseReplaces, SinglePhase, SplitByPromotion, ImmutableDictionary, TieBreakDirective, CompetitionResult, PendingTieBreaks (+2 more)
...
### Community 436 - "SeedNzMAles200"
Cohesion: 0.50
Nodes (3): SeedNzMAles200, Definition, TaskD

### Community 437 - "SeedNzMNdc"
Cohesion: 0.50
Nodes (3): SeedNzMNdc, Definition, TaskD

### Community 438 - "EventName"
Cohesion: 0.67
Nodes (3): ConcurrentDictionary, Type, EventName

### Community 440 - "PenaltyAccrual"
Cohesion: 0.67
Nodes (3): PenaltyAccrual, OncePerAttempt, PerOccurrence

### Community 441 - "AccruedInfo"
Cohesion: 0.67
Nodes (3): AccruedInfo, HasDisqualify, TotalDeduction

### Community 443 - "ClassDefinitionProjectionPropertyTests"
Cohesion: 0.67
Nodes (3): DateTimeOffset, Gen, ClassDefinitionProjectionPropertyTests

### Community 444 - "SeedAggregate"
Cohesion: 0.67
Nodes (3): SeedAggregate, Definition, TaskA

### Community 445 - "SeedF3F"
Cohesion: 0.67
Nodes (3): SeedF3F, Definition, TaskS

### Community 446 - "SeedNzNAles123"
Cohesion: 0.67
Nodes (3): SeedNzNAles123, Definition, TaskD

### Community 447 - "SeedNzPRadian"
Cohesion: 0.67
Nodes (3): SeedNzPRadian, Definition, TaskD

### Community 448 - "SeedX5j"
Cohesion: 0.67
Nodes (3): SeedX5j, Definition, TaskD

## Knowledge Gaps
- **2614 isolated node(s):** `context7`, `rider`, `$schema`, `.opencode/plugins/graphify.js`, `None` (+2609 more)
...
- **Why does `ClassDefinition` connect `ClassDefinition` to `ReflightingForAMissedRoundSteps`, `MetricAbsenceFixtures`, `CatalogueDrawPropertyTests`, `CompetitorRegistered`, `CompetitionEvent`, `CompetitionCreated`, `EntryId`, `CompetitionId`, `.CheckLimits`, `TapeLandingScaleProofTests`, `MeasuredValue`, `ClosingACompetitionSteps`, `.New`, `ScoringServicePropertyTests`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `Then`, `PenaltyDefinition`, `FakeEntryQuery`, `.All_seven_team_events_round_trip_through_the_real_store_and_replay_to_the_expected_state`, `RecordingAReflightRulingSteps`, `ScoringTeamsSteps`, `ResolvedTask`, `.SeedAsync`, `OpenFlight`, `LandingTapeDeclaredScaleSteps`, `PrescribeDrawDecideTests`, `TeamsDecideTests`, `.CompetitionAdopting`, `.LoadAsync`, `.New`, `RegisterCompetitorPropertyTests`, `SystemClock`, `.Validate`, `.BuildDrawnCompetition`, `DeclareInstrumentsHandler`, `DrawAcceptanceDecideTests`, `GliderscoreFixture`, `PublishClassDefinition`, `RecordCompetitionPenaltyDecideTests`, `.BuildDrawnCompetition`, `.BuildDrawnCompetition`, `.SeedOpenEntryWithFlight`, `CaptureMeasurement`, `.MapQueries`, `Competition`, `PrescribeDrawPropertyTests`, `.BuildCompetition`, `.Of`, `SeedF3K`, `.DrawnCompetitionAsync`, `TaskRoundClosurePropertyTests`, `ClassDefinitionValidationPropertyTests`, `DrawAcceptancePropertyTests`, `PhaseDefinition`, `IDispatcher`, `CompetitionReplaceTaskRoundPropertyTests`, `.ScoreCompetition`, `.New`, `.OpenFlownEntry`, `GroupSpotsPropertyTests`, `.New`, `.SetUpAsync`, `ReflightRule`, `.BaseDefinition`, `.BuildDrawnCompetition`, `.DefinitionWith`, `Corpus.cs`, `CapturePolicyConfigured`, `.Load`, `.Decide`, `.ScoreGroup`, `.SeedDrawnCompetitionAsync`, `SeeingWhatIsRecordedSteps`, `CompetitionSummary`, `RecordEntryPenaltyDecideTests`, `AdoptedRules`, `DrawPhase`, `SeedF5K`, `SeedF3J`, `SeedF5kNdc`, `ClassDefinitionPublished`, `SeedingTheClassCatalogueSteps`, `TaskDefinition`, `AuthenticationEventStoreTests`, `SeedF5jNdc`, `CreateCompetitionPropertyTests`, `SeedF5J`, `SeedNzF3kNdc`, `CompetitionResult`, `RulesAmendment`, `SeedF3B`, `CompetitionModelBasedFoldTests`, `.SeedOneFlownEntry`, `SeedNzMAles200`, `SeedNzMNdc`, `.Load`, `ClassDefinitionProjectionPropertyTests`, `SeedAggregate`, `SeedF3F`, `SeedNzNAles123`, `SeedNzPRadian`, `SeedX5j`?**
  _High betweenness centrality (0.162) - this node is a cross-community bridge._
- **Why does `CompetitorId` connect `CompetitorId` to `Entry`, `GetCompetitionEventLogHandlerTests`, `ReflightingForAMissedRoundSteps`, `CatalogueDrawPropertyTests`, `Defect`, `CompetitorRegistered`, `.SeedWired`, `F5JChristchurchTapeReadingExamplesTests`, `CompetitionEvent`, `CompetitionCreated`, `EntryId`, `CompetitionId`, `ResolvingATieBreakSteps`, `EntryCapturePropertyTests`, `ClosingACompetitionSteps`, `.New`, `Competition.cs`, `ScoringServicePropertyTests`, `IEventStore`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `Then`, `AmendMeasurementDecideTests`, `.Exact`, `.ComputeEntries`, `FakeEntryQuery`, `.All_seven_team_events_round_trip_through_the_real_store_and_replay_to_the_expected_state`, `TaskRoundRecordingPropertyTests`, `RecordingAReflightRulingSteps`, `ScoringTeamsSteps`, `LandingTapeDeclaredScaleSteps`, `DrawProtectionPropertyTests`, `FakeEventStore`, `PrescribeDrawDecideTests`, `TeamsDecideTests`, `.LoadAsync`, `.New`, `SystemClock`, `.BuildDrawnCompetition`, `DrawAcceptanceDecideTests`, `GliderscoreFixture`, `TeamClassificationEngineTests`, `PublishClassDefinition`, `RecordCompetitionPenaltyDecideTests`, `.BuildDrawnCompetition`, `.BuildDrawnCompetition`, `.SeedScoredTeamCompetition`, `.MapQueries`, `Competition`, `PrescribeDrawPropertyTests`, `.BuildCompetition`, `OpenFlightDecideTests`, `Competition`, `.Of`, `.DrawnCompetitionAsync`, `TaskRoundClosurePropertyTests`, `IDispatcher`, `.ScoreCompetition`, `TeamClassificationPropertyTests`, `.New`, `.OpenFlownEntry`, `GroupSpotsPropertyTests`, `AssigningSpotsSteps`, `.BuildDrawnCompetition`, `.SetUpAsync`, `.Compute_against_a_hand_built_three_round_fixture_matches_hand_computed_counts`, `.BuildGroups`, `ReflightRule`, `.BuildDrawnCompetition`, `.Classify`, `FindEntries`, `ProtectedPair`, `.DefinitionWith`, `RecordingAGliderscoreFixtureSteps`, `DateTimeOffset`, `.ScoreGroup`, `.SeedDrawnCompetitionAsync`, `SeeingWhatIsRecordedSteps`, `.ComputeGroupViews`, `RecordEntryPenaltyDecideTests`, `AdoptedRules`, `DrawPhase`, `CaptureMeasurementDecideTests`, `TaskDefinition`, `AnnulEntryDecideTests`, `Competitor`, `.SeedOneFlownEntry`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `CompetitionId` connect `CompetitionId` to `Entry`, `GetCompetitionEventLogHandlerTests`, `.SeedScoredTeamCompetition`, `.SeedOpenEntryWithFlight`, `CompetitorRegistered`, `.SeedWired`, `CaptureMeasurement`, `CompetitionCreated`, `.MapQueries`, `.SetUpAsync`, `EntryCapturePropertyTests`, `Competition.cs`, `IEventStore`, `ReflightRule`, `OpenFlightDecideTests`, `Competition`, `.Exact`, `AmendMeasurementDecideTests`, `.Of`, `FakeEntryQuery`, `.SeedOneFlownEntry`, `FindEntries`, `ProtectedPair`, `OpenFlight`, `.DrawnCompetitionAsync`, `FakeEventStore`, `.Decide`, `.LoadAsync`, `.SeedDrawnCompetitionAsync`, `RegisterCompetitorPropertyTests`, `SystemClock`, `.SeedCompetition`, `CompetitionSummary`, `IDispatcher`, `RecordEntryPenaltyDecideTests`, `DeclareInstrumentsHandler`, `AdoptedRules`, `DrawPhase`, `GliderscoreFixture`, `CaptureMeasurementDecideTests`, `PublishClassDefinition`, `.OpenFlownEntry`, `.New`, `.LoadCurrentAsync`, `AnnulEntryDecideTests`?**
...
- **Should `Entry` be split into smaller, more focused modules?**
  _Cohesion score 0.043153244988107374 - nodes in this community are weakly interconnected._
- **Should `Soarscore.Domain.PublishedClassDefinition` be split into smaller, more focused modules?**
  _Cohesion score 0.040357941834451905 - nodes in this community are weakly interconnected._
