...
## Corpus Check
- 807 files · ~1,319,357 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10321 nodes · 29135 edges · 459 communities (446 shown, 13 thin omitted)
...
## Communities (459 total, 13 thin omitted)

### Community 0 - "FlightOpened"
Cohesion: 0.07
Nodes (33): EntryProjection, Amendment, At, By, Instrument, NewValue, Reason, DateTimeOffset (+25 more)
...
### Community 2 - "Competition.cs"
Cohesion: 0.04
Nodes (59): Competitor, CompetitorNumber, Id, PersonRef, RegisteredAt, WithdrawnAt, DeclaredResult, Aggregate (+51 more)
...
Cohesion: 0.08
Nodes (27): CaptureSlot, Class, AllFlights, FlightSelection, LastNFlights, PendingFlightDiagnostic, DateTimeOffset, Fact (+19 more)
...
Cohesion: 0.06
Nodes (9): Soarscore.Domain.Competitions, Soarscore.Application.Shared.Entries, Soarscore.Application.Tests.Queries.Competitions, Soarscore.Application.Tests.Queries.Entries, Soarscore.Application.Queries.Entries, Soarscore.Domain, Soarscore.Application.Shared.Competitions, FutureEvent (+1 more)

### Community 8 - "CompetitorId"
Cohesion: 0.14
Nodes (14): MinPerGroupByRound, Sizes, CompetitorId, MinPerGroup, TaskCount, DateTimeOffset, Dictionary, Fact (+6 more)
...
### Community 10 - ".Exact"
Cohesion: 0.09
Nodes (32): CancellationToken, IEventStore, Task, RecordEntryPenalty, RecordEntryPenaltyHandler, ExpectedVersion, Any, IsAny (+24 more)

### Community 11 - "PersonId"
Cohesion: 0.07
Nodes (36): IsBogus, CancellationToken, IClock, IEventStore, Task, RegisterCompetitorHandler, CancellationToken, IClock (+28 more)
...
Cohesion: 0.15
Nodes (18): FlownReading, Readings, CompetitionId, Competitor, Entry, EntryId, Fact, Group (+10 more)

### Community 15 - "ScoreTerm"
Cohesion: 0.16
Nodes (8): ScoreTerm, ImmutableArray, IReadOnlyDictionary, FlightSelector, InterpretedFlight, Metrics, Fact, FlightZeroingTaskGateTests
...
Cohesion: 0.04
Nodes (105): ClassCorpusSeederHost, ICommand, ICommandHandler, IHttpMaxRequestBodySizeFeature, IOptionsMonitor, IParsable, WebApplication, Commands (+97 more)

### Community 19 - "ResolvingATieBreakSteps"
Cohesion: 0.08
Nodes (27): Competition, ImmutableArray, CompetitionView, ImmutableArray, PendingTieBreaksView, PendingTieBreakView, CancellationToken, IEventStore (+19 more)
...
Cohesion: 0.06
Nodes (15): Soarscore.Infrastructure.Competitions, Soarscore.Application.Seeding, Soarscore.Infrastructure.CompetitionClasses, Soarscore.Application.Tests.Auth, Soarscore.Infrastructure.People, Soarscore.Application.Shared.People, Soarscore.Api.Auth, Soarscore.Application.Tests.Shared.People (+7 more)

### Community 25 - "Soarscore.Application"
Cohesion: 0.12
Nodes (5): Soarscore.Application.Tests.Commands.Entries, Soarscore.Application.Tests.Shared.Competitions, Soarscore.Application.Tests.Shared.Entries, Soarscore.Application.Tests.Commands.Competitions, Soarscore.Application
...
Cohesion: 0.19
Nodes (14): CancellationToken, IClock, IEventStore, Task, CaptureMeasurementHandler, DateTimeOffset, Fact, FakeEventStore (+6 more)

### Community 32 - ".SeedEntryWithTwoFlightsAsync"
Cohesion: 0.13
Nodes (19): CancellationToken, IClock, IEventStore, Task, CorrectInstrumentDeclarationHandler, CancellationToken, IClock, IEventStore (+11 more)
...
### Community 55 - ".Of"
Cohesion: 0.09
Nodes (17): Bindings, ClassDef, ExpectedRawScore, AllOf, Children, Predicate, ResolvedTask, ResolvedTiming (+9 more)
...
Cohesion: 0.16
Nodes (13): IServiceCollection, CancellationToken, IDocumentSessionFactory, IReadOnlyList, Task, DocumentPeopleQuery, IConfiguration, IDocumentSessionFactory (+5 more)
...
Cohesion: 0.17
Nodes (17): CancellationToken, IClock, IEventStore, Task, GrantRoleHandler, CancellationToken, IClock, IEventStore (+9 more)

### Community 63 - ".AuthorizeAsync"
Cohesion: 0.18
Nodes (12): ICommandPolicy, ContactDetailsPolicy, AuthzOutcome, CancellationToken, ICurrentUser, IServiceProvider, Task, OrganiserPolicy (+4 more)
...
Cohesion: 0.05
Nodes (53): TaskDefinition, Code, Flights, FlightValidWhen, Group, Metrics, Name, Normalise (+45 more)
...
Cohesion: 0.10
Nodes (29): CancellationToken, IClock, IEventStore, Task, AssignScoringTeamMembershipHandler, CancellationToken, Task, CancellationToken (+21 more)

### Community 78 - "BestNFlights"
Cohesion: 0.12
Nodes (18): TargetAssignment, AnyOrder, InOrder, None, ImmutableArray, BestNFlights, Count, RankByMetric (+10 more)

### Community 79 - "LookupRow"
Cohesion: 0.09
Nodes (20): Rows, LookupRow, Builder, ImmutableArray, Rows, ImmutableArray, SeedF5J, Definition (+12 more)
...
### Community 83 - "AcceptanceFixture"
Cohesion: 0.16
Nodes (12): BeforeTestRun, AfterTestRun, HttpClient, PostgreSqlContainer, SemaphoreSlim, ServiceProvider, Task, WebApplicationFactory (+4 more)
...
Cohesion: 0.22
Nodes (14): CancellationToken, IReadOnlyList, Task, FindEntries, FindEntriesHandler, CancellationToken, IReadOnlyList, Task (+6 more)

### Community 94 - "FakeCurrentUser"
Cohesion: 0.24
Nodes (14): AuthzOutcome, CancellationToken, ICurrentUser, IServiceProvider, Task, Fact, IServiceProvider, PersonId (+6 more)
...
Cohesion: 0.19
Nodes (12): Guid, IFormatProvider, ScoringTeamId, ScoringTeamMembership, CompetitorRef, TeamRef, TeamClassificationConfiguration, Enabled (+4 more)
...
### Community 109 - "Soarscore.Application.Commands.Competitions"
Cohesion: 0.16
Nodes (12): Soarscore.Infrastructure.Tests, Soarscore.Application.Commands.Competitions, Soarscore.Application.Commands.Entries, Soarscore.Application.Commands.People, Soarscore.Api.Commands, Soarscore.Acceptance.Tests.Support, Soarscore.Infrastructure, Soarscore.Application.Queries.Competitions (+4 more)
...
### Community 124 - "ScoringTeam"
Cohesion: 0.21
Nodes (9): ProtectionGroupMembership, CompetitorRef, ScoringTeam, Id, Name, ArgumentException, DateTimeOffset, Fact (+1 more)
...
Cohesion: 0.09
Nodes (27): PeopleProjection, IdentityLink, DateTimeOffset, ClubAffiliationChanged, ContactDetailsChanged, IdentityLinked, PersonEvent, PersonRegistered (+19 more)
...
Cohesion: 0.13
Nodes (29): Provider, IReadOnlyList, AuthBootstrap, LinkSignIn, CancellationToken, IReadOnlyList, Task, FindPeople (+21 more)
...
Cohesion: 0.09
Nodes (32): IQuery, IReadOnlyList, WebApplication, Queries, CancellationToken, Entry, IEventStore, ImmutableArray (+24 more)
...
Cohesion: 0.05
Nodes (57): IJasperFxProjection, IProjection, PersonIdentityProjection, CancellationToken, IDocumentOperations, IDocumentSession, IEvent, IReadOnlyList (+49 more)

### Community 140 - ".New"
Cohesion: 0.08
Nodes (26): Competition, DateOnly, CompetitionCreated, DrawAccepted, Competition, Dictionary, Entries, Entry (+18 more)
...
### Community 155 - ".WhenTheHarnessReplaysTheGliderScoreFixture"
Cohesion: 0.17
...
Cohesion: 0.05
Nodes (53): ResolvedSchedule, Round, DateOnly, DateTimeOffset, Defect, Func, IEnumerable, ImmutableArray (+45 more)
...
Cohesion: 0.11
Nodes (25): IClock, IEventStore, PersonIdentityMatch, IDomainEvent, Guid, IReadOnlyList, DateTimeOffset, FakeClock (+17 more)
...
### Community 180 - "AuthorizationPipeline"
Cohesion: 0.24
...
### Community 196 - "TeamsEventJsonTests"
Cohesion: 0.27
...
### Community 200 - "Entry"
Cohesion: 0.05
Nodes (48): DateTimeOffset, Defect, Func, ImmutableArray, Penalty, PenaltyRecorded, Result, Annulment (+40 more)
...
### Community 217 - "PrescribeDrawDecideTests"
Cohesion: 0.05
Nodes (49): CountLetters, Echo, CancellationToken, Task, Type, ICommand, IDispatcher, IQuery (+41 more)

### Community 218 - ".TwoRoundCompetitionAsync"
Cohesion: 0.21
...
Cohesion: 0.10
Nodes (29): Competitors, Competition, DateTimeOffset, Fact, FakeEventStore, Group, GroupRef, ImmutableArray (+21 more)
...
Cohesion: 0.14
Nodes (17): DeclaredInstrument, Instrument, Metric, Scale, ConstantTerm, Value, ImmutableArray, IReadOnlyDictionary (+9 more)
...
### Community 272 - "AdoptedRules"
Cohesion: 0.14
Nodes (17): CancellationToken, IClock, IEventStore, Task, WithdrawCompetitorHandler, AdoptedRules, AdoptedAt, Definition (+9 more)
...
### Community 285 - "SeeingWhatIsRecordedSteps"
Cohesion: 0.06
Nodes (46): GenEntry, GenFlight, Noise, PlacedEntry, Shape, Competition, Entry, Group (+38 more)
...
### Community 312 - "ComposedReadingScale"
Cohesion: 0.32
...
Cohesion: 0.18
Nodes (9): Action, CompetitionProjection, CapturePolicyConfigured, Fact, Fact, CompetitionProjectionTests, DateTimeOffset, Fact (+1 more)
...
### Community 338 - ".SeedOpenEntryWithFlight"
Cohesion: 0.28
Nodes (5): DateTimeOffset, FakeEventStore, ImmutableArray, Store, TapeCaptureHandlerTests
...
Cohesion: 0.06
Nodes (50): FakeServiceProvider, IServiceProvider, AuthzOutcome, CancellationToken, ICurrentUser, IServiceProvider, Task, CapturePolicyPolicy (+42 more)
...
Cohesion: 0.06
Nodes (56): CancellationToken, IClock, IEventStore, Task, DrawPhaseHandler, CancellationToken, IEventStore, Task (+48 more)
...
### Community 357 - ".SeedFinalisableTeamCompetition"
Cohesion: 0.33
Nodes (5): EntryQuery, FakeEventStore, ImmutableArray, Store, TeamId
...
Cohesion: 0.04
Nodes (56): closure, ClosureKind, ImmutableArray, PhaseDefinition, Drops, Ordinal, Promotion, Rounds (+48 more)
...
### Community 368 - ".SeedOpenEntryWithFlight"
Cohesion: 0.17
...
### Community 383 - "SeedF3B"
Cohesion: 0.40
Nodes (5): SeedF3B, Definition, TaskA, TaskB, TaskC

### Community 384 - "SeedNzMAles200"
Cohesion: 0.50
...
Cohesion: 0.05
Nodes (51): CancellationToken, IClock, IEventStore, Task, OpenFlightHandler, CancellationToken, Guid, IReadOnlyList (+43 more)

### Community 389 - "PostgresFixture"
Cohesion: 0.03
Nodes (60): IAsyncLifetime, PostgresAuthenticationEventStoreTests, SqliteAuthenticationEventStoreTests, PostgresBindParameterEventStoreTests, SqliteBindParameterEventStoreTests, PostgresCatalogueDrawEventStoreTests, SqliteCatalogueDrawEventStoreTests, PostgresCompetitorEventStoreTests (+52 more)

### Community 390 - "SeedNzMNdc"
Cohesion: 0.50
...
### Community 398 - ".ResolveAndInterpret"
Cohesion: 0.13
Nodes (16): ISet, ImmutableArray, IReadOnlyDictionary, IReadOnlySet, FlightMetricResolution, IReadOnlyDictionary, FlightResult, FlightResultState (+8 more)
...
### Community 408 - "PhaseType"
Cohesion: 0.67
Nodes (3): PhaseType, Flyoff, Preliminary
...
Cohesion: 0.07
Nodes (10): Soarscore.Application.Tests.Commands.CompetitionClasses, Soarscore.Application.Tests.Seeding, Soarscore.Application.Queries.CompetitionClasses, Soarscore.Api.Queries, Soarscore.Application.Tests.Shared.CompetitionClasses, Soarscore.Application.Shared.CompetitionClasses, Soarscore.Api.Routing, Soarscore.Application.Tests.Queries.CompetitionClasses (+2 more)

### Community 482 - "CompetitionModelBasedFoldTests"
Cohesion: 0.20
...
## Knowledge Gaps
- **2680 isolated node(s):** `context7`, `rider`, `$schema`, `.opencode/plugins/graphify.js`, `None` (+2675 more)
...
- **Why does `ClassDefinition` connect `ClassDefinition` to `FlightOpened`, `Competition.cs`, `ReflightingForAMissedRoundSteps`, `.InterpretAllFlights`, `CompetitorId`, `.Exact`, `PersonId`, `.New`, `Then`, `CompetitionId`, `.CheckLimits`, `TapeLandingScaleProofTests`, `MeasuredValue`, `RecordCompetitionPenaltyDecideTests`, `ClosingACompetitionSteps`, `.New`, `CaptureMeasurement`, `.SeedEntryWithTwoFlightsAsync`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `ScoringACompetitionSteps`, `PenaltyDefinition`, `FakeEntryQuery`, `.BuildDrawnCompetition`, `RecordingAReflightRulingSteps`, `ScoringTeamsSteps`, `.Of`, `.SeedAsync`, `LandingTapeDeclaredScaleSteps`, `TaskDefinition`, `.CompetitionAdopting`, `.LoadAsync`, `LookupRow`, `IStoreFixture`, `.Validate`, `DrawAcceptanceDecideTests`, `GliderscoreFixture`, `PublishClassDefinition`, `ScoringTeam`, `PrescribeDrawPropertyTests`, `.BuildDrawnCompetition`, `.MapQueries`, `.New`, `.SetUpAsync`, `FinaliseDecideTests`, `.DefinitionWith`, `RecordEntryPenaltyDecideTests`, `.DrawnCompetitionAsync`, `SeedF3K`, `.BuildCompetition`, `.DrawnCompetitionAsync`, `ClassDefinitionValidationPropertyTests`, `SeedF5kNdc`, `PrescribeDrawDecideTests`, `.TwoRoundCompetitionAsync`, `CompetitionReplaceTaskRoundPropertyTests`, `.ScoreCompetition`, `.BuildDrawnCompetition`, `.All_seven_team_events_round_trip_through_the_real_store_and_replay_to_the_expected_state`, `FakeEventStore`, `GroupSpotsPropertyTests`, `.HandleAsync`, `.SeedDrawnCompetitionAsync`, `DeclaredInstrument`, `AdoptedRules`, `CapturePolicyFoldTests`, `.BuildCompetition`, `SeeingWhatIsRecordedSteps`, `CompetitionResult`, `.BuildDrawnCompetition`, `BindParameterDecideTests`, `.DefinitionWith`, `Corpus.cs`, `.CompareAsync`, `CapturePolicyConfigured`, `CompetitionEvent`, `.Load`, `.SeedOpenEntryWithFlight`, `CompetitionDecidePropertyTests`, `ScoringServicePropertyTests`, `SystemClock`, `SeedF3J`, `ClassDefinitionPublished`, `PhaseDefinition`, `.SeedOpenEntryWithFlight`, `SeedF3B`, `SeedNzMAles200`, `.DrawnCompetitionAsync`, `Result`, `SeedNzMNdc`, `PublishedClassDefinition`, `SeedF5K`, `.Load`, `ClassDefinitionProjectionPropertyTests`, `.SampleCompetition`, `CreateCompetitionPropertyTests`, `SeedingTheClassCatalogueSteps`, `CompetitionModelBasedFoldTests`?**
  _High betweenness centrality (0.120) - this node is a cross-community bridge._
- **Why does `CompetitorId` connect `CompetitorId` to `FlightOpened`, `Competition.cs`, `ReflightingForAMissedRoundSteps`, `PersonId`, `.SeedWired`, `F5JChristchurchTapeReadingExamplesTests`, `.New`, `Then`, `CompetitionId`, `ResolvingATieBreakSteps`, `EntryCapturePropertyTests`, `RecordCompetitionPenaltyDecideTests`, `ClosingACompetitionSteps`, `.New`, `IEventStore`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `ScoringACompetitionSteps`, `AmendMeasurementDecideTests`, `FakeEventStore`, `FakeEntryQuery`, `.BuildDrawnCompetition`, `RecordingAReflightRulingSteps`, `ScoringTeamsSteps`, `LandingTapeDeclaredScaleSteps`, `DrawProtectionPropertyTests`, `PrescribingADrawSteps`, `TeamsDecideTests`, `.LoadAsync`, `IStoreFixture`, `IEntryQuery`, `DrawAcceptanceDecideTests`, `GliderscoreFixture`, `TeamClassificationPropertyTests`, `ScoringTeamId`, `ProtectedPair`, `ScoringTeam`, `PrescribeDrawPropertyTests`, `.BuildDrawnCompetition`, `.MapQueries`, `.New`, `.SetUpAsync`, `.DefinitionWith`, `RecordEntryPenaltyDecideTests`, `Competition`, `CaptureMeasurementDecideTests`, `.DrawnCompetitionAsync`, `.BuildCompetition`, `.DrawnCompetitionAsync`, `Entry`, `PrescribeDrawDecideTests`, `.TwoRoundCompetitionAsync`, `.ScoreCompetition`, `.BuildDrawnCompetition`, `FakeEventStore`, `GroupSpotsPropertyTests`, `AssigningSpotsSteps`, `.SeedDrawnCompetitionAsync`, `.BuildDrawnCompetition`, `AdoptedRules`, `TapeAmendmentDecideTests`, `.ComputeEntries`, `.BuildGroups`, `.BuildCompetition`, `SeeingWhatIsRecordedSteps`, `PhaseDrawPropertyTests`, `.BuildDrawnCompetition`, `.Classify`, `.DefinitionWith`, `RecordingAGliderscoreFixtureSteps`, `GetCompetitionEventLogHandlerTests`, `CompetitionEvent`, `ScoringServicePropertyTests`, `SystemClock`, `.SeedFinalisableTeamCompetition`, `PhaseDefinition`, `.DrawnCompetitionAsync`, `CapturePolicyState`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `CompetitionId` connect `CompetitionId` to `FlightOpened`, `Competition.cs`, `.SeedDrawnCompetitionAsync`, `Result`, `.DrawnCompetitionAsync`, `.MapQueries`, `IProjection`, `.SeedWired`, `.New`, `PersonId`, `AdoptedRules`, `.SetUpAsync`, `.New`, `ResolvingATieBreakSteps`, `TapeAmendmentDecideTests`, `RecordEntryPenaltyDecideTests`, `EntryCapturePropertyTests`, `CaptureMeasurement`, `.SeedEntryWithTwoFlightsAsync`, `IEventStore`, `Competition`, `FakeEventStore`, `AmendMeasurementDecideTests`, `CaptureMeasurementDecideTests`, `.Decide`, `.DrawnCompetitionAsync`, `FakeEntryQuery`, `GetCompetitionEventLogHandlerTests`, `.DrawnCompetitionAsync`, `Entry`, `.LoadAsync`, `.SeedOpenEntryWithFlight`, `IStoreFixture`, `.SeedCompetition`, `CompetitionSummary`, `PrescribeDrawDecideTests`, `.TwoRoundCompetitionAsync`, `IEntryQuery`, `SystemClock`, `GliderscoreFixture`, `.SeedFinalisableTeamCompetition`, `PublishClassDefinition`, `.SeedOpenEntryWithFlight`, `FakeEventStore`, `ProtectedPair`, `.HandleAsync`?**
...
- **Should `Soarscore.Domain.PublishedClassDefinition` be split into smaller, more focused modules?**
  _Cohesion score 0.04007567939456484 - nodes in this community are weakly interconnected._
- **Should `Competition.cs` be split into smaller, more focused modules?**
