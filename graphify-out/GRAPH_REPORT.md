...
## Corpus Check
- 478 files · ~722,553 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6402 nodes · 16616 edges · 340 communities (327 shown, 13 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1810 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1218d9a0`
...
## Communities (340 total, 13 thin omitted)

### Community 0 - ".ScoreCompetition"
Cohesion: 0.29
Nodes (9): Result, TaskRoundCoordinate, Competitors, DateTimeOffset, Dictionary, Fact, Group, ImmutableArray (+1 more)

### Community 1 - "Soarscore.Domain.PublishedClassDefinition"
Cohesion: 0.06
Nodes (15): Soarscore.Domain.Scoring, Soarscore.Domain.Tests, Soarscore.Domain.Competitions, Soarscore.Domain.People, Soarscore.Application.Tests.Queries.Competitions, Soarscore.Application.Tests.Shared.Competitions, Soarscore.SeedData, Soarscore.Domain.Entries (+7 more)
...
Cohesion: 0.09
Nodes (41): CancellationToken, IClock, IEventStore, Task, BindParameterHandler, CancellationToken, IClock, IEventStore (+33 more)
...
Cohesion: 0.10
Nodes (38): Path, test_fetch_comp_touches_network_only_through_the_kernel(), _action_candidates(), _audit_plans(), check_common_audit_fields(), exact_sleep_factory(), execute_op(), FakeClock (+30 more)
...
Cohesion: 0.22
Nodes (6): IReadOnlyList, JsonSerializerOptions, List, ClassDefinitionIngestion, Fact, ClassDefinitionIngestionTests
...
### Community 11 - ".Of"
Cohesion: 0.15
Nodes (8): Rounding, Fact, InlineData, Theory, BindParameterDecideTests, Fact, ImmutableArray, CaptureMeasurementDecideTests
...
Cohesion: 0.05
Nodes (61): aggregate, dropped, minRounds, minTasks, outcomes, RoundOutcome, DropPolicy, ApplyWhenResultsAtLeast (+53 more)

### Community 14 - ".New"
Cohesion: 0.15
Nodes (9): ArgumentException, Competition, DateTimeOffset, Fact, CompetitionFoldTests, Fact, InlineData, Theory (+1 more)

### Community 15 - "CompetitionId"
Cohesion: 0.06
Nodes (60): ICommand, IHttpMaxRequestBodySizeFeature, WebApplication, IReadOnlyList, WebApplication, CancellationToken, IClock, IEventStore (+52 more)

### Community 16 - "PostgresFixture"
Cohesion: 0.04
Nodes (53): IAsyncLifetime, ICompetitionsQuery, IDocumentSessionFactory, DocumentCompetitionsQuery, PostgresBindParameterEventStoreTests, SqliteBindParameterEventStoreTests, PostgresCatalogueDrawEventStoreTests, SqliteCatalogueDrawEventStoreTests (+45 more)
...
Cohesion: 0.11
Nodes (28): ICommandHandler, CancellationToken, IClock, IEventStore, ImmutableArray, Task, FinaliseCompetition, FinaliseCompetitionHandler (+20 more)
...
Cohesion: 0.33
Nodes (5): Bands, Literal, NumberOrParam, Band, Bands
...
Cohesion: 0.12
Nodes (22): Exception, Competition, TaskResolver, Parameter, AllowedValues, BoundAt, DefaultValue, Kind (+14 more)

### Community 24 - "Soarscore.Application.Commands.CompetitionClasses"
Cohesion: 0.08
Nodes (10): Soarscore.Application.Tests, Soarscore.Application.Tests.Commands.CompetitionClasses, Soarscore.Application.Tests.Shared.CompetitionClasses, Soarscore.Application.Shared.CompetitionClasses, Soarscore.Application.Commands.CompetitionClasses, Soarscore.Application.Tests.Queries.CompetitionClasses, Fact, ClassDefinitionHashingTests (+2 more)
...
Cohesion: 0.08
Nodes (22): DecideActual, DecideModel, FlagValue, FlightPlan, MetricIndex, NumericValue, Pick, PlannedCapture (+14 more)

### Community 27 - "DrawAcceptanceEventStoreTests"
Cohesion: 0.06
Nodes (47): CountLetters, Echo, IServiceProvider, CancellationToken, IServiceProvider, Task, Type, Dispatcher (+39 more)

### Community 28 - "ClosingACompetitionSteps"
Cohesion: 0.12
Nodes (14): Competition, ImmutableArray, CompetitionView, DateTimeOffset, Dictionary, Given, Group, HttpClient (+6 more)
...
Cohesion: 0.18
Nodes (20): IReadOnlyList, Dictionary, CompetitionFile, CompetitionIdentity, CompetitionScoring, CompPilotRow, CompPilotsTable, DurFamilyRow (+12 more)

### Community 31 - ".Exact"
Cohesion: 0.09
Nodes (35): CancellationToken, IClock, IEventStore, Task, DrawPhaseHandler, AdoptedRules, DateTimeOffset, Fact (+27 more)
...
Cohesion: 0.14
Nodes (21): KeyCollection, Competition, Dictionary, Entry, HashSet, HttpClient, IEnumerable, ImmutableArray (+13 more)

### Community 35 - "FlightOpened"
Cohesion: 0.17
Nodes (15): DateTimeOffset, Penalty, EntryAnnulled, EntryEvent, FlightOpened, MeasurementAmended, MeasurementCaptured, PenaltyRecorded (+7 more)
...
### Community 41 - "ScoreTerm"
Cohesion: 0.15
Nodes (18): FlightSelection, ScoreTerm, ImmutableArray, IReadOnlyDictionary, FlightSelector, IReadOnlyDictionary, FlightResult, FlightResultState (+10 more)
...
Cohesion: 0.17
Nodes (16): CancellationToken, IClock, IEventStore, Task, CaptureMeasurementHandler, CancellationToken, DateTimeOffset, Fact (+8 more)

### Community 48 - "Competition"
Cohesion: 0.09
Nodes (22): DateOnly, DateTimeOffset, Defect, Penalty, ReflightRuling, Result, TaskRoundCoordinate, Competition (+14 more)

### Community 49 - "ScoringVocabulary.cs"
Cohesion: 0.06
Nodes (40): Comparator, EqualTo, GreaterOrEqual, GreaterThan, LessOrEqual, LessThan, TargetAssignment, AnyOrder (+32 more)
...
Cohesion: 0.13
Nodes (23): CancellationToken, IEventStore, Task, RecordCompetitionPenalty, RecordCompetitionPenaltyHandler, Penalty, By, CompetitorRef (+15 more)

### Community 54 - "Soarscore.Application.Commands.Entries"
Cohesion: 0.15
Nodes (7): Soarscore.Application.Tests.Commands.Entries, Soarscore.Application.Commands.Entries, Soarscore.Acceptance.Tests.Support, Soarscore.Application.Tests.Queries.Entries, Soarscore.Application.Tests.Shared.Entries, Soarscore.Acceptance.Tests.Support.Gliderscore, Soarscore.Acceptance.Tests.Steps
...
### Community 59 - "MetricDefinition"
Cohesion: 0.05
Nodes (34): CompositionKind, ChooseFromCatalogue, FixedSequence, MeasuredKind, Flag, Number, ParameterBindingPoint, BeforeFlying (+26 more)
...
### Community 61 - "CompetitorId"
Cohesion: 0.10
Nodes (27): IParsable, DateOnly, CreateCompetition, CancellationToken, IClock, IEventStore, Task, RegisterCompetitorHandler (+19 more)
...
Cohesion: 0.17
Nodes (16): GroupNo, PilotNo, RoundNo, SlotCapture, IReadOnlyList, GliderscoreFixture, ScoresRawFile, ScoresRow (+8 more)
...
Cohesion: 0.12
Nodes (12): Soarscore.Application.Tests.Shared.People, Soarscore.Application.Tests.Queries.People, IClock, DateTimeOffset, FakeClock, UtcNow, DateTimeOffset, FakeClock (+4 more)

### Community 67 - "TaskResult"
Cohesion: 0.33
Nodes (8): PenaltyEffectSpec, ImmutableArray, PenaltyApplication, RecordedPenalty, SelectedFlights, TaskResult, Fact, PenaltyEngineTests

### Community 68 - ".Normalise"
Cohesion: 0.14
Nodes (18): NormalisationDirection, HigherIsBetter, LowerIsBetter, Normalisation, Direction, Round, WinnerScore, ImmutableDictionary (+10 more)

### Community 69 - ".Rank"
Cohesion: 0.20
Nodes (10): FinalRankingKind, LastPhaseReplaces, SinglePhase, SplitByPromotion, ImmutableArray, CompetitionResult, FinalCompetitorScore, Fact (+2 more)
...
### Community 77 - ".SeedEntryUnderF5K"
Cohesion: 0.18
...
Cohesion: 0.05
Nodes (49): IQuery, IReadOnlyList, WebApplication, Queries, CancellationToken, IEventStore, Task, GetClassDefinition (+41 more)
...
Cohesion: 0.16
Nodes (7): JsonElement, Given, Task, Then, When, HarnessSelfCheckSteps, DivergenceEntry
...
### Community 108 - "PrescribeDrawPropertyTests"
Cohesion: 0.17
...
Cohesion: 0.04
Nodes (44): closure, ClosureKind, fieldSize, Ref, TaskDefinition, Code, Flights, FlightValidWhen (+36 more)

### Community 122 - "PenaltyDefinition"
Cohesion: 0.11
Nodes (15): ImmutableArray, PenaltyDefinition, Accrual, Effects, ExclusionGroups, InfractionType, PenaltyAccrual, OncePerAttempt (+7 more)
...
Cohesion: 0.11
Nodes (19): Role, ReflightRule, EntitledScores, MinNewGroupSize, OthersScore, ReflightSelection, BetterOf, NotPermitted (+11 more)
...
Cohesion: 0.17
Nodes (10): IConfiguration, IServiceCollection, DocumentStore, MartenConfig, IDocumentSessionFactory, IDocumentStore, ServiceCollectionExtensions, SoarscoreStore (+2 more)

### Community 138 - ".Load"
Cohesion: 0.18
Nodes (7): Given, Task, When, IReadOnlyList, JsonSerializerOptions, List, FixtureLoader
...
### Community 140 - "RegisterCompetitorPropertyTests"
Cohesion: 0.24
...
Cohesion: 0.36
Nodes (3): Then, ReplaySteps, Fixture
...
Cohesion: 0.12
Nodes (15): Adding a fixture, Differential gate result, GliderScore fixture extraction, How the corpus is consumed, Index contract (rule 5), Offline-only rule, Output shape contract, Pinned access_parser version (+7 more)
...
### Community 170 - "ReflightRuling"
Cohesion: 0.25
Nodes (8): DateTimeOffset, ReflightRuling, At, By, CompetitorRef, Reason, Selection, TaskRound
...
### Community 174 - "IDomainEvent"
Cohesion: 0.15
Nodes (18): IEventStore, IDomainEvent, CancellationToken, Guid, IReadOnlyDictionary, IReadOnlyList, List, Task (+10 more)
...
### Community 178 - "PublishedClassDefinition"
Cohesion: 0.14
...
### Community 212 - ".New"
Cohesion: 0.09
Nodes (23): Id, Competition, DateOnly, CompetitionCreated, Competition, Dictionary, Entries, Entry (+15 more)
...
### Community 223 - "IProjection"
Cohesion: 0.27
Nodes (8): IProjection, IDocumentOperations, IDocumentSession, ClassDefinitionSummaryProjection, FisherClassDefinitionSummaryProjection, MartenClassDefinitionSummaryProjection, DocumentStore, FisherConfig
...
### Community 231 - "Competition.cs"
Cohesion: 0.08
Nodes (25): Competitor, CompetitorNumber, Id, PersonRef, RegisteredAt, WithdrawnAt, Finalisation, At (+17 more)
...
### Community 234 - ".New"
Cohesion: 0.10
Nodes (17): AdoptedRules, AdoptedAt, Definition, SourceClassId, SourceVersion, DateOnly, Fact, Gen (+9 more)
...
### Community 237 - ".ShapePermits"
Cohesion: 0.25
Nodes (5): Entry, IReadOnlyList, ReflightSelector, InlineData, Theory
...
### Community 241 - "F5J — RC Electric Powered Thermal Duration Gliders"
Cohesion: 0.25
...
### Community 246 - ".BuildDrawnCompetition"
Cohesion: 0.25
...
### Community 251 - "F3K — RC Hand-Launch Gliders"
Cohesion: 0.18
...
### Community 252 - ".ApplyRounding"
Cohesion: 0.24
Nodes (5): Annulment, At, By, Reason, RoundingSupport

### Community 253 - ".Apply"
Cohesion: 0.40
Nodes (4): EntryProjection, DateTimeOffset, Fact, EntryProjectionTests

### Community 254 - "FlagOrParam"
Cohesion: 0.19
Nodes (10): JsonSerializerOptions, ClassDefinitionHashing, Type, FlagOrParam, Ref, JsonSerializerOptions, Utf8JsonReader, Utf8JsonWriter (+2 more)

### Community 255 - "A.6 BUREAU"
Cohesion: 0.29
...
### Community 259 - ".SeedOpenEntryWithFlight"
Cohesion: 0.23
...
### Community 272 - "DecideFlightModel"
Cohesion: 0.32
...
Cohesion: 0.09
Nodes (30): CancellationToken, Guid, IReadOnlyList, Task, IEventStore, RecordedEvent, IReadOnlyList, Result (+22 more)
...
### Community 277 - "DecimalAsStringConverter"
Cohesion: 0.31
...
### Community 282 - "DocumentClassLibraryQuery"
Cohesion: 0.32
...
### Community 286 - "Story — Entry-scoped point-deduction penalties are inert"
Cohesion: 0.40
Nodes (4): Before starting, Story — Entry-scoped point-deduction penalties are inert, What, Why it matters

### Community 287 - "IClock"
Cohesion: 0.29
...
### Community 298 - "Story — Expose the pre-normalisation score over HTTP"
Cohesion: 0.40
Nodes (4): Before starting, Story — Expose the pre-normalisation score over HTTP, What, Why it matters
...
### Community 321 - ".SearchAsync"
Cohesion: 0.40
Nodes (4): CancellationToken, DateOnly, IReadOnlyList, Task

### Community 323 - "Amendment"
Cohesion: 0.25
...
### Community 327 - "RankingEnginePropertyTests"
Cohesion: 0.40
Nodes (4): Disqualified, Gen, Score, RankingEnginePropertyTests

### Community 328 - "Soarscore.Application"
Cohesion: 0.10
Nodes (19): Soarscore.Infrastructure.Competitions, Soarscore.Infrastructure.Tests, Soarscore.Infrastructure.CompetitionClasses, Soarscore.Infrastructure.People, Soarscore.Application.Commands.People, Soarscore.Application.Queries.People, Soarscore.Api.Commands, Soarscore.Infrastructure (+11 more)
...
### Community 336 - "SeedF3B"
Cohesion: 0.40
Nodes (5): SeedF3B, Definition, TaskA, TaskB, TaskC

### Community 343 - "SeedF3F"
Cohesion: 0.67
Nodes (3): SeedF3F, Definition, TaskS

### Community 344 - "SeedNzNAles123"
Cohesion: 0.67
Nodes (3): SeedNzNAles123, Definition, TaskD

### Community 345 - "SeedNzPRadian"
Cohesion: 0.67
Nodes (3): SeedNzPRadian, Definition, TaskD

## Knowledge Gaps
- **1841 isolated node(s):** `context7`, `rider`, `$schema`, `.opencode/plugins/graphify.js`, `$(SoarscoreTargetFramework)` (+1836 more)
...
- **Why does `ClassDefinition` connect `ClassDefinition` to `.ScoreCompetition`, `.BuildCompetitionWithPenalties`, `FakeEntryQuery`, `SeedF5K`, `CatalogueDrawPropertyTests`, `.CheckLimits`, `ResolvedTask`, `.Of`, `PrescribeDrawDecideTests`, `PhaseDefinition`, `.New`, `CompetitionId`, `Then`, `ICommandHandler`, `PhaseDrawn`, `MeasuredValue`, `DrawAcceptanceEventStoreTests`, `ClosingACompetitionSteps`, `.New`, `.Exact`, `FlightOpened`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `ScoringACompetitionSteps`, `SystemClock`, `.SeedOpenEntryWithFlight`, `When`, `.SeedCompetition`, `FinaliseDecideTests`, `.SeedOpenEntry`, `MetricDefinition`, `CompetitorId`, `GliderscoreFixture`, `.Rank`, `.SetUpAsync`, `.CompetitionAdopting`, `.SeedEntryUnderF5K`, `.BuildDrawnCompetition`, `.BuildDrawnCompetition`, `.LoadAsync`, `.BuildDispatcher`, `.Validate`, `.DrawnCompetitionAsync`, `DrawAcceptanceDecideTests`, `SeedF3K`, `CompetitionReplaceTaskRoundPropertyTests`, `PublishClassDefinition`, `PrescribeDrawPropertyTests`, `.SeedCompetition`, `CompetitionFieldPropertyTests`, `TaskDefinition`, `PenaltyDefinition`, `ReflightRule`, `SeeingWhatIsRecordedSteps`, `WithdrawCompetitorHandler`, `ClassDefinitionPublished`, `.Load`, `RegisterCompetitorPropertyTests`, `.BaseDefinition`, `EntryModelBasedFoldTests`, `.SeedCompetition`, `PublishedClassDefinition`, `.ScoreGroup`, `ClassDefinitionValidationPropertyTests`, `.Apply`, `.New`, `IStoreFixture`, `Competition.cs`, `.New`, `.BuildDrawnCompetition`, `SeedF3J`, `.SeedOpenEntryWithFlight`, `SeedF5J`, `.DrawnCompetitionAsync`, `ClassDefinitionEventJsonTests`, `Corpus.cs`, `CreateCompetitionPropertyTests`, `SeedF3B`, `SeedF3F`, `SeedNzNAles123`, `SeedNzPRadian`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `CompetitorId` connect `CompetitorId` to `.ScoreCompetition`, `SeeingWhatIsRecordedSteps`, `.BuildCompetitionWithPenalties`, `FakeEntryQuery`, `WithdrawCompetitorHandler`, `CatalogueDrawPropertyTests`, `.Of`, `PrescribeDrawDecideTests`, `CompetitionId`, `Then`, `ICommandHandler`, `PhaseDrawn`, `.DrawnCompetitionAsync`, `EntryCapturePropertyTests`, `DrawAcceptanceEventStoreTests`, `ClosingACompetitionSteps`, `.New`, `.Exact`, `Entry`, `.CompareRawGrainAsync`, `AnnulEntryDecideTests`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `ScoringACompetitionSteps`, `AmendMeasurementDecideTests`, `FlightOpened`, `OpenFlightDecideTests`, `ReflightRuling`, `SystemClock`, `TaskRoundRecordingPropertyTests`, `Competition`, `When`, `.SeedCompetition`, `FinaliseDecideTests`, `TaskRound`, `.SetUpAsync`, `.BuildDrawnCompetition`, `.BuildDrawnCompetition`, `.ComputeEntries`, `.LoadAsync`, `FakeEventStore`, `.New`, `IStoreFixture`, `.DrawnCompetitionAsync`, `DrawAcceptanceDecideTests`, `Competition.cs`, `.New`, `PrescribeDrawPropertyTests`, `.SeedCompetition`, `.BuildDrawnCompetition`, `ReflightRule`, `RecordEntryPenaltyDecideTests`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `CompetitionId` connect `CompetitionId` to `.LoadCurrentAsync`, `SeeingWhatIsRecordedSteps`, `FakeEntryQuery`, `.SeedOpenEntryWithFlight`, `WithdrawCompetitorHandler`, `DrawingACatalogueChoicePhaseSteps`, `PrescribeDrawDecideTests`, `RegisterCompetitorPropertyTests`, `.Of`, `Then`, `ICommandHandler`, `.DrawnCompetitionAsync`, `CompetitionSummary`, `EntryCapturePropertyTests`, `DrawAcceptanceEventStoreTests`, `ClosingACompetitionSteps`, `.Exact`, `Entry`, `.SeedCompetition`, `.CompareRawGrainAsync`, `AnnulEntryDecideTests`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `ScoringACompetitionSteps`, `AmendMeasurementDecideTests`, `SystemClock`, `FlightOpened`, `OpenFlightDecideTests`, `.SeedOpenEntryWithFlight`, `Competition`, `When`, `.SeedCompetition`, `.SeedOpenEntry`, `CompetitorId`, `.SetUpAsync`, `FakeEventStore`, `.LoadAsync`, `.New`, `IStoreFixture`, `.DrawnCompetitionAsync`, `Competition.cs`, `.New`, `PublishClassDefinition`, `RecordEntryPenaltyDecideTests`?**
...
- **Should `Soarscore.Domain.PublishedClassDefinition` be split into smaller, more focused modules?**
  _Cohesion score 0.0647010647010647 - nodes in this community are weakly interconnected._
- **Should `FakeEntryQuery` be split into smaller, more focused modules?**
  _Cohesion score 0.0889240506329114 - nodes in this community are weakly interconnected._
- **Should `SeedF5K` be split into smaller, more focused modules?**
