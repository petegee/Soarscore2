...
## Corpus Check
- 581 files · ~1,006,153 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6897 nodes · 18151 edges · 318 communities (307 shown, 11 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1956 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e4779746`
...
3. `ClassDefinition` - 186 edges
4. `Soarscore.Domain.PublishedClassDefinition` - 176 edges
5. `Competition` - 152 edges
6. `Soarscore.Domain.Competitions` - 139 edges
7. `Result` - 119 edges
8. `EntryId` - 104 edges
9. `Soarscore.Domain.People` - 97 edges
10. `Soarscore.SeedData` - 94 edges
...
## Communities (318 total, 11 thin omitted)
...
Cohesion: 0.07
Nodes (53): CancellationToken, IClock, IEventStore, Task, BindParameterHandler, CancellationToken, IClock, IEventStore (+45 more)
...
Cohesion: 0.12
Nodes (28): IClassFixture, CancellationToken, IEventStore, ImmutableArray, Task, CompetitionView, GetCompetition, GetCompetitionHandler (+20 more)
...
Cohesion: 0.11
Nodes (8): Soarscore.Application.Tests.Commands.Entries, Soarscore.Application.Shared.Entries, Soarscore.Application.Commands.Competitions, Soarscore.Application.Commands.Entries, Soarscore.Application.Queries.Entries, Soarscore.Domain, Soarscore.Application.Tests.Shared.Entries, Soarscore.Application.Shared.Competitions
...
### Community 11 - "ReflightDestinationTests"
Cohesion: 0.32
Nodes (5): DateTimeOffset, Dictionary, Fact, Result, ReflightDestinationTests

### Community 12 - "PrescribeDrawDecideTests"
Cohesion: 0.07
Nodes (28): Mutation, IReadOnlyList, PrescribedGroup, PrescribedRound, Given, HttpClient, HttpResponseMessage, IEnumerable (+20 more)

### Community 13 - "DropPolicy"
Cohesion: 0.12
Nodes (27): aggregate, dropped, DropPolicy, ApplyWhenResultsAtLeast, ApplyWhenRoundsCompletedAtLeast, Dimension, DropCount, ImmutableArray (+19 more)

### Community 14 - ".New"
Cohesion: 0.07
Nodes (36): Id, DateOnly, CompetitionCreated, DrawAccepted, Dictionary, Entries, Store, Entry (+28 more)

### Community 15 - "Person"
Cohesion: 0.08
Nodes (33): CancellationToken, IClock, IEventStore, Task, RenamePerson, RenamePersonHandler, CancellationToken, IEventStore (+25 more)

### Community 16 - "FlightSelectorTests"
Cohesion: 0.11
Nodes (15): Bindings, ClassDef, ExpectedRawScore, CapScope, RateTerm, Cap, CapScope, Rate (+7 more)
...
Cohesion: 0.07
Nodes (40): ParameterBinding, At, BoundValue, By, ParameterName, PhaseOrdinal, RoundOrdinal, RulesAmendment (+32 more)
...
Cohesion: 0.09
Nodes (21): CountsFor, ImmutableArray, IReadOnlyDictionary, EntryGapsView, FlightGapsView, GroupRecordingView, RecordingCore, GroupId (+13 more)
...
Cohesion: 0.13
Nodes (21): Parameter, AllowedValues, BoundAt, DefaultValue, Kind, Name, Unit, MeasuredKind (+13 more)
...
### Community 27 - "Soarscore.Application.Commands.People"
Cohesion: 0.14
Nodes (7): Soarscore.Application.Shared.People, Soarscore.Application.Commands.People, Soarscore.Acceptance.Tests.Support, Soarscore.Application.Queries.Scoring, Soarscore.Acceptance.Tests.Support.Gliderscore, Soarscore.Acceptance.Tests.Steps, Soarscore.Application.Tests.Queries.Scoring
...
Cohesion: 0.04
Nodes (57): ResolvedSchedule, Round, Group, DateOnly, DateTimeOffset, Defect, Func, ImmutableArray (+49 more)
...
Cohesion: 0.16
Nodes (18): GroupNo, KeyCollection, PilotNo, RoundNo, Dictionary, HashSet, HttpClient, IEnumerable (+10 more)

### Community 35 - "FlightOpened"
Cohesion: 0.15
Nodes (16): Penalty, EntryAnnulled, EntryEvent, FlightOpened, MeasurementAmended, MeasurementCaptured, PenaltyRecorded, DateTimeOffset (+8 more)
...
### Community 40 - ".Exact"
Cohesion: 0.08
Nodes (34): IsBogus, CancellationToken, IClock, IEventStore, Task, DrawPhaseHandler, AdoptedRules, DateTimeOffset (+26 more)

### Community 41 - ".Of"
Cohesion: 0.20
Nodes (5): ResolvedTask, ResolvedTiming, ArgumentException, Fact, FlightInterpreterTests
...
Cohesion: 0.05
Nodes (57): AccruedInfo, PenaltyDefinition, Accrual, Effects, ExclusionGroups, PenaltyEffectSpec, NormalisationDirection, PenaltyAccrual (+49 more)
...
Cohesion: 0.32
Nodes (6): DateTimeOffset, Fact, FakeEventStore, Store, Task, CaptureMeasurementHandlerTests
...
### Community 59 - "Soarscore.Application.Queries.People"
Cohesion: 0.08
Nodes (16): Soarscore.Application.Tests.Shared.People, Soarscore.Application.Queries.People, Soarscore.Api.Queries, Soarscore.Application.Tests.Queries.People, Soarscore.Api.Routing, Soarscore.Application.Tests.Commands.People, IClock, DateTimeOffset (+8 more)
...
Cohesion: 0.16
Nodes (18): DateTimeOffset, ReflightRuling, At, By, CompetitorRef, Reason, Selection, TaskRound (+10 more)
...
### Community 77 - ".Build"
Cohesion: 0.05
Nodes (66): ICommand, IHttpMaxRequestBodySizeFeature, WebApplication, Commands, IReadOnlyList, WebApplication, Composition, CancellationToken (+58 more)
...
Cohesion: 0.11
Nodes (26): IQuery, IQueryHandler, IReadOnlyList, WebApplication, Queries, CancellationToken, IEventStore, Task (+18 more)
...
### Community 93 - "B.1.2 Classification of model aircraft"
Cohesion: 0.11
...
Cohesion: 0.15
Nodes (12): Comparator, DropDimension, PenaltyEffect, TargetAssignment, WorkingTimeKind, Comparison, LeftMetricRef, RightMetricRef (+4 more)
...
Cohesion: 0.12
Nodes (20): IEventStore, CancellationToken, IEventStore, Task, Version, EntryLoader, DateTimeOffset, Fact (+12 more)
...
Cohesion: 0.15
Nodes (12): EventKind, phaseCount, roundsPerPhase, targetPhase, targetTaskRound, taskRoundsPerRound, Gen, kind (+4 more)
...
### Community 107 - "PersonId"
Cohesion: 0.05
Nodes (50): Hash, CancellationToken, IClock, IEventStore, Task, PublishClassDefinition, PublishClassDefinitionHandler, CancellationToken (+42 more)
...
Cohesion: 0.14
Nodes (14): Competitor, CompetitorNumber, Id, PersonRef, RegisteredAt, WithdrawnAt, DateTimeOffset, Fact (+6 more)
...
Cohesion: 0.11
Nodes (18): DrawOp, FieldOp, Op, Gen, Index, CompetitionFieldPropertyTests, FieldOp, DateTimeOffset (+10 more)
...
Cohesion: 0.12
Nodes (17): RoundOrdinal, ReflightSelection, TaskCode, Competitors, DateTimeOffset, Fact, ImmutableArray, InlineData (+9 more)
...
Cohesion: 0.07
Nodes (11): Soarscore.Application.Tests, Soarscore.Application.Tests.Shared.Competitions, Soarscore.SeedData, Soarscore.Application.Tests.Commands.Competitions, JsonSerializerContext, Intrinsic, ImmutableArray, Corpus (+3 more)
...
### Community 135 - "ClassDefinitionRetired"
Cohesion: 0.23
Nodes (8): IDomainEvent, ClassDefinitionProjection, DateTimeOffset, ClassDefinitionEvent, ClassDefinitionRetired, ArgumentException, Fact, ClassDefinitionProjectionTests
...
Cohesion: 0.11
Nodes (16): IConfiguration, IServiceCollection, CancellationToken, IDocumentSessionFactory, IReadOnlyList, Task, DocumentEntryQuery, CancellationToken (+8 more)
...
Cohesion: 0.04
Nodes (48): TaskDefinition, Code, Flights, FlightValidWhen, Group, Metrics, Name, Normalise (+40 more)
...
Cohesion: 0.07
Nodes (29): closure, ClosureKind, fieldSize, ImmutableArray, PhaseDefinition, Drops, Ordinal, Promotion (+21 more)
...
### Community 168 - "ReflightSelectionPropertyTests"
Cohesion: 0.29
...
Cohesion: 0.10
Nodes (25): IParsable, Round2GroupRef, CancellationToken, IClock, IEventStore, Task, RegisterCompetitorHandler, CancellationToken (+17 more)
...
Cohesion: 0.09
Nodes (31): ImmutableArray, AllFlights, AllOf, Children, BestNFlights, Count, RankByMetric, Targets (+23 more)
...
Cohesion: 0.12
Nodes (16): minRounds, minTasks, outcomes, RoundOutcome, RoundComposition, Kind, MaxRounds, RequireDistinctTaskPerRound (+8 more)
...
Cohesion: 0.19
Nodes (13): CancellationToken, IClock, IEventStore, IReadOnlyList, Task, AppendReflightGroup, AppendReflightGroupHandler, CancellationToken (+5 more)

### Community 275 - "ClassDefinitionProjectionPropertyTests"
Cohesion: 0.67
Nodes (3): DateTimeOffset, Gen, ClassDefinitionProjectionPropertyTests

### Community 276 - "ReflightDestinationEventStoreTests.cs"
Cohesion: 0.47
...
### Community 287 - ".Rank"
Cohesion: 0.07
Nodes (43): Cells, Disq, IList, Position, Entry, PromotionRule, CarryPenalties, Kind (+35 more)
...
Cohesion: 0.04
Nodes (62): Soarscore.Infrastructure.Competitions, Soarscore.Infrastructure.Tests, Soarscore.Infrastructure.CompetitionClasses, Soarscore.Infrastructure.People, Soarscore.Application.Tests.Queries.Competitions, Soarscore.Api.Commands, Soarscore.Infrastructure, Soarscore.Application.Queries.Competitions (+54 more)

### Community 318 - "SeedF5J"
Cohesion: 0.12
Nodes (16): Builder, Rows, LookupRow, LookupTerm, MetricRef, Rows, ImmutableArray, Rows (+8 more)
...
### Community 331 - "IEventStore"
Cohesion: 0.09
Nodes (31): CancellationToken, Guid, IReadOnlyList, Task, ExpectedVersion, Any, IsAny, IsExact (+23 more)
...
## Knowledge Gaps
- **1990 isolated node(s):** `context7`, `rider`, `$schema`, `.opencode/plugins/graphify.js`, `$(SoarscoreTargetFramework)` (+1985 more)
...
- **Why does `ClassDefinition` connect `ClassDefinition` to `Soarscore.SeedData`, `FakeEntryQuery`, `ReflightingForAMissedRoundSteps`, `SystemClock`, `WithdrawCompetitorHandler`, `ClassDefinitionRetired`, `CatalogueDrawPropertyTests`, `.CheckLimits`, `PublishedClassDefinition`, `.BuildDispatcher`, `.New`, `PrescribeDrawDecideTests`, `FlightSelectorTests`, `EntryId`, `.DrawnCompetitionAsync`, `PhaseDrawn`, `ClassDefinitionProjectionPropertyTests`, `EntryModelBasedFoldTests`, `DrawAcceptanceEventStoreTests`, `MeasuredValue`, `ReflightDestinationEventStoreTests.cs`, `IStoreFixture`, `TaskDefinition`, `CompetitionId`, `Then`, `.New`, `GliderscoreFixture`, `.Rank`, `PhaseDefinition`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `ScoringACompetitionSteps`, `.Exact`, `BindParameterPropertyTests`, `CompetitorId`, `PenaltyDefinition`, `.SeedOpenEntryWithFlight`, `ScoringServicePropertyTests`, `AdoptedRules`, `When`, `.SeedCompetition`, `FinaliseDecideTests`, `.ScoreGroup`, `.SeedOpenEntry`, `MetricDefinition`, `SeedF5J`, `.ScoreCompetition`, `RecordEntryPenalty`, `BindParameterDecideTests`, `.SetUpAsync`, `.CompetitionAdopting`, `CreateCompetitionPropertyTests`, `ClassDefinitionValidationPropertyTests`, `.Build`, `.Apply`, `.BuildDrawnCompetition`, `.HandleAsync`, `.MapQueries`, `.Validate`, `.BuildCompetition`, `SeedF5K`, `.DrawnCompetitionAsync`, `DrawAcceptanceDecideTests`, `CompetitionReplaceTaskRoundPropertyTests`, `SeeingWhatIsRecordedSteps`, `PersonId`, `.SeedCompetition`, `CompetitionFieldPropertyTests`, `.BuildCompetition`, `ClassDefinitionFoldTests`, `FinaliseValidityPropertyTests`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `CompetitorId` connect `CompetitorId` to `Soarscore.Domain.PublishedClassDefinition`, `FakeEntryQuery`, `ReflightingForAMissedRoundSteps`, `SystemClock`, `WithdrawCompetitorHandler`, `CatalogueDrawPropertyTests`, `.AddSoarscoreInfrastructure`, `ReflightDestinationTests`, `PrescribeDrawDecideTests`, `.New`, `.DrawnCompetitionAsync`, `CompetitionId`, `PhaseDrawn`, `EntryId`, `GroupId`, `DrawAcceptanceEventStoreTests`, `IStoreFixture`, `EntryCapturePropertyTests`, `Then`, `.New`, `Competition`, `Entry`, `.CompareRawGrainViaHttpAsync`, `FlightOpened`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `ScoringACompetitionSteps`, `AmendMeasurementDecideTests`, `.Exact`, `AnnulEntryDecideTests`, `OpenFlightDecideTests`, `ReflightSelectionPropertyTests`, `TaskRoundRecordingPropertyTests`, `ScoringServicePropertyTests`, `When`, `.SeedCompetition`, `FinaliseDecideTests`, `.ScoreCompetition`, `RecordEntryPenalty`, `.SetUpAsync`, `.Build`, `.BuildDrawnCompetition`, `.ComputeEntries`, `.MapQueries`, `.BuildCompetition`, `.DrawnCompetitionAsync`, `DrawAcceptanceDecideTests`, `ReplayDriver`, `FakeEventStore`, `SeeingWhatIsRecordedSteps`, `PersonId`, `.SeedCompetition`, `.BuildCompetition`, `CaptureMeasurementDecideTests`, `.ScoreWith`, `RecordEntryPenaltyDecideTests`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `CompetitionId` connect `CompetitionId` to `Soarscore.Domain.PublishedClassDefinition`, `FakeEntryQuery`, `.LoadCurrentAsync`, `SystemClock`, `ReflightingForAMissedRoundSteps`, `WithdrawCompetitorHandler`, `.AddSoarscoreInfrastructure`, `DrawingACatalogueChoicePhaseSteps`, `PrescribeDrawDecideTests`, `.New`, `.DrawnCompetitionAsync`, `EntryId`, `DrawAcceptanceEventStoreTests`, `IStoreFixture`, `EntryCapturePropertyTests`, `Then`, `Competition`, `Entry`, `.CompareRawGrainViaHttpAsync`, `FlightOpened`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `ScoringACompetitionSteps`, `AmendMeasurementDecideTests`, `.Exact`, `AnnulEntryDecideTests`, `OpenFlightDecideTests`, `CompetitorId`, `.SeedOpenEntryWithFlight`, `CompetitionSummary`, `AdoptedRules`, `When`, `.SeedCompetition`, `.SeedOpenEntry`, `.SetUpAsync`, `.Build`, `.HandleAsync`, `.MapQueries`, `.DrawnCompetitionAsync`, `ReplayDriver`, `FakeEventStore`, `SeeingWhatIsRecordedSteps`, `PersonId`, `CaptureMeasurementDecideTests`, `RecordEntryPenaltyDecideTests`?**
...
- **Should `Soarscore.Domain.PublishedClassDefinition` be split into smaller, more focused modules?**
  _Cohesion score 0.0817963111467522 - nodes in this community are weakly interconnected._
