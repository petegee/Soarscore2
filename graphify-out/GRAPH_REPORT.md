# Graph Report - SoarScore2  (2026-09-09)

## Corpus Check
- 678 files · ~1,187,817 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8717 nodes · 23999 edges · 416 communities (403 shown, 13 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 2557 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b4619336`
...
- ClassDefinition
- MeasuredValue
- Soarscore.Application.Shared.CompetitionClasses
- FakeEntryQuery
...
- FakePeopleQuery
- .Seed
- .P1_a_spot_assignment_is_a_whole_replaced_bijection_that_dies_with_the_draw
- .Apply
- .Apply
- .LoadAsync
- TaskDefinition
...
1. `CompetitorId` - 278 edges
2. `CompetitionId` - 227 edges
3. `ClassDefinition` - 223 edges
4. `Soarscore.Domain.PublishedClassDefinition` - 215 edges
5. `Soarscore.Domain.Competitions` - 188 edges
6. `Result` - 134 edges
7. `Soarscore.Domain` - 123 edges
8. `EntryId` - 122 edges
9. `Soarscore.SeedData` - 122 edges
10. `Soarscore.Domain.People` - 116 edges
...
## Communities (416 total, 13 thin omitted)

### Community 0 - "Competition"
Cohesion: 0.09
Nodes (21): IEnumerable, Penalty, Competition, AdoptedRules, DeclaredInstruments, EndDate, EvaluatorVersion, Finalisations (+13 more)

### Community 1 - "Soarscore.Domain.PublishedClassDefinition"
Cohesion: 0.07
Nodes (6): Soarscore.Domain.Scoring, Soarscore.Domain.Tests, Soarscore.Domain.Competitions, Soarscore.Domain.People, Soarscore.Domain.Entries, Soarscore.Domain.PublishedClassDefinition
...
### Community 4 - "Entry"
Cohesion: 0.07
Nodes (36): Entry, CompetitionRef, CompetitorRef, CountsForRoundOrdinal, Flights, GroupRef, Id, Penalties (+28 more)
...
Cohesion: 0.07
Nodes (10): Soarscore.Application.Tests.Commands.Entries, Soarscore.Application.Shared.Entries, Soarscore.Application.Commands.Competitions, Soarscore.Application.Commands.Entries, Soarscore.Application.Shared.People, Soarscore.Application.Tests.Queries.Entries, Soarscore.Application.Queries.Entries, Soarscore.Domain (+2 more)
...
Cohesion: 0.11
Nodes (17): ImmutableArray, Penalty, Round, CompetitionEvent, CompetitorWithdrawn, Finalised, GroupSpotsAssigned, InstrumentDeclarationCorrected (+9 more)
...
Cohesion: 0.08
Nodes (66): ICommand, ICommandHandler, IHttpMaxRequestBodySizeFeature, WebApplication, Commands, IReadOnlyList, WebApplication, Composition (+58 more)

### Community 19 - "DeclaredTeamResult"
Cohesion: 0.13
Nodes (15): DeclaredTeamResult, BestIndividualPlacing, Contributors, Name, Placing, PlacingSum, TeamRef, Total (+7 more)
...
Cohesion: 0.09
Nodes (31): Exception, Competition, TaskResolver, Parameter, AllowedValues, BoundAt, DefaultValue, Kind (+23 more)

### Community 24 - "Soarscore.Application.Shared.CompetitionClasses"
Cohesion: 0.14
Nodes (3): Soarscore.Application.Tests, Soarscore.Application.Shared.CompetitionClasses, Soarscore.Application.Tests.Queries.CompetitionClasses

### Community 25 - "FakeEntryQuery"
Cohesion: 0.24
Nodes (13): CancellationToken, IClock, IEventStore, Task, BindParameterHandler, DateTimeOffset, Fact, FakeEventStore (+5 more)
...
Cohesion: 0.09
Nodes (12): Soarscore.Application.Tests.Commands.CompetitionClasses, Soarscore.Application.Commands.People, Soarscore.Api.Commands, Soarscore.Acceptance.Tests.Support, Soarscore.Application.Tests.Shared.CompetitionClasses, Soarscore.Application.Queries.Scoring, Soarscore.Acceptance.Tests.Support.Gliderscore, Soarscore.Application.Commands.CompetitionClasses (+4 more)
...
Cohesion: 0.14
Nodes (16): FlightPlan, DateTimeOffset, Penalty, EntryAnnulled, EntryEvent, FlightOpened, MeasurementAmended, MeasurementCaptured (+8 more)
...
Cohesion: 0.21
Nodes (17): AccruedInfo, PenaltyScope, PenaltyDefinition, Accrual, Effects, ExclusionGroups, PermittedScopes, PenaltyEffectSpec (+9 more)
...
Cohesion: 0.27
Nodes (11): GenEntry, GenFlight, Noise, DateTimeOffset, Gen, ImmutableArray, GenEntry, GenFlight (+3 more)

### Community 47 - "Measurement"
Cohesion: 0.08
Nodes (23): DateTimeOffset, Defect, Func, ImmutableArray, Penalty, PenaltyRecorded, Result, Annulment (+15 more)
...
### Community 49 - "CaptureMeasurement"
Cohesion: 0.06
Nodes (41): CancellationToken, IClock, IEventStore, Task, CorrectInstrumentDeclarationHandler, CancellationToken, IClock, IEventStore (+33 more)
...
### Community 56 - "ScoringVocabulary.cs"
Cohesion: 0.06
Nodes (34): ISet, Comparator, EqualTo, GreaterOrEqual, GreaterThan, LessOrEqual, LessThan, TargetAssignment (+26 more)
...
### Community 62 - "TaskTiming"
Cohesion: 0.10
Nodes (20): GroupConstraint, MinPerGroup, MinValidResults, LastFlight, TaskTiming, Kind, MaxLaunches, PreparationTime (+12 more)
...
Cohesion: 0.08
Nodes (27): Bindings, ClassDef, ExpectedRawScore, BestNFlights, Count, RankByMetric, Targets, TargetValues (+19 more)

### Community 66 - "Defect"
Cohesion: 0.14
Nodes (4): Defect, ReflightRuling, TaskRoundCoordinate, Defect
...
### Community 69 - "DrawAcceptancePropertyTests"
Cohesion: 0.12
...
Cohesion: 0.08
Nodes (38): IQueryHandler, CancellationToken, IClock, IEventStore, Task, ChangePersonContactDetails, ChangePersonContactDetailsHandler, CancellationToken (+30 more)
...
### Community 81 - "Result"
Cohesion: 0.06
Nodes (38): CancellationToken, Task, CancellationToken, Task, CancellationToken, Task, CancellationToken, Task (+30 more)
...
Cohesion: 0.05
Nodes (46): IParsable, IReadOnlyList, WebApplication, Queries, CancellationToken, IReadOnlyList, Task, CancellationToken (+38 more)

### Community 93 - ".New"
Cohesion: 0.11
Nodes (16): FieldOp, Fact, InlineData, Theory, CompetitionDecideTests, Fact, Gen, Index (+8 more)

### Community 94 - "SystemClock"
Cohesion: 0.06
Nodes (58): IClassFixture, Round2GroupRef, CancellationToken, IClock, IEventStore, Task, RegisterCompetitorHandler, CancellationToken (+50 more)
...
### Community 104 - ".New"
Cohesion: 0.14
Nodes (11): CompetitorRegistered, Store, ArgumentException, Competition, DateTimeOffset, Fact, CompetitionFoldTests, Fact (+3 more)
...
Cohesion: 0.15
Nodes (12): Competitor, CompetitorNumber, Id, PersonRef, RegisteredAt, WithdrawnAt, DateTimeOffset, Fact (+4 more)
...
### Community 129 - ".New"
Cohesion: 0.05
Nodes (49): IsBogus, PeopleProjection, DateTimeOffset, Defect, Result, ClubAffiliation, ClubName, MembershipNumber (+41 more)
...
Cohesion: 0.15
Nodes (18): IQuery, CancellationToken, IEventStore, ImmutableArray, Task, ScoreTeamStandings, ScoreTeamStandingsHandler, TeamStandingsView (+10 more)
...
Cohesion: 0.08
Nodes (23): CompositionKind, ChooseFromCatalogue, FixedSequence, DropDimension, ByRound, ByTask, PenaltyEffect, DeductPoints (+15 more)
...
Cohesion: 0.10
Nodes (30): RoundOrdinal, DateTimeOffset, ReflightRuling, At, By, CompetitorRef, Reason, Selection (+22 more)
...
Cohesion: 0.26
Nodes (9): CancellationToken, DateOnly, Guid, IReadOnlyDictionary, IReadOnlyList, RecordedEvent, Task, FakeEventStore (+1 more)
...
### Community 212 - "RankingEnginePropertyTests"
Cohesion: 0.24
...
### Community 219 - "4. Binding class contract — deltas to `Steps/RecordingAGliderscoreFixtureSteps.cs`"
Cohesion: 0.10
Nodes (19): 1. Ground truth established by planning, 2. Files, 3. The feature file, verbatim, 4. Binding class contract — deltas to `Steps/RecordingAGliderscoreFixtureSteps.cs`, 5. Work items, 6. Testing approach notes, 7. Scope guards and widening gates, Gherkin keyword trap (unchanged, still applies) (+11 more)
...
### Community 269 - "Entries/TestDoubles.cs"
Cohesion: 0.13
...
Cohesion: 0.19
Nodes (13): OpKind, Ops, SpotBase, Op, DateTimeOffset, FieldSize, Gen, Perm (+5 more)

### Community 276 - ".BuildWorld"
Cohesion: 0.19
Nodes (12): PlacedEntry, Shape, Competition, Entry, Fact, Group, IReadOnlyDictionary, IReadOnlyList (+4 more)
...
Cohesion: 0.14
Nodes (22): CancellationToken, IClock, IEventStore, Task, DrawPhaseHandler, AdoptedRules, Store, AdoptedRules (+14 more)
...
### Community 298 - ".ComputeGroupViews"
Cohesion: 0.22
...
Cohesion: 0.03
Nodes (69): Soarscore.Infrastructure.Competitions, Soarscore.Infrastructure.Tests, Soarscore.Infrastructure.CompetitionClasses, Soarscore.Infrastructure.People, Soarscore.Application.Tests.Queries.Competitions, Soarscore.Application.Queries.People, Soarscore.Infrastructure, Soarscore.Application.Queries.CompetitionClasses (+61 more)
...
### Community 313 - "Soarscore.SeedData"
Cohesion: 0.06
...
Cohesion: 0.12
Nodes (16): EnteredRow, CompetitionId, Dictionary, Given, GroupNo, HashSet, IReadOnlyList, List (+8 more)

### Community 319 - ".AddSoarscoreInfrastructure"
Cohesion: 0.09
Nodes (20): IConfiguration, IServiceCollection, DateTimeOffset, IClock, UtcNow, CancellationToken, DateOnly, IDocumentSessionFactory (+12 more)

### Community 320 - "TapeAmendmentDecideTests"
Cohesion: 0.37
Nodes (3): Fact, ImmutableArray, TapeAmendmentDecideTests

### Community 321 - "CompetitionResult"
Cohesion: 0.20
...
Cohesion: 0.11
Nodes (18): ResolvedSchedule, ImmutableArray, Group, CompetitorRefs, Id, Ordinal, Spots, InstrumentDeclaration (+10 more)
...
Cohesion: 0.09
Nodes (19): CompetitionProjection, AdoptedRules, AdoptedAt, Definition, SourceClassId, SourceVersion, GroupRef, DateTimeOffset (+11 more)
...
### Community 343 - ".SeedOneFlownEntry"
Cohesion: 0.24
...
### Community 349 - ".PostCommandRawAsync"
Cohesion: 0.33
...
Cohesion: 0.12
Nodes (17): IReadOnlyDictionary, FlightResult, FlightResultState, NoResult, Pending, Valid, PenaltyApplication, RawPenaltyApplication (+9 more)
...
### Community 359 - "SeedF5J"
Cohesion: 0.11
Nodes (15): ImmutableArray, SeedF5J, Definition, FlightMetrics, FlyoffTaskD, LandingRows, StartHeightBands, TaskD (+7 more)

### Community 360 - "FakePeopleQuery"
Cohesion: 0.47
...
### Community 362 - ".P1_a_spot_assignment_is_a_whole_replaced_bijection_that_dies_with_the_draw"
Cohesion: 0.27
Nodes (5): IReadOnlyCollection, Competition, Fact, Group, IReadOnlyList
...
### Community 364 - ".Apply"
Cohesion: 0.07
Nodes (46): PenaltyRecorded, DeclaredTeamContributor, CompetitorRef, Placing, Score, DateTimeOffset, Group, ReflightRuling (+38 more)

### Community 365 - ".LoadAsync"
Cohesion: 0.29
Nodes (6): CancellationToken, Entry, IEventStore, Task, Version, EntryLoader

### Community 366 - "TaskDefinition"
Cohesion: 0.04
Nodes (52): Class, TaskDefinition, Code, Flights, FlightValidWhen, Group, Metrics, Name (+44 more)
...
### Community 369 - "ExpectedVersion"
Cohesion: 0.17
Nodes (12): ExpectedVersion, Any, IsAny, IsExact, IsNoStream, NoStream, Version, Kind (+4 more)

### Community 370 - ".New"
Cohesion: 0.06
Nodes (37): Competition, DateOnly, CompetitionCreated, DrawAccepted, EntryQuery, FakeEventStore, ImmutableArray, Store (+29 more)

### Community 371 - "F3B — RC Multi-Task Gliders"
Cohesion: 0.22
...
### Community 391 - ".AppendAsync"
Cohesion: 0.57
Nodes (4): CancellationToken, Guid, IReadOnlyList, StaleReadEventStore

### Community 392 - ".LoadAsync_for_an_existing_stream_returns_the_folded_entry_and_its_version"
Cohesion: 0.47
Nodes (4): DateTimeOffset, Fact, Task, EntryLoaderTests

### Community 393 - "CompetitorModel"
Cohesion: 0.40
...
### Community 399 - "Story — F5J Christchurch parallel-run witness (the guaranteed divergence)"
Cohesion: 0.12
Nodes (16): Before starting, Cross-story contract — `kanban/backlog/tape-points-landing-seeds.md`, Plan, Scope guards and standing constraints, Settled decisions (2026-09-07, Pete; decision 2 rewritten 2026-09-08), Story — F5J Christchurch parallel-run witness (the guaranteed divergence), Testing approach, Verified ground truth (2026-09-07, planning — re-verify line refs before relying on one) (+8 more)

### Community 400 - "F3K.4 SAFETY"
Cohesion: 0.40
...
### Community 412 - "ClassDefinitionProjectionPropertyTests"
Cohesion: 0.67
Nodes (3): DateTimeOffset, Gen, ClassDefinitionProjectionPropertyTests

## Knowledge Gaps
- **2438 isolated node(s):** `context7`, `rider`, `$schema`, `.opencode/plugins/graphify.js`, `$(SoarscoreTargetFramework)` (+2433 more)
...
- **Why does `ClassDefinition` connect `ClassDefinition` to `EntryOpened`, `ReflightingForAMissedRoundSteps`, `Entry`, `CatalogueDrawPropertyTests`, `PrescribeDrawDecideTests`, `.Decide`, `CompetitionEvent`, `EntryId`, `CompetitionId`, `.CheckLimits`, `TapeLandingScaleProofTests`, `MeasuredValue`, `FakeEntryQuery`, `CompetitionScoreView`, `.New`, `FixtureModels.cs`, `ScoringServicePropertyTests`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `ScoringACompetitionSteps`, `.SeedCompetition`, `PenaltyDefinition`, `CaptureMeasurement`, `When`, `ScoringTeamsSteps`, `PhaseDefinition`, `OpenFlight`, `LandingTapeDeclaredScaleSteps`, `ScoreTerm`, `DrawAcceptancePropertyTests`, `.CompetitionAdopting`, `ScoringTeamCommandHandlerTests`, `.BuildDrawnCompetition`, `Result`, `.HandleAsync`, `MetricDefinition`, `CompetitorId`, `.New`, `SystemClock`, `DrawAcceptanceDecideTests`, `GliderscoreFixture`, `.New`, `PublishClassDefinition`, `RecordCompetitionPenaltyDecideTests`, `.New`, `.SeedCompetition`, `SeedF3K`, `EntryModelBasedFoldTests`, `FinaliseDecideTests`, `SeedNzF3kNdc`, `.ScoreCompetition`, `SeedF5kNdc`, `FakeEventStore`, `ClassDefinitionValidationPropertyTests`, `WithdrawCompetitorHandler`, `IDispatcher`, `CompetitionReplaceTaskRoundPropertyTests`, `SeeingWhatIsRecordedSteps`, `.DrawnCompetitionAsync`, `ReadingScale`, `DeclaredInstrument`, `.DrawnCompetitionAsync`, `ClassDefinitionPublished`, `.SetUpAsync`, `GroupSpotsPropertyTests`, `DrawPhase`, `Soarscore.SeedData`, `SeedF5K`, `CompetitionResult`, `BindParameterPropertyTests`, `.SeedEntryUnderF5K`, `AdoptedRules`, `BindParameterDecideTests`, `PublishedClassDefinition`, `.SeedOneFlownEntry`, `.BuildDrawnCompetition`, `SeedF3J`, `SeedF5J`, `.Apply`, `.Apply`, `TaskDefinition`, `.New`, `CreateCompetitionPropertyTests`, `.CompareAsync`, `RulesAmendment`, `ClassDefinitionEventJsonTests`, `ClassDefinitionProjectionPropertyTests`?**
  _High betweenness centrality (0.137) - this node is a cross-community bridge._
- **Why does `CompetitorId` connect `CompetitorId` to `Competition`, `Soarscore.Domain.PublishedClassDefinition`, `EntryOpened`, `ReflightingForAMissedRoundSteps`, `Entry`, `CatalogueDrawPropertyTests`, `.SeedWired`, `PrescribeDrawDecideTests`, `CompetitionEvent`, `EntryId`, `CompetitionId`, `EntryCapturePropertyTests`, `CompetitionScoreView`, `.New`, `ScoringServicePropertyTests`, `IEventStore`, `FlightOpened`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `ScoringACompetitionSteps`, `AmendMeasurementDecideTests`, `FakeClock`, `When`, `ScoringTeamsSteps`, `PhaseDefinition`, `LandingTapeDeclaredScaleSteps`, `TaskTiming`, `Defect`, `TeamsDecideTests`, `ScoringTeamCommandHandlerTests`, `PersonId`, `.BuildDrawnCompetition`, `Result`, `Round`, `.HandleAsync`, `.New`, `SystemClock`, `DrawAcceptanceDecideTests`, `GliderscoreFixture`, `PublishClassDefinition`, `RecordCompetitionPenaltyDecideTests`, `CaptureMeasurementDecideTests`, `.SeedCompetition`, `.SeedScoredTeamCompetition`, `.Classify`, `Penalty`, `FinaliseDecideTests`, `DateTimeOffset`, `TaskRoundClosurePropertyTests`, `OpenFlightDecideTests`, `.ScoreCompetition`, `FakeEventStore`, `WithdrawCompetitorHandler`, `IDispatcher`, `DrawProtectionPropertyTests`, `SeeingWhatIsRecordedSteps`, `TeamClassificationEngineTests`, `TeamClassificationPropertyTests`, `.DrawnCompetitionAsync`, `FindEntries`, `AssigningSpotsSteps`, `.DrawnCompetitionAsync`, `.BuildDrawnCompetition`, `.SetUpAsync`, `.BuildWorld`, `.BuildGroups`, `DrawPhase`, `RecordEntryPenaltyDecideTests`, `PhaseDrawPropertyTests`, `.ComputeGroupViews`, `AnnulEntryDecideTests`, `ProtectedPair`, `RecordingAGliderscoreFixtureSteps`, `TapeAmendmentDecideTests`, `ImmutableArray`, `AdoptedRules`, `.SeedOneFlownEntry`, `.BuildDrawnCompetition`, `ScoringServiceZeroRoutingTests`, `.P1_a_spot_assignment_is_a_whole_replaced_bijection_that_dies_with_the_draw`, `.Apply`, `.New`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `Result` connect `Result` to `FindClassDefinitions`, `.AppendAsync`, `EntryOpened`, `.DrawnCompetitionAsync`, `.SeedCompetition`, `.AppendAsync`, `.SeedScoredTeamCompetition`, `.SeedWired`, `.Select`, `.SetUpAsync`, `MeasuredValue`, `FakeEntryQuery`, `DrawPhase`, `CompetitionSummary`, `FakeClock`, `.SeedCompetition`, `FakeEventStore`, `PersonSummary`, `CaptureMeasurement`, `ProtectedPair`, `OpenFlight`, `JasperFxEventStore`, `Defect`, `FakeEventStore`, `Dispatcher`, `FakeEventStore`, `.SeedEntryUnderF5K`, `ScoringTeamCommandHandlerTests`, `WithdrawCompetitorHandler`, `PersonId`, `FakeEventStore`, `.HandleAsync`, `IDomainEvent`, `PublishedClassDefinition`, `IDispatcher`, `.HandleAsync`, `CompetitorId`, `SystemClock`, `PublishClassDefinition`, `.LoadAsync`, `MartenEventStore`, `FisherEventStore`, `.New`, `.DrawnCompetitionAsync`, `EndpointRouteBuilderExtensions`, `FindEntries`?**
...
- **Should `Soarscore.Domain.PublishedClassDefinition` be split into smaller, more focused modules?**
  _Cohesion score 0.07260726072607261 - nodes in this community are weakly interconnected._
