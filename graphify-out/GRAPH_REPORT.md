# Graph Report - SoarScore2  (2026-09-06)

## Corpus Check
- 656 files · ~1,125,048 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8231 nodes · 22439 edges · 409 communities (397 shown, 12 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 2407 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `25727173`
...
1. `CompetitorId` - 272 edges
2. `ClassDefinition` - 217 edges
3. `CompetitionId` - 214 edges
4. `Soarscore.Domain.PublishedClassDefinition` - 203 edges
5. `Soarscore.Domain.Competitions` - 175 edges
6. `Result` - 132 edges
7. `Soarscore.Domain` - 117 edges
8. `Soarscore.Domain.People` - 112 edges
9. `Soarscore.SeedData` - 111 edges
10. `EntryId` - 110 edges
...
## Communities (409 total, 12 thin omitted)
...
Cohesion: 0.06
Nodes (8): Soarscore.Domain.Scoring, Soarscore.Domain.Tests, Soarscore.Domain.Competitions, Soarscore.Domain.People, Soarscore.SeedData, Soarscore.Domain.Entries, Soarscore.Domain.PublishedClassDefinition, Intrinsic
...
Cohesion: 0.08
Nodes (7): Soarscore.Application.Commands.Competitions, Soarscore.Application.Shared.People, Soarscore.Application.Tests.Shared.Competitions, Soarscore.Application.Queries.Entries, Soarscore.Domain, Soarscore.Application.Tests.Commands.Competitions, Soarscore.Application.Shared.Competitions

### Community 8 - "CatalogueDrawPropertyTests"
Cohesion: 0.16
Nodes (11): MinPerGroupByRound, Sizes, MinPerGroup, TaskCount, Competition, DateTimeOffset, Fact, Field (+3 more)
...
### Community 11 - ".SeedOpenEntryWithFlight"
Cohesion: 0.15
...
Cohesion: 0.13
Nodes (24): DropPolicy, ApplyWhenResultsAtLeast, ApplyWhenRoundsCompletedAtLeast, Dimension, DropCount, IReadOnlyDictionary, RoundData, TaskRoundData (+16 more)

### Community 14 - "CompetitionDecidePropertyTests"
Cohesion: 0.43
Nodes (4): DateOnly, Fact, Gen, CompetitionDecidePropertyTests

### Community 15 - "IEventStore"
Cohesion: 0.18
...
Cohesion: 0.05
Nodes (87): ICommand, ICommandHandler, IHttpMaxRequestBodySizeFeature, IParsable, WebApplication, Commands, IReadOnlyList, WebApplication (+79 more)
...
Cohesion: 0.09
Nodes (24): HashSet, IEnumerable, ImmutableArray, IReadOnlyDictionary, List, Phase, Task, ClassDefinitionValidation (+16 more)
...
Cohesion: 0.15
Nodes (5): Soarscore.Application.Queries.CompetitionClasses, Soarscore.Application.Shared.CompetitionClasses, Soarscore.Application.Tests.Queries.CompetitionClasses, PostgresClassDefinitionEventStoreTests, SqliteClassDefinitionEventStoreTests

### Community 25 - "FakeEntryQuery"
Cohesion: 0.23
Nodes (14): CancellationToken, IClock, IEventStore, Task, BindParameterHandler, ParameterBound, DateTimeOffset, Fact (+6 more)

### Community 26 - "EntryCapturePropertyTests"
Cohesion: 0.08
Nodes (27): DecideActual, DecideFlightModel, DecideModel, FlagValue, MetricIndex, NumericValue, Pick, PlannedCapture (+19 more)

### Community 27 - "Soarscore.Application.Commands.CompetitionClasses"
Cohesion: 0.09
Nodes (11): Soarscore.Application.Tests.Commands.CompetitionClasses, Soarscore.Application.Commands.People, Soarscore.Acceptance.Tests.Support, Soarscore.Application.Tests.Shared.CompetitionClasses, Soarscore.Application.Queries.Scoring, Soarscore.Acceptance.Tests.Support.Gliderscore, Soarscore.Application.Commands.CompetitionClasses, Soarscore.Acceptance.Tests.Steps (+3 more)
...
Cohesion: 0.11
Nodes (27): KeyCollection, Mismatches, StandingsCompared, Competition, Dictionary, Entry, Func, HashSet (+19 more)

### Community 35 - "FlightOpened"
Cohesion: 0.14
Nodes (20): FlightPlan, DateTimeOffset, Amendment, At, By, NewValue, Reason, DateTimeOffset (+12 more)
...
### Community 38 - "Then"
Cohesion: 0.09
Nodes (20): ImmutableArray, CompetitionScoreView, Entry, ImmutableArray, IReadOnlyDictionary, CompetitorTaskResultView, GroupScoreView, Then (+12 more)
...
### Community 41 - ".BuildDrawnCompetition"
Cohesion: 0.24
...
### Community 47 - "ScoringServiceZeroRoutingTests"
Cohesion: 0.22
Nodes (8): Other, Subject, DateTimeOffset, Entries, ImmutableArray, ImmutableDictionary, IReadOnlyDictionary, ScoringServiceZeroRoutingTests
...
Cohesion: 0.06
Nodes (36): ImmutableArray, PhaseDefinition, Drops, Ordinal, Promotion, Rounds, Tasks, TieBreaks (+28 more)

### Community 56 - "ResolvedTask"
Cohesion: 0.07
Nodes (34): Bindings, ClassDef, ExpectedRawScore, ISet, FlightSelection, LastNFlights, ScoreTerm, ImmutableArray (+26 more)
...
### Community 59 - ".OpenAndCaptureFlightAsync"
Cohesion: 0.25
...
Cohesion: 0.05
Nodes (33): Builder, Rows, ConstantTerm, Value, LookupRow, LookupTerm, MetricRef, Rows (+25 more)

### Community 62 - "CompetitionEvent"
Cohesion: 0.09
Nodes (37): PenaltyRecorded, DateTimeOffset, Penalty, ReflightRuling, CompetitionEvent, CompetitorWithdrawn, DrawRejected, GroupSpotsAssigned (+29 more)
...
Cohesion: 0.50
Nodes (4): ReflightRole, Entitled, Filler, Original
...
Cohesion: 0.05
Nodes (57): IQueryHandler, CancellationToken, IClock, IEventStore, ImmutableArray, Task, FinaliseCompetition, FinaliseCompetitionHandler (+49 more)
...
### Community 93 - ".New"
Cohesion: 0.11
Nodes (17): FieldOp, DrawAccepted, Fact, InlineData, Theory, CompetitionDecideTests, Fact, Gen (+9 more)

### Community 94 - "SystemClock"
Cohesion: 0.07
Nodes (46): IClassFixture, Round2GroupRef, CancellationToken, IClock, IEventStore, Task, RegisterCompetitorHandler, CancellationToken (+38 more)
...
Cohesion: 0.16
Nodes (16): GroupNo, Kept, PilotNo, ReflightRows, RoundNo, SlotCapture, ScoresRow, HttpClient (+8 more)
...
### Community 104 - ".Create"
Cohesion: 0.09
Nodes (22): DeclaredResult, Aggregate, CompetitorRef, Placing, Promoted, Group, ReflightGroupAppended, ArgumentException (+14 more)
...
### Community 125 - "BindParameterDecideTests"
Cohesion: 0.21
...
Cohesion: 0.12
Nodes (20): IProjection, IDocumentOperations, IDocumentSession, ClassDefinitionSummaryProjection, FisherClassDefinitionSummaryProjection, MartenClassDefinitionSummaryProjection, DocumentStore, FisherConfig (+12 more)
...
Cohesion: 0.12
Nodes (17): CancellationToken, Task, Type, IQuery, IQueryHandler, IReadOnlyList, Result, Code (+9 more)

### Community 134 - "PhaseDrawn"
Cohesion: 0.15
Nodes (6): ImmutableArray, Round, PhaseDrawn, DateTimeOffset, Fact, CompetitionEventJsonTests
...
Cohesion: 0.07
Nodes (27): ImmutableArray, SeedF3K, Catalogue, Definition, FlightMetrics, TaskA, TaskB, TaskC (+19 more)
...
### Community 145 - "PublishedClassDefinition"
Cohesion: 0.14
...
Cohesion: 0.13
Nodes (11): Competition, DateTimeOffset, Fact, ImmutableArray, InlineData, Theory, FinaliseDecideTests, OneTeamResult (+3 more)

### Community 153 - "Person"
Cohesion: 0.12
Nodes (15): CancellationToken, Task, CancellationToken, IEventStore, Task, Version, PersonLoader, DateTimeOffset (+7 more)
...
### Community 190 - "PrescribeDrawPropertyTests"
Cohesion: 0.16
...
Cohesion: 0.10
Nodes (28): Id, Competitors, Competition, Dictionary, Entries, Entry, Competition, DateTimeOffset (+20 more)
...
### Community 210 - "WithdrawCompetitorHandler"
Cohesion: 0.22
...
### Community 214 - ".SeedOneFlownEntry"
Cohesion: 0.24
...
Cohesion: 0.12
Nodes (22): ICommand, IDispatcher, GroupSpot, CancellationToken, Fact, Task, DrawAcceptanceEventStoreTests, Ct (+14 more)
...
Cohesion: 0.27
Nodes (11): CancellationToken, IReadOnlyList, Task, FindEntries, FindEntriesHandler, CancellationToken, IReadOnlyList, Task (+3 more)
...
### Community 257 - "CompetitorId"
Cohesion: 0.21
Nodes (7): CompetitorFinalScoreView, CompetitorId, Dictionary, IEnumerable, ImmutableArray, Fact, Result
...
### Community 275 - "PersonDecideTests"
Cohesion: 0.25
...
### Community 284 - ".New"
Cohesion: 0.05
Nodes (58): IsBogus, CancellationToken, Task, CancellationToken, IClock, IEventStore, Task, DrawPhaseHandler (+50 more)

### Community 285 - ".BuildDrawnCompetition"
Cohesion: 0.27
...
Cohesion: 0.09
Nodes (29): CancellationToken, IEventStore, Task, RecordCompetitionPenalty, RecordCompetitionPenaltyHandler, Penalty, By, CompetitorRef (+21 more)
...
### Community 297 - ".AddSoarscoreInfrastructure"
Cohesion: 0.10
Nodes (18): IConfiguration, IServiceCollection, CancellationToken, IDocumentSessionFactory, IReadOnlyList, Task, DocumentEntryQuery, CancellationToken (+10 more)
...
### Community 300 - "f3k-southern-fling/ladder.py"
Cohesion: 0.20
...
Cohesion: 0.03
Nodes (72): Soarscore.Infrastructure.Competitions, Soarscore.Infrastructure.Tests, Soarscore.Infrastructure.CompetitionClasses, Soarscore.Infrastructure.People, Soarscore.Application.Tests.Queries.Competitions, Soarscore.Application.Queries.People, Soarscore.Api.Commands, Soarscore.Infrastructure (+64 more)
...
Cohesion: 0.07
Nodes (29): ResolvedSchedule, Round, Func, ImmutableArray, Draw, CreatedAt, Status, Group (+21 more)
...
Cohesion: 0.31
Nodes (5): GeneratedRegex, Regex, Fact, IEnumerable, ClassAgnosticismTests

### Community 334 - "00-nz-general-rules.md"
Cohesion: 0.29
...
### Community 336 - "ReflightSelection"
Cohesion: 0.15
...
### Community 338 - "EntryEventJsonTests"
Cohesion: 0.22
Nodes (7): Annulment, At, By, Reason, DateTimeOffset, Fact, EntryEventJsonTests

### Community 339 - ".BuildDispatcher"
Cohesion: 0.49
...
### Community 343 - "Soarscore.Application.Commands.Entries"
Cohesion: 0.17
Nodes (5): Soarscore.Application.Tests.Commands.Entries, Soarscore.Application.Shared.Entries, Soarscore.Application.Commands.Entries, Soarscore.Application.Tests.Queries.Entries, Soarscore.Application.Tests.Shared.Entries

### Community 344 - ".Every_endpoint_is_GET_or_POST"
Cohesion: 0.18
...
Cohesion: 0.20
Nodes (8): RoundingMode, Ceiling, HalfUp, Truncate, Gen, IReadOnlyDictionary, FlightSelectorPropertyTests, M
...
### Community 358 - "Entry"
Cohesion: 0.06
Nodes (32): Func, ImmutableArray, Penalty, PenaltyRecorded, Result, Entry, Annulment, CompetitionRef (+24 more)

### Community 359 - ".Annulled_entry_carries_reason_by_and_timestamp"
Cohesion: 0.42
...
Cohesion: 0.05
Nodes (56): TaskDefinition, Code, Flights, FlightValidWhen, Group, Metrics, Name, Normalise (+48 more)

### Community 367 - "ScoringCorpusPropertyTests"
Cohesion: 0.25
Nodes (7): DateTimeOffset, Fact, ImmutableArray, ImmutableDictionary, Name, Value, ScoringCorpusPropertyTests

### Community 368 - "F3K.2 DEFINITION OF MODEL GLIDER"
Cohesion: 0.29
...
### Community 373 - "ClassDefinitionProjectionPropertyTests"
Cohesion: 0.67
...
### Community 380 - "F3 Soaring — Generally Applicable Rules"
Cohesion: 0.29
...
### Community 381 - "RulesAmendment"
Cohesion: 0.40
Nodes (5): RulesAmendment, At, By, Definition, Reason

### Community 382 - "A.6 BUREAU"
Cohesion: 0.29
...
### Community 395 - "F3J.2 THE FLYING SITE"
Cohesion: 0.40
Nodes (5): F3J.2.1 Site Surface, F3J.2.2 Site Marking, F3J.2.3 Landing Spots, F3J.2.4 Safety Rules, F3J.2 THE FLYING SITE

### Community 396 - "DrawAcceptancePropertyTests"
Cohesion: 0.12
Nodes (17): DrawOp, DateTimeOffset, Fact, Gen, List, DrawAcceptancePropertyTests, DrawOp, Accept (+9 more)

### Community 397 - "Story — Corpus-wide fixture→seed parallel-run mapping table"
Cohesion: 0.40
Nodes (4): Before starting, Story — Corpus-wide fixture→seed parallel-run mapping table, What, Why it matters
...
- **Why does `ClassDefinition` connect `ClassDefinition` to `EntryOpened`, `ReflightingForAMissedRoundSteps`, `MetricAbsenceFixtures`, `CatalogueDrawPropertyTests`, `.SeedOpenEntryWithFlight`, `PrescribeDrawDecideTests`, `CompetitionDecidePropertyTests`, `EntryId`, `CompetitionId`, `.All_seven_team_events_round_trip_through_the_real_store_and_replay_to_the_expected_state`, `.CheckLimits`, `Corpus.cs`, `MeasuredValue`, `FakeEntryQuery`, `ClosingACompetitionSteps`, `.New`, `GliderscoreFixture`, `ScoringServicePropertyTests`, `FlightOpened`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `Then`, `.BuildDrawnCompetition`, `PenaltyDefinition`, `ScoringServiceZeroRoutingTests`, `When`, `ScoringTeamsSteps`, `PhaseDefinition`, `ResolvedTask`, `.SeedOpenEntry`, `.OpenAndCaptureFlightAsync`, `LookupRow`, `CompetitionEvent`, `CompetitionReplaceTaskRoundPropertyTests`, `GroupSpotsPropertyTests`, `TeamsDecideTests`, `.CompetitionAdopting`, `.LoadAsync`, `.BuildDrawnCompetition`, `.SeedOpenEntryWithFlight`, `IStoreFixture`, `.Validate`, `.DrawnCompetitionAsync`, `.New`, `SystemClock`, `DrawAcceptanceDecideTests`, `ReplayDriver`, `.Create`, `PublishClassDefinition`, `RecordCompetitionPenaltyDecideTests`, `.ScoreCompetition`, `BindParameterDecideTests`, `PhaseDrawn`, `SeedF3K`, `PublishedClassDefinition`, `EntryModelBasedFoldTests`, `Competition`, `.Apply`, `CompetitionResult`, `SeedF5kNdc`, `PrescribeDrawPropertyTests`, `FakeEventStore`, `ClassDefinitionValidationPropertyTests`, `WithdrawCompetitorHandler`, `.SeedOneFlownEntry`, `IDispatcher`, `SeeingWhatIsRecordedSteps`, `.DrawnCompetitionAsync`, `.ScoreGroup`, `.BuildCompetition`, `.SetUpAsync`, `.New`, `.BuildDrawnCompetition`, `RecordEntryPenaltyDecideTests`, `Soarscore.Application`, `SeedF5K`, `BindParameterPropertyTests`, `.SeedEntryUnderF5K`, `.BuildDispatcher`, `ClassDefinitionPublished`, `TaskDefinition`, `ClassDefinitionProjectionPropertyTests`, `SeedNzMAles200`, `SeedNzMNdc`, `RulesAmendment`, `CreateCompetitionPropertyTests`, `ClassDefinitionEventJsonTests`, `.BuildCompetition`, `ParallelRunLedger`, `DrawAcceptancePropertyTests`, `.MapQueries`?**
  _High betweenness centrality (0.129) - this node is a cross-community bridge._
- **Why does `CompetitorId` connect `CompetitorId` to `Competition`, `Soarscore.Domain.PublishedClassDefinition`, `EntryOpened`, `ReflightingForAMissedRoundSteps`, `PrescribeDrawDecideTests`, `.Of`, `EntryId`, `CompetitionId`, `.All_seven_team_events_round_trip_through_the_real_store_and_replay_to_the_expected_state`, `EntryCapturePropertyTests`, `ClosingACompetitionSteps`, `.New`, `ScoringServicePropertyTests`, `Comparator`, `FlightOpened`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `Then`, `AmendMeasurementDecideTests`, `.Exact`, `.BuildDrawnCompetition`, `TaskRoundRecordingPropertyTests`, `ScoringServiceZeroRoutingTests`, `When`, `ScoringTeamsSteps`, `PhaseDefinition`, `.OpenAndCaptureFlightAsync`, `CompetitionEvent`, `GroupSpotsPropertyTests`, `TeamsDecideTests`, `.LoadAsync`, `.BuildDrawnCompetition`, `.ComputeEntries`, `IStoreFixture`, `.DrawnCompetitionAsync`, `.New`, `SystemClock`, `DrawAcceptanceDecideTests`, `ReplayDriver`, `.Create`, `RecordCompetitionPenaltyDecideTests`, `.ScoreCompetition`, `.SeedScoredTeamCompetition`, `.Classify`, `Competition`, `OpenFlightDecideTests`, `DrawingACatalogueChoicePhaseSteps`, `PrescribeDrawPropertyTests`, `FakeEventStore`, `WithdrawCompetitorHandler`, `.SeedOneFlownEntry`, `IDispatcher`, `DrawProtectionPropertyTests`, `SeeingWhatIsRecordedSteps`, `TeamClassificationEngineTests`, `TeamClassificationPropertyTests`, `.DrawnCompetitionAsync`, `.SeedWired`, `FindEntries`, `AssigningSpotsSteps`, `.BuildDrawnCompetition`, `.BuildCompetition`, `.SetUpAsync`, `.BuildGroups`, `.New`, `.BuildDrawnCompetition`, `RecordEntryPenaltyDecideTests`, `PhaseDrawPropertyTests`, `.AddSoarscoreInfrastructure`, `AnnulEntryDecideTests`, `ProtectedPair`, `TaskRound`, `ReflightSelection`, `EntryEventJsonTests`, `.ComputeGroupViews`, `Entry`, `Model`, `.BuildCompetition`, `Competitor`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `CompetitionId` connect `CompetitionId` to `Competition`, `Soarscore.Domain.PublishedClassDefinition`, `EntryOpened`, `.SeedScoredTeamCompetition`, `.LoadCurrentAsync`, `.SeedOpenEntryWithFlight`, `.Of`, `.SetUpAsync`, `FakeEntryQuery`, `EntryCapturePropertyTests`, `.New`, `CompetitionSummary`, `RecordEntryPenaltyDecideTests`, `Comparator`, `FlightOpened`, `OpenFlightDecideTests`, `AmendMeasurementDecideTests`, `.Exact`, `.AddSoarscoreInfrastructure`, `AnnulEntryDecideTests`, `ProtectedPair`, `.SeedOpenEntry`, `.OpenAndCaptureFlightAsync`, `FakeEventStore`, `.LoadAsync`, `.SeedOpenEntryWithFlight`, `WithdrawCompetitorHandler`, `EntryEventJsonTests`, `IStoreFixture`, `.SeedOneFlownEntry`, `IDispatcher`, `.DrawnCompetitionAsync`, `SystemClock`, `ReplayDriver`, `Entry`, `PublishClassDefinition`, `.DrawnCompetitionAsync`, `.SeedWired`, `FindEntries`?**
