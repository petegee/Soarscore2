# Graph Report - SoarScore2  (2026-09-11)

## Corpus Check
- 728 files · ~1,257,995 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9234 nodes · 25597 edges · 418 communities (408 shown, 10 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 2704 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cef1be76`
...
- Soarscore.Application.Shared.People
- FakeEventStore
...
1. `CompetitorId` - 297 edges
2. `CompetitionId` - 235 edges
3. `ClassDefinition` - 233 edges
4. `Soarscore.Domain.PublishedClassDefinition` - 231 edges
5. `Soarscore.Domain.Competitions` - 198 edges
6. `Result` - 138 edges
7. `Soarscore.SeedData` - 131 edges
8. `EntryId` - 130 edges
9. `Soarscore.Domain` - 129 edges
10. `Soarscore.Domain.People` - 122 edges
...
## Communities (418 total, 10 thin omitted)

### Community 0 - "PrescribeDrawDecideTests"
Cohesion: 0.06
...
Cohesion: 0.16
Nodes (26): CancellationToken, IClock, IEventStore, Task, OpenEntryHandler, EntrySummary, CancellationToken, IReadOnlyList (+18 more)

### Community 3 - "ReflightingForAMissedRoundSteps"
Cohesion: 0.09
Nodes (21): Warnings, CompetitionId, Dictionary, Given, Group, HttpClient, HttpResponseMessage, IReadOnlyList (+13 more)
...
Cohesion: 0.07
Nodes (13): Soarscore.Domain.Competitions, Soarscore.Application.Shared.Entries, Soarscore.Application.Commands.Competitions, Soarscore.Application.Tests.Queries.Competitions, Soarscore.Application.Tests.Shared.Competitions, Soarscore.Application.Tests.Queries.Entries, Soarscore.Application.Queries.Entries, Soarscore.Domain (+5 more)
...
Cohesion: 0.08
Nodes (30): IParsable, CancellationToken, IClock, IEventStore, Task, RegisterCompetitorHandler, CancellationToken, Task (+22 more)
...
### Community 15 - ".BuildCompetition"
Cohesion: 0.08
Nodes (24): CountsFor, Role, ReflightRole, Entitled, Filler, Original, Entry, ReflightSelector (+16 more)

### Community 16 - ".SelectAndScore"
Cohesion: 0.11
Nodes (17): ISet, Predicate, ImmutableArray, IReadOnlyDictionary, IReadOnlySet, FlightMetricResolution, ImmutableArray, IReadOnlyDictionary (+9 more)

### Community 17 - "CapturingAScoreSteps"
Cohesion: 0.08
Nodes (18): Competition, ImmutableArray, CompetitionView, CompetitionId, Dictionary, Given, Group, HttpClient (+10 more)

### Community 18 - "CompetitionId"
Cohesion: 0.04
Nodes (101): ClassCorpusSeederHost, ICommand, ICommandHandler, IHttpMaxRequestBodySizeFeature, WebApplication, IReadOnlyList, WebApplication, CancellationToken (+93 more)

### Community 19 - "ResolvingATieBreakSteps"
Cohesion: 0.11
Nodes (14): ImmutableArray, CompetitionScoreView, CompetitionId, Dictionary, Given, Group, HttpClient, HttpResponseMessage (+6 more)
...
Cohesion: 0.14
Nodes (11): LandingTable, ConditionalTerm, Else, DateTimeOffset, Dictionary, Fact, ImmutableArray, IReadOnlyList (+3 more)

### Community 22 - "ClassDefinition"
Cohesion: 0.08
Nodes (26): HashSet, IReadOnlyDictionary, List, Phase, Task, ClassDefinitionValidation, ClassDefinition, FaiDesignation (+18 more)

### Community 23 - "MeasuredValue"
Cohesion: 0.10
Nodes (28): Exception, Parameter, AllowedValues, BoundAt, DefaultValue, Kind, Name, Unit (+20 more)

### Community 24 - "FakeClock"
Cohesion: 0.29
Nodes (7): IClock, DateTimeOffset, FakeClock, UtcNow, DateTimeOffset, FakeClock, UtcNow

### Community 25 - "CompetitionEvent"
Cohesion: 0.11
Nodes (14): InstrumentDeclarationCorrection, At, By, Instruments, Reason, ImmutableArray, Penalty, CompetitionEvent (+6 more)
...
Cohesion: 0.12
Nodes (17): Soarscore.Infrastructure.Tests, Soarscore.Application.Commands.Entries, Soarscore.Acceptance.Tests, Soarscore.Application.Commands.People, Soarscore.Api.Commands, Soarscore.Acceptance.Tests.Support, Soarscore.Application.Queries.Competitions, Soarscore.Application.Queries.Scoring (+9 more)
...
Cohesion: 0.15
Nodes (28): List, Dictionary, IReadOnlyList, CompetitionFile, CompetitionIdentity, CompetitionScoring, CompPilotRow, CompPilotsTable (+20 more)

### Community 31 - "ImmutableArray"
Cohesion: 0.07
Nodes (34): ResolvedSchedule, Round, Func, ImmutableArray, Draw, CreatedAt, Status, Group (+26 more)

### Community 32 - "ScoringServicePropertyTests"
Cohesion: 0.13
Nodes (12): Scope, InfractionType, SubjectIndex, DateTimeOffset, Fact, Gen, ImmutableArray, IReadOnlyDictionary (+4 more)
...
### Community 35 - "Entry"
Cohesion: 0.04
Nodes (70): FlightPlan, EntryProjection, DateTimeOffset, Defect, Func, ImmutableArray, Penalty, PenaltyRecorded (+62 more)
...
### Community 41 - "DrawPhase"
Cohesion: 0.08
Nodes (43): Round2GroupRef, CancellationToken, IClock, IEventStore, Task, DrawPhaseHandler, DateOnly, CompetitionSummary (+35 more)
...
### Community 46 - "RecordEntryPenaltyDecideTests"
Cohesion: 0.14
Nodes (17): Penalty, By, CompetitorRef, InfractionType, Scope, TaskRound, PenaltyScope, Competition (+9 more)

### Community 47 - "Path"
Cohesion: 0.14
Nodes (20): Path, IEnumerable, ImmutableArray, MetricRef, Term, encode(), extract_table(), _install_tolerant_parser_patch() (+12 more)
...
### Community 49 - "SeeingWhatIsRecordedSteps"
Cohesion: 0.06
Nodes (45): GenEntry, GenFlight, Noise, PlacedEntry, Shape, Competition, Entry, Group (+37 more)
...
Cohesion: 0.07
Nodes (36): Bindings, ClassDef, ExpectedRawScore, TargetAssignment, AnyOrder, InOrder, None, ImmutableArray (+28 more)

### Community 56 - ".SeedAsync"
Cohesion: 0.11
Nodes (23): DirectoryNotFoundException, EventStore, IHostedService, ILogger, IServiceScopeFactory, CancellationToken, IConfiguration, Task (+15 more)
...
### Community 58 - ".Exact"
Cohesion: 0.09
Nodes (22): CancellationToken, Task, CancellationToken, Task, CancellationToken, IClock, IEventStore, Task (+14 more)
...
### Community 65 - "FlightResultState"
Cohesion: 0.50
Nodes (4): FlightResultState, NoResult, Pending, Valid

### Community 66 - "Competition"
Cohesion: 0.06
Nodes (36): DateOnly, DateTimeOffset, Defect, IEnumerable, Penalty, PenaltyRecorded, ReflightRuling, Result (+28 more)
...
### Community 69 - "6. Use-case 4: Exceptions to the normal running"
Cohesion: 0.06
Nodes (31): 1. How the API thinks, 2. Endpoint map, 3. Use-case 1: NDC organiser — scores on paper, entered afterwards, 4. Use-case 2: National / international organiser — set up in advance, run live, 5. Use-case 3: Import a realised draw from another system, 6.10 Score-read exceptions, 6.1 Withdrawal (`POST /withdraw-competitor`), 6.2 Annul an entry (`POST /annul-entry`) (+23 more)
...
Cohesion: 0.09
Nodes (35): IQueryHandler, CancellationToken, IClock, IEventStore, Task, ChangePersonClubAffiliation, ChangePersonClubAffiliationHandler, CancellationToken (+27 more)
...
Cohesion: 0.15
Nodes (20): Cut, Halt, OrderKey, Policy, Entry, Strict, Cells, Disq (+12 more)
...
### Community 83 - "RecordCompetitionPenalty"
Cohesion: 0.20
...
Cohesion: 0.08
Nodes (37): CancellationToken, IClock, IEventStore, ImmutableArray, Task, FinaliseCompetition, FinaliseCompetitionHandler, CancellationToken (+29 more)
...
### Community 86 - "MetricDefinition"
Cohesion: 0.15
Nodes (11): IReadOnlyList, MetricDefinition, DeclaredBeforeLaunch, Kind, Name, Precision, Unit, WhenNotRecorded (+3 more)
...
Cohesion: 0.09
Nodes (27): CountLetters, Echo, IServiceProvider, Type, CancellationToken, Dictionary, Fact, InvalidOperationException (+19 more)
...
### Community 92 - ".SeedOpenEntryWithFlight"
Cohesion: 0.23
Nodes (11): CancellationToken, IClock, IEventStore, Task, AmendMeasurementHandler, DateTimeOffset, Fact, FakeEventStore (+3 more)

### Community 93 - ".New"
Cohesion: 0.06
Nodes (45): FieldOp, Id, Competition, DateOnly, CompetitionCreated, DrawAccepted, Competition, Dictionary (+37 more)

### Community 94 - "Result"
Cohesion: 0.14
Nodes (17): CancellationToken, IServiceProvider, Task, Type, Dispatcher, ICommand, IQuery, IQueryHandler (+9 more)
...
Cohesion: 0.13
Nodes (21): Instrument, Kept, ReflightRows, SlotCapture, TapeFileName, Task, ScoresRow, GroupNo (+13 more)
...
Cohesion: 0.09
Nodes (39): Hash, CancellationToken, IClock, IEventStore, Task, PublishClassDefinition, PublishClassDefinitionHandler, CancellationToken (+31 more)
...
### Community 125 - "CaptureMeasurement"
Cohesion: 0.15
Nodes (14): DateTimeOffset, Fact, FakeEventStore, Store, Task, CaptureMeasurementHandlerTests, DateTimeOffset, Fact (+6 more)
...
### Community 138 - "BindParameterDecideTests"
Cohesion: 0.21
...
Cohesion: 0.20
Nodes (11): CompetitionId, Entry, Fact, Group, HttpClient, HttpResponseMessage, IReadOnlyDictionary, List (+3 more)
...
### Community 145 - ".MapQueries"
Cohesion: 0.08
Nodes (36): IQuery, IReadOnlyList, WebApplication, Queries, CancellationToken, IEventStore, IReadOnlyDictionary, Task (+28 more)
...
Cohesion: 0.13
Nodes (16): actual, Actual, Model, model, Fact, Gen, GenOperation, CompetitionModelBasedFoldTests (+8 more)
...
### Community 153 - "GroupConstraint"
Cohesion: 0.08
Nodes (30): MinEnforcement, Shall, Should, GroupConstraint, MinEnforcement, MinValidResults, LastFlight, RateTerm (+22 more)

### Community 154 - ".ScoreCompetition"
Cohesion: 0.10
Nodes (29): RoundOrdinal, ReflightRuling, At, By, CompetitorRef, Reason, Selection, TaskRound (+21 more)
...
### Community 161 - ".SeedOpenEntry"
Cohesion: 0.36
Nodes (6): DateTimeOffset, Fact, FakeEventStore, Store, Task, AnnulEntryHandlerTests
...
### Community 163 - "Soarscore.Application.Queries.CompetitionClasses"
Cohesion: 0.06
Nodes (14): Soarscore.Application.Seeding, Soarscore.Application.Tests.Commands.CompetitionClasses, Soarscore.Application.Tests.Seeding, Soarscore.Application.Queries.CompetitionClasses, Soarscore.Application.Tests.Shared.CompetitionClasses, Soarscore.Application.Shared.CompetitionClasses, Soarscore.Api.Seeding, Soarscore.Application.Tests.Queries.CompetitionClasses (+6 more)
...
Cohesion: 0.08
Nodes (34): HTMLParser, build_range_postback(), collect_comps(), extract_form_fields(), fetch_catalogue(), find_range_select(), _FormScanner, is_comp_id_value() (+26 more)

### Community 167 - ".SeedCompetition"
Cohesion: 0.23
...
Cohesion: 0.05
Nodes (36): PromotionRule, CarryPenalties, Kind, MaxGroupSize, MinGroupSize, TopN, TopPercent, RoundComposition (+28 more)
...
### Community 170 - ".BuildCompetition"
Cohesion: 0.18
...
### Community 174 - "DeclareInstrumentsHandler"
Cohesion: 0.22
...
Cohesion: 0.25
Nodes (10): CancellationToken, IReadOnlyList, Task, FindPeople, FindPeopleHandler, CancellationToken, IReadOnlyList, Task (+2 more)
...
Cohesion: 0.07
Nodes (26): ImmutableArray, SeedF3J, Definition, FlightMetrics, FlyoffTaskD, LandingRows, TaskD, ImmutableArray (+18 more)
...
### Community 180 - "f3k-southern-fling/ladder.py"
Cohesion: 0.20
...
### Community 210 - ".DrawnCompetitionAsync"
Cohesion: 0.23
...
### Community 214 - "FindCompetitions"
Cohesion: 0.19
Nodes (15): CancellationToken, DateOnly, IReadOnlyList, Task, FindCompetitions, FindCompetitionsHandler, CancellationToken, DateOnly (+7 more)
...
### Community 223 - ".New"
Cohesion: 0.05
Nodes (41): EventKind, phaseCount, roundsPerPhase, AdoptedRules, AdoptedAt, Definition, SourceClassId, SourceVersion (+33 more)
...
### Community 238 - "CompetitionResult"
Cohesion: 0.12
...
### Community 243 - ".Apply"
Cohesion: 0.10
Nodes (32): DateTimeOffset, Group, ReflightRuling, TieBreakOutcome, CompetitorWithdrawn, DrawRejected, ProtectionGroupDefined, ProtectionGroupMemberAdded (+24 more)

### Community 244 - "IClassFixture"
Cohesion: 0.13
Nodes (19): IClassFixture, CancellationToken, IClock, IEventStore, Task, RecordReflightRulingHandler, CancellationToken, Entry (+11 more)
...
Cohesion: 0.25
Nodes (6): Microsoft.AspNetCore.OpenApi, Swashbuckle.AspNetCore.SwaggerUI, Microsoft.NET.Sdk.Web, $(SoarscoreTargetFramework), $(SoarscoreTargetFramework), Microsoft.NET.Sdk
...
### Community 250 - "DrawOp"
Cohesion: 0.40
Nodes (5): DrawOp, Accept, Register, Reject, Withdraw

### Community 251 - "AcceptanceFixture"
Cohesion: 0.17
Nodes (12): BeforeTestRun, SemaphoreSlim, AfterTestRun, HttpClient, PostgreSqlContainer, ServiceProvider, Task, AcceptanceFixture (+4 more)

### Community 252 - "FlightModel"
Cohesion: 0.18
...
### Community 254 - "B.1.2 Classification of model aircraft"
Cohesion: 0.11
...
Cohesion: 0.14
Nodes (18): DeclaredInstrument, Instrument, Metric, Scale, ImmutableArray, IReadOnlyDictionary, FlightInterpreter, Intrinsic (+10 more)

### Community 260 - ".DrawnCompetitionAsync"
Cohesion: 0.18
Nodes (14): CancellationToken, IClock, IEventStore, Task, AppendReflightGroupHandler, Competitors, CancellationToken, Fact (+6 more)
...
### Community 269 - "FinaliseValidityPropertyTests"
Cohesion: 0.14
...
### Community 272 - "ClassDefinitionPublished"
Cohesion: 0.17
Nodes (12): DateTimeOffset, ClassDefinitionPublished, ClassDefinitionRetired, DateTimeOffset, Fact, Gen, ClassDefinitionProjectionPropertyTests, ArgumentException (+4 more)
...
### Community 284 - ".BuildOtherEventTypes"
Cohesion: 0.13
Nodes (15): ParameterBinding, At, BoundValue, By, ParameterName, PhaseOrdinal, RoundOrdinal, RulesAmendment (+7 more)

### Community 285 - "F3K.11 DEFINITIONS OF TASKS"
Cohesion: 0.13
...
### Community 287 - ".Rank"
Cohesion: 0.16
Nodes (14): FinalRankingKind, LastPhaseReplaces, SinglePhase, SplitByPromotion, ImmutableArray, ImmutableDictionary, List, RankingEngine (+6 more)
...
### Community 290 - "SeedF5K"
Cohesion: 0.08
Nodes (23): ImmutableArray, SeedF5J, Definition, FlightMetrics, FlyoffTaskD, LandingRows, StartHeightBands, TaskD (+15 more)
...
### Community 305 - "IProjection"
Cohesion: 0.19
Nodes (10): IProjection, IDocumentOperations, IDocumentSession, ClassDefinitionSummaryProjection, FisherClassDefinitionSummaryProjection, MartenClassDefinitionSummaryProjection, DocumentStore, FisherConfig (+2 more)

### Community 306 - ".LoadCurrentAsync"
Cohesion: 0.26
...
Cohesion: 0.03
Nodes (56): IAsyncLifetime, PostgresCatalogueDrawEventStoreTests, SqliteCatalogueDrawEventStoreTests, PostgresCompetitorEventStoreTests, SqliteCompetitorEventStoreTests, PostgresDrawAcceptanceEventStoreTests, SqliteDrawAcceptanceEventStoreTests, PostgresEntryCaptureEventStoreTests (+48 more)
...
Cohesion: 0.10
Nodes (18): IServiceCollection, CancellationToken, IDocumentSessionFactory, IReadOnlyList, Task, DocumentClassLibraryQuery, CancellationToken, IDocumentSessionFactory (+10 more)
...
### Community 325 - "NZ Class M — ALES 200 (Altitude Limited Electric Soaring)"
Cohesion: 0.12
Nodes (17): 1. Pilot assignment to groups (the draw), 2. Launch (`NZ.3.12.1`), 3. Data the timer / helper collects, 4. The task (`NZ.3.12.1 f, g, m, n`), 5. Group score (`NZ.3.12.3`), 6. Round and final score, 7. Re-flights (`NZ.3.12.5 l`), 8. NDC format (`NZ.3.12.7`) — a different scoring pipeline (+9 more)

### Community 326 - ".BuildDispatcher"
Cohesion: 0.49
...
### Community 330 - "ExpectedVersion"
Cohesion: 0.17
Nodes (12): ExpectedVersion, Any, IsAny, IsExact, IsNoStream, NoStream, Version, Kind (+4 more)

### Community 331 - ".ReadStreamAsync"
Cohesion: 0.18
Nodes (12): CancellationToken, Guid, IReadOnlyList, Task, RecordedEvent, CancellationToken, IReadOnlyList, Task (+4 more)
...
### Community 334 - "SystemClock"
Cohesion: 0.12
Nodes (22): IClock, IEventStore, CaptureMeasurementHandler, DateTimeOffset, SystemClock, UtcNow, Fact, Task (+14 more)
...
### Community 336 - "GroupId"
Cohesion: 0.09
Nodes (20): CancellationToken, Task, GroupId, DateTimeOffset, Fact, FakeEventStore, ImmutableArray, Members (+12 more)
...
### Community 338 - ".Of"
Cohesion: 0.14
Nodes (8): AllOf, Children, Fact, ImmutableArray, CaptureMeasurementDecideTests, ArgumentException, Fact, FlightInterpreterTests

### Community 339 - "4 F3J – RADIO CONTROLED THERMAL DURATION GLIDERS"
Cohesion: 0.05
...
### Community 344 - "Soarscore.Application"
Cohesion: 0.07
Nodes (16): Soarscore.Infrastructure.Competitions, Soarscore.Application.Tests.Commands.Entries, Soarscore.Infrastructure.CompetitionClasses, Soarscore.Infrastructure.People, Soarscore.Application.Tests.Shared.People, Soarscore.Application.Queries.People, Soarscore.Infrastructure, Soarscore.Api.Queries (+8 more)

### Community 345 - "Soarscore.Application.Shared.People"
Cohesion: 0.16
Nodes (5): Alias, Soarscore.Application.Shared.People, IReadOnlyList, Type, SoarscoreEventTypes

### Community 346 - "FakeEventStore"
Cohesion: 0.11
Nodes (27): Competition, DateTimeOffset, Fact, FakeEventStore, Group, GroupRef, ImmutableArray, IReadOnlyList (+19 more)

### Community 347 - "F3B.2 RULES FOR MULTI-TASK CONTESTS"
Cohesion: 0.18
...
### Community 348 - "FakePeopleQuery"
Cohesion: 0.47
Nodes (5): Fact, IDispatcher, Task, PersonQueriesTests, FakePeopleQuery

### Community 349 - "F3G.2 RULES FOR MULTI-TASK CONTESTS"
Cohesion: 0.20
...
Cohesion: 0.27
Nodes (4): IReadOnlyList, Score, Fact, ReflightSelectorTests
...
### Community 354 - "RoundingMode"
Cohesion: 0.20
Nodes (8): RoundingMode, Ceiling, HalfUp, Truncate, Gen, IReadOnlyDictionary, FlightSelectorPropertyTests, Metric
...
### Community 360 - "NZ Soaring — Generally Applicable Rules"
Cohesion: 0.25
...
### Community 364 - "DeclaredTeamResult"
Cohesion: 0.08
Nodes (34): DeclaredResult, Aggregate, CompetitorRef, Placing, Promoted, DeclaredTeamContributor, CompetitorRef, Placing (+26 more)
...
Cohesion: 0.04
Nodes (55): ImmutableArray, PhaseDefinition, Drops, Ordinal, Promotion, Rounds, Tasks, TieBreaks (+47 more)
...
### Community 368 - "NZMAA Flying Rules, Section 5: Soaring — March 2024 (extracted source text)"
Cohesion: 0.29
...
### Community 371 - "LookupRow"
Cohesion: 0.15
Nodes (11): Rows, Tape, LookupRow, Rows, Fact, ImmutableArray, IReadOnlyList, TapeCompositionPropertyTests (+3 more)
...
### Community 379 - "TapeCorpus"
Cohesion: 0.50
Nodes (4): ImmutableArray, SeedTape, TapeCorpus, All

### Community 380 - "F3K.9 DEFINITION OF A ROUND"
Cohesion: 0.29
...
### Community 388 - ".AppendAsync"
Cohesion: 0.57
Nodes (4): CancellationToken, Guid, IReadOnlyList, StaleReadEventStore

### Community 389 - ".AppendAsync"
Cohesion: 0.57
Nodes (4): CancellationToken, Guid, IReadOnlyList, StaleReadEventStore

### Community 390 - "CompetitionDecidePropertyTests"
Cohesion: 0.43
Nodes (4): DateOnly, Fact, Gen, CompetitionDecidePropertyTests

### Community 391 - ".Capture_order_does_not_change_the_folded_entry"
Cohesion: 0.33
...
### Community 395 - "Story stub - Teams grain in the parallel-run comparison"
Cohesion: 0.40
Nodes (4): Before starting, Story stub - Teams grain in the parallel-run comparison, What, Why it matters

### Community 396 - "Competitor"
Cohesion: 0.33
Nodes (6): Competitor, CompetitorNumber, Id, PersonRef, RegisteredAt, WithdrawnAt

### Community 397 - "ClassDefinitionSummary"
Cohesion: 0.12
Nodes (20): IDomainEvent, DateTimeOffset, Guid, ClassDefinitionProjection, ClassDefinitionSummary, CancellationToken, IReadOnlyList, Task (+12 more)

### Community 398 - "F3K.10 SCORING"
Cohesion: 0.40
Nodes (5): F3K.10.1 Final score, F3K.10.2 Resolution of a tie, F3K.10.3 Fly-off, F3K.10.4 Team Classification, F3K.10 SCORING

### Community 399 - ".ApplyAsync"
Cohesion: 0.40
Nodes (4): CancellationToken, IEvent, IReadOnlyList, Task

### Community 400 - "MeasuredKind"
Cohesion: 0.33
Nodes (3): MeasuredKind, Flag, Number

### Community 401 - ".FlyReadingsAsync"
Cohesion: 0.33
Nodes (5): FlownReading, Readings, IReadOnlyList, FlownReading, View

### Community 402 - "TaskRoundRecordingHandlerTests"
Cohesion: 0.53
Nodes (3): DateTimeOffset, Fact, TaskRoundRecordingHandlerTests

### Community 403 - "FakeEventStore"
Cohesion: 0.31
Nodes (8): CancellationToken, Guid, IReadOnlyDictionary, IReadOnlyList, List, Task, FakeEventStore, Streams

### Community 406 - "SeedF5L"
Cohesion: 0.33
Nodes (6): ImmutableArray, SeedF5L, Definition, FlightMetrics, FlyoffTaskD, TaskD

### Community 407 - "F3K.4 SAFETY"
Cohesion: 0.40
...
### Community 409 - "Story — CI authoring-drift guard for the seed corpus"
Cohesion: 0.40
Nodes (4): Before starting, Story — CI authoring-drift guard for the seed corpus, What, Why it matters

### Community 411 - "F3K.1 GENERAL"
Cohesion: 0.50
Nodes (4): F3K.1.1 Timekeepers, F3K.1.2 Helper, F3K.1.3 Transmitter Pound, F3K.1 GENERAL

### Community 414 - "AccruedInfo"
Cohesion: 0.67
Nodes (3): AccruedInfo, HasDisqualify, TotalDeduction

### Community 415 - "Actual"
Cohesion: 0.67
Nodes (3): Entry, Actual, Value

### Community 416 - "TaskResultState"
Cohesion: 0.67
Nodes (3): TaskResultState, NoResult, Valid

### Community 417 - "Actual"
Cohesion: 0.67
Nodes (3): Competition, Actual, Value

## Knowledge Gaps
- **2536 isolated node(s):** `context7`, `rider`, `$schema`, `.opencode/plugins/graphify.js`, `Soarscore.Api.Seeding` (+2531 more)
...
- **Why does `ClassDefinition` connect `ClassDefinition` to `PrescribeDrawDecideTests`, `FakeEntryQuery`, `ReflightingForAMissedRoundSteps`, `MetricAbsenceFixtures`, `CatalogueDrawPropertyTests`, `NumberOrParam`, `CompetitorId`, `.Aggregate`, `.HandleAsync`, `CapturingAScoreSteps`, `CompetitionId`, `.CheckLimits`, `TapeLandingScaleProofTests`, `MeasuredValue`, `CompetitionEvent`, `ClosingACompetitionSteps`, `.New`, `GliderscoreFixture`, `ScoringServicePropertyTests`, `Entry`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `Then`, `DrawPhase`, `PenaltyDefinition`, `SeeingWhatIsRecordedSteps`, `When`, `ScoringTeamsSteps`, `ResolvedTask`, `.SeedAsync`, `.Exact`, `LandingTapeDeclaredScaleSteps`, `FakeEventStore`, `.CompetitionAdopting`, `ScoringTeamCommandHandlerTests`, `.BuildDrawnCompetition`, `RecordCompetitionPenalty`, `.HandleAsync`, `MetricDefinition`, `.SeedOpenEntryWithFlight`, `.New`, `ReplayDriver`, `PublishClassDefinition`, `RecordCompetitionPenaltyDecideTests`, `CaptureMeasurement`, `.BuildDrawnCompetition`, `.BuildDrawnCompetition`, `BindParameterDecideTests`, `.MapQueries`, `EntryModelBasedFoldTests`, `FinaliseDecideTests`, `GroupConstraint`, `.ScoreCompetition`, `.SeedCompetition`, `.BuildCompetition`, `DeclareInstrumentsHandler`, `SeedF3K`, `ClassDefinitionValidationPropertyTests`, `.DrawnCompetitionAsync`, `.SeedCompetition`, `IDispatcher`, `.DefinitionWith`, `.New`, `.Apply`, `IClassFixture`, `DeclaredInstrument`, `.DrawnCompetitionAsync`, `ClassDefinitionPublished`, `.SetUpAsync`, `GroupSpotsPropertyTests`, `.BuildOtherEventTypes`, `.Rank`, `SeedF5K`, `BindParameterPropertyTests`, `Corpus.cs`, `.CompareAsync`, `.Apply`, `.BuildDispatcher`, `SystemClock`, `GroupId`, `.Of`, `PublishedClassDefinition`, `FakeEventStore`, `SeedNzF3kNdc`, `SeedF5kNdc`, `DeclaredTeamResult`, `SeedingTheClassCatalogueSteps`, `TaskDefinition`, `CreateCompetitionPropertyTests`, `CompetitionDecidePropertyTests`, `SeedF5L`, `.Load`, `ClassDefinitionEventJsonTests`?**
  _High betweenness centrality (0.126) - this node is a cross-community bridge._
- **Why does `CompetitorId` connect `CompetitorId` to `PrescribeDrawDecideTests`, `Soarscore.Domain.PublishedClassDefinition`, `FakeEntryQuery`, `ReflightingForAMissedRoundSteps`, `CatalogueDrawPropertyTests`, `.SeedWired`, `.BuildCompetition`, `CapturingAScoreSteps`, `CompetitionId`, `ResolvingATieBreakSteps`, `EntryCapturePropertyTests`, `ClosingACompetitionSteps`, `.New`, `ImmutableArray`, `ScoringServicePropertyTests`, `IEventStore`, `Entry`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `Then`, `AmendMeasurementDecideTests`, `FakeClock`, `DrawPhase`, `RecordEntryPenaltyDecideTests`, `SeeingWhatIsRecordedSteps`, `When`, `ScoringTeamsSteps`, `.Exact`, `LandingTapeDeclaredScaleSteps`, `FakeEventStore`, `Competition`, `TeamsDecideTests`, `ScoringTeamCommandHandlerTests`, `.BuildDrawnCompetition`, `RecordCompetitionPenalty`, `.HandleAsync`, `.New`, `DrawAcceptanceDecideTests`, `ReplayDriver`, `ScoringTeamId`, `RecordCompetitionPenaltyDecideTests`, `.BuildDrawnCompetition`, `.BuildDrawnCompetition`, `.SeedScoredTeamCompetition`, `F5JChristchurchTapeReadingExamplesTests`, `.MapQueries`, `GroupConstraint`, `.ScoreCompetition`, `OpenFlightDecideTests`, `.BuildCompetition`, `.DrawnCompetitionAsync`, `.SeedCompetition`, `IDispatcher`, `.DefinitionWith`, `.New`, `DrawProtectionPropertyTests`, `CompetitionResult`, `.Apply`, `IClassFixture`, `AssigningSpotsSteps`, `.DrawnCompetitionAsync`, `.BuildDrawnCompetition`, `.SetUpAsync`, `GroupSpotsPropertyTests`, `.ComputeEntries`, `.BuildGroups`, `PhaseDrawPropertyTests`, `.ScoreWith`, `.Classify`, `ProtectedPair`, `RecordingAGliderscoreFixtureSteps`, `.AddSoarscoreInfrastructure`, `SystemClock`, `GroupId`, `.Of`, `FakeEventStore`, `TapeAmendmentDecideTests`, `DeclaredTeamResult`, `Competitor`, `.FlyReadingsAsync`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `CompetitionId` connect `CompetitionId` to `Soarscore.Domain.PublishedClassDefinition`, `FakeEntryQuery`, `.DrawnCompetitionAsync`, `.SeedScoredTeamCompetition`, `CompetitorId`, `.SeedWired`, `.HandleAsync`, `.MapQueries`, `.SetUpAsync`, `EntryCapturePropertyTests`, `IEventStore`, `Entry`, `OpenFlightDecideTests`, `.SeedCompetition`, `FakeClock`, `DrawPhase`, `AmendMeasurementDecideTests`, `DeclareInstrumentsHandler`, `RecordEntryPenaltyDecideTests`, `ProtectedPair`, `.Exact`, `FakeEventStore`, `.AddSoarscoreInfrastructure`, `Competition`, `ScoringTeamCommandHandlerTests`, `SystemClock`, `GroupId`, `.DrawnCompetitionAsync`, `RecordCompetitionPenalty`, `.HandleAsync`, `.SeedCompetition`, `.Of`, `IDispatcher`, `FakeEventStore`, `.SeedOpenEntryWithFlight`, `.New`, `.New`, `ReplayDriver`, `TapeAmendmentDecideTests`, `PublishClassDefinition`, `IClassFixture`, `.LoadCurrentAsync`, `CaptureMeasurement`?**
...
- **Should `PrescribeDrawDecideTests` be split into smaller, more focused modules?**
...
- **Should `Soarscore.Domain.PublishedClassDefinition` be split into smaller, more focused modules?**
  _Cohesion score 0.04621337755666114 - nodes in this community are weakly interconnected._
