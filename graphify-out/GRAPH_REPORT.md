...
## Corpus Check
- 480 files · ~727,835 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6445 nodes · 16751 edges · 322 communities (308 shown, 14 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1848 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0e11970c`
...
## Communities (322 total, 14 thin omitted)
...
Cohesion: 0.06
Nodes (63): AfterTestRun, BeforeTestRun, CancellationToken, IClock, IEventStore, Task, BindParameterHandler, CancellationToken (+55 more)
...
Cohesion: 0.11
Nodes (34): Path, test_fetch_comp_touches_network_only_through_the_kernel(), check_common_audit_fields(), exact_sleep_factory(), execute_op(), FakeClock, FakeTransport, granular_sleep_factory() (+26 more)
...
Cohesion: 0.10
Nodes (8): Soarscore.Application.Tests.Commands.Entries, Soarscore.Application.Shared.Entries, Soarscore.Application.Commands.Entries, Soarscore.Application.Tests.Queries.Entries, Soarscore.Application.Queries.Entries, Soarscore.Domain, Soarscore.Application.Tests.Shared.Entries, Soarscore.Application.Shared.Competitions
...
Cohesion: 0.12
Nodes (18): IParsable, CancellationToken, IClock, IEventStore, Task, RegisterPerson, RegisterPersonHandler, Guid (+10 more)
...
Cohesion: 0.13
Nodes (27): aggregate, dropped, DropPolicy, ApplyWhenResultsAtLeast, ApplyWhenRoundsCompletedAtLeast, Dimension, DropCount, DropDimension (+19 more)
...
### Community 15 - ".Build"
Cohesion: 0.05
Nodes (61): ICommand, IHttpMaxRequestBodySizeFeature, WebApplication, IReadOnlyList, WebApplication, CancellationToken, IClock, IEventStore (+53 more)

### Community 16 - "Soarscore.Application"
Cohesion: 0.04
Nodes (63): Soarscore.Infrastructure.Competitions, Soarscore.Infrastructure.Tests, Soarscore.Infrastructure.CompetitionClasses, Soarscore.Infrastructure.People, Soarscore.Application.Tests.Queries.Competitions, Soarscore.Application.Queries.People, Soarscore.Infrastructure, Soarscore.Api.Queries (+55 more)
...
Cohesion: 0.07
Nodes (44): ICommandHandler, CancellationToken, IClock, IEventStore, ImmutableArray, Task, FinaliseCompetition, FinaliseCompetitionHandler (+36 more)

### Community 19 - "PhaseDrawn"
Cohesion: 0.10
Nodes (28): PenaltyRecorded, DateTimeOffset, Group, ImmutableArray, Penalty, ReflightRuling, Round, CompetitionEvent (+20 more)
...
Cohesion: 0.09
Nodes (12): Soarscore.Application.Tests, Soarscore.Application.Tests.Commands.CompetitionClasses, Soarscore.Application.Queries.CompetitionClasses, Soarscore.Application.Tests.Shared.CompetitionClasses, Soarscore.Application.Shared.CompetitionClasses, Soarscore.Application.Commands.CompetitionClasses, Soarscore.Application.Tests.Queries.CompetitionClasses, ClassDefinitionStreamId (+4 more)
...
Cohesion: 0.08
Nodes (40): GroupNo, JsonElement, PilotNo, RoundNo, SlotCapture, Task, When, List (+32 more)
...
Cohesion: 0.14
Nodes (19): Amendment, At, By, NewValue, Reason, Penalty, EntryAnnulled, EntryEvent (+11 more)
...
### Community 38 - "When"
Cohesion: 0.13
Nodes (13): RecordEntryPenalty, When, DateTimeOffset, Dictionary, Given, Group, HttpClient, HttpResponseMessage (+5 more)
...
Cohesion: 0.12
Nodes (28): CancellationToken, IEventStore, Task, GetCompetition, GetCompetitionHandler, DateTimeOffset, SystemClock, UtcNow (+20 more)

### Community 41 - "ResolvedTask"
Cohesion: 0.11
Nodes (15): Bindings, ClassDef, ExpectedRawScore, Competition, TaskResolver, AllFlights, ResolvedGroupConstraint, ResolvedTask (+7 more)
...
Cohesion: 0.07
Nodes (33): TargetAssignment, AnyOrder, InOrder, None, ImmutableArray, AllOf, Children, BestNFlights (+25 more)
...
Cohesion: 0.12
Nodes (14): CompositionKind, ChooseFromCatalogue, FixedSequence, MeasuredKind, Flag, Number, ParameterBindingPoint, BeforeFlying (+6 more)
...
Cohesion: 0.11
Nodes (24): IsBogus, CancellationToken, IClock, IEventStore, Task, RegisterCompetitorHandler, DateTimeOffset, Fact (+16 more)
...
### Community 63 - "PromotionRule"
Cohesion: 0.09
Nodes (26): Disqualified, PromotionRule, CarryPenalties, Kind, MaxGroupSize, MinGroupSize, TopN, TopPercent (+18 more)
...
### Community 67 - "DateTimeOffset"
Cohesion: 0.17
Nodes (10): ResolvedSchedule, DateTimeOffset, ImmutableArray, Result, Group, CompetitorRefs, Id, Ordinal (+2 more)

### Community 68 - "PenaltyDefinition"
Cohesion: 0.05
Nodes (60): AccruedInfo, PenaltyDefinition, Accrual, Effects, ExclusionGroups, PenaltyEffectSpec, NormalisationDirection, HigherIsBetter (+52 more)

### Community 69 - "MetricDefinition"
Cohesion: 0.08
Nodes (26): RoundingMode, Ceiling, HalfUp, Truncate, MetricDefinition, DeclaredBeforeLaunch, Kind, Name (+18 more)
...
Cohesion: 0.29
Nodes (9): CancellationToken, IEventStore, Task, RecordEntryPenaltyHandler, DateTimeOffset, Fact, PenaltyRecorded, Task (+1 more)
...
Cohesion: 0.16
Nodes (15): IReadOnlyList, WebApplication, Queries, CancellationToken, Entry, IEventStore, ImmutableArray, IReadOnlyDictionary (+7 more)
...
Cohesion: 0.05
Nodes (39): TaskDefinition, Code, Flights, FlightValidWhen, Group, Metrics, Name, Normalise (+31 more)

### Community 122 - "PhaseDefinition"
Cohesion: 0.11
Nodes (19): ImmutableArray, PhaseDefinition, Drops, Ordinal, Promotion, Rounds, Tasks, Validity (+11 more)
...
Cohesion: 0.12
Nodes (16): IDomainEvent, DateTimeOffset, ClassDefinitionEvent, ClassDefinitionPublished, ClassDefinitionRetired, Fact, ClassDefinitionEventJsonTests, DateTimeOffset (+8 more)
...
### Community 140 - "Person"
Cohesion: 0.19
Nodes (10): DateTimeOffset, Defect, Result, Person, Club, Contact, Id, Name (+2 more)
...
Cohesion: 0.17
Nodes (7): Given, Then, ReplaySteps, Fixture, IReadOnlyList, JsonSerializerOptions, FixtureLoader
...
Cohesion: 0.05
Nodes (45): actual, CompetitorModel, Actual, Model, FlightModel, MeasurementModel, model, Competition (+37 more)
...
### Community 161 - "PhaseAggregatorTests"
Cohesion: 0.36
...
### Community 174 - "Soarscore.Application.Commands.Competitions"
Cohesion: 0.28
Nodes (5): Soarscore.Application.Commands.Competitions, Soarscore.Application.Tests.Shared.Competitions, Soarscore.Api.Commands, Soarscore.Application.Tests.Commands.Competitions, Commands
...
Cohesion: 0.10
Nodes (18): IQuery, CancellationToken, IEventStore, Task, ClassDefinitionLoader, CancellationToken, IEventStore, Task (+10 more)
...
Cohesion: 0.12
Nodes (20): ScoreTerm, ImmutableArray, IReadOnlyDictionary, FlightSelector, IReadOnlyDictionary, FlightResult, FlightResultState, NoResult (+12 more)
...
Cohesion: 0.09
Nodes (26): Bands, Builder, Rows, CapScope, PerFlight, PerTask, NumberOrParam, Band (+18 more)
...
### Community 234 - ".New"
Cohesion: 0.09
Nodes (24): Id, Competition, DateOnly, CompetitionCreated, Role, Competition, Dictionary, Entries (+16 more)
...
### Community 244 - "TaskRound"
Cohesion: 0.18
Nodes (9): Group, Func, TaskRound, Groups, Ordinal, State, TaskRef, TaskRoundState (+1 more)
...
### Community 256 - ".ComputeGroupViews"
Cohesion: 0.36
...
### Community 272 - "ClassDefinitionIngestion"
Cohesion: 0.53
...
### Community 281 - "SeedF3B"
Cohesion: 0.40
Nodes (5): SeedF3B, Definition, TaskA, TaskB, TaskC

### Community 282 - "composite"
Cohesion: 0.50
...
### Community 328 - "Soarscore.Application.Commands.People"
Cohesion: 0.15
...
## Knowledge Gaps
- **1857 isolated node(s):** `context7`, `rider`, `$schema`, `.opencode/plugins/graphify.js`, `$(SoarscoreTargetFramework)` (+1852 more)
...
- **Why does `ClassDefinition` connect `ClassDefinition` to `SeeingWhatIsRecordedSteps`, `.BuildCompetitionWithPenalties`, `FakeEntryQuery`, `.SeedOpenEntryWithFlight`, `WithdrawCompetitorHandler`, `SeedF5K`, `ClassDefinitionPublished`, `CatalogueDrawPropertyTests`, `.CheckLimits`, `Competition.cs`, `.Of`, `PrescribeDrawDecideTests`, `.New`, `.Build`, `EntryId`, `BindParameterPropertyTests`, `PhaseDrawn`, `DrawAcceptanceEventStoreTests`, `EntryModelBasedFoldTests`, `IClassFixture`, `MeasuredValue`, `CompetitionId`, `SeedF3B`, `Then`, `.New`, `GliderscoreFixture`, `.Exact`, `FlightOpened`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `When`, `SystemClock`, `ResolvedTask`, `TaskRoundClosurePropertyTests`, `.SeedOpenEntryWithFlight`, `ScoringVocabulary.cs`, `PublishedClassDefinition`, `RecordingAReflightRulingSteps`, `.SeedCompetition`, `FinaliseDecideTests`, `.SeedOpenEntry`, `.HandleAsync`, `PromotionRule`, `.ScoreCompetition`, `PenaltyDefinition`, `ScoreTerm`, `Corpus.cs`, `.SetUpAsync`, `.CompetitionAdopting`, `MetricDefinition`, `CreateCompetitionPropertyTests`, `ClassDefinitionValidationPropertyTests`, `AdoptedRules`, `.HandleAsync`, `.BuildDrawnCompetition`, `TaskRoundCompleted`, `.BuildDrawnCompetition`, `GroupId`, `.BuildDispatcher`, `.Validate`, `.DrawnCompetitionAsync`, `SeedF3K`, `IStoreFixture`, `CompetitionReplaceTaskRoundPropertyTests`, `.New`, `PublishClassDefinition`, `.SeedCompetition`, `.Decide`, `.BuildDrawnCompetition`, `CompetitionFieldPropertyTests`, `TaskDefinition`, `PhaseDefinition`, `ReflightRule`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `CompetitorId` connect `CompetitorId` to `.ComputeGroupViews`, `SeeingWhatIsRecordedSteps`, `.BuildCompetitionWithPenalties`, `FakeEntryQuery`, `WithdrawCompetitorHandler`, `CatalogueDrawPropertyTests`, `.AddSoarscoreInfrastructure`, `Competition.cs`, `PrescribeDrawDecideTests`, `.Build`, `EntryId`, `CompetitionId`, `PhaseDrawn`, `Competitor`, `DrawAcceptanceEventStoreTests`, `IClassFixture`, `EntryCapturePropertyTests`, `Then`, `.New`, `.Exact`, `Entry`, `.CompareRawGrainAsync`, `AnnulEntryDecideTests`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `When`, `AmendMeasurementDecideTests`, `FlightOpened`, `OpenFlightDecideTests`, `SystemClock`, `TaskRoundRecordingPropertyTests`, `Competition`, `RecordingAReflightRulingSteps`, `.SeedCompetition`, `FinaliseDecideTests`, `.HandleAsync`, `.ScoreCompetition`, `DateTimeOffset`, `MetricDefinition`, `.SetUpAsync`, `EntryEventJsonTests`, `.BuildDrawnCompetition`, `.BuildDrawnCompetition`, `Round`, `GroupId`, `FakeEventStore`, `.DrawnCompetitionAsync`, `DrawAcceptanceDecideTests`, `IStoreFixture`, `.New`, `.SeedCompetition`, `.BuildDrawnCompetition`, `ReflightRule`, `RecordEntryPenaltyDecideTests`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `CompetitionId` connect `CompetitionId` to `.LoadCurrentAsync`, `SeeingWhatIsRecordedSteps`, `FakeEntryQuery`, `.SeedOpenEntryWithFlight`, `WithdrawCompetitorHandler`, `.AddSoarscoreInfrastructure`, `Competition.cs`, `CompetitorId`, `DrawingACatalogueChoicePhaseSteps`, `PrescribeDrawDecideTests`, `.Build`, `EntryId`, `IClassFixture`, `DrawAcceptanceEventStoreTests`, `CompetitionSummary`, `EntryCapturePropertyTests`, `Then`, `.Exact`, `Entry`, `.CompareRawGrainAsync`, `AnnulEntryDecideTests`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `When`, `AmendMeasurementDecideTests`, `SystemClock`, `FlightOpened`, `OpenFlightDecideTests`, `.SeedOpenEntryWithFlight`, `Competition`, `RecordingAReflightRulingSteps`, `.SeedCompetition`, `.SeedOpenEntry`, `.HandleAsync`, `MetricDefinition`, `.SetUpAsync`, `EntryEventJsonTests`, `FakeEventStore`, `GroupId`, `.DrawnCompetitionAsync`, `IStoreFixture`, `.New`, `PublishClassDefinition`, `.Decide`, `RecordEntryPenaltyDecideTests`?**
...
- **Should `Soarscore.Domain.PublishedClassDefinition` be split into smaller, more focused modules?**
  _Cohesion score 0.07346491228070176 - nodes in this community are weakly interconnected._
- **Should `FakeEntryQuery` be split into smaller, more focused modules?**
  _Cohesion score 0.05606523955147808 - nodes in this community are weakly interconnected._
