# Graph Report - Soarscore2  (2026-08-30)

## Corpus Check
- 580 files · ~998,620 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6977 nodes · 18199 edges · 345 communities (335 shown, 10 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 2023 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a8b24eb8`
...
1. `CompetitorId` - 194 edges
2. `CompetitionId` - 192 edges
3. `ClassDefinition` - 183 edges
4. `Soarscore.Domain.PublishedClassDefinition` - 173 edges
5. `Soarscore.Domain.Competitions` - 139 edges
6. `Result` - 119 edges
7. `EntryId` - 104 edges
8. `Soarscore.Domain.People` - 97 edges
9. `Soarscore.SeedData` - 94 edges
10. `Soarscore.Domain` - 91 edges
...
## Communities (345 total, 10 thin omitted)

### Community 0 - ".Select"
Cohesion: 0.15
Nodes (13): CountsFor, Role, ReflightRole, Entitled, Filler, Original, Entry, IReadOnlyList (+5 more)

### Community 1 - "Soarscore.Domain.PublishedClassDefinition"
Cohesion: 0.08
Nodes (7): Soarscore.Domain.Scoring, Soarscore.Domain.Tests, Soarscore.Domain.Competitions, Soarscore.Domain.People, Soarscore.Application.Tests.Queries.Entries, Soarscore.Domain.Entries, Soarscore.Domain.PublishedClassDefinition
...
Cohesion: 0.07
Nodes (20): Soarscore.Application.Shared.Entries, Soarscore.Application.Commands.Competitions, Soarscore.Application.Commands.Entries, Soarscore.Application.Shared.People, Soarscore.Application.Commands.People, Soarscore.Application.Tests.Queries.Competitions, Soarscore.Api.Commands, Soarscore.Acceptance.Tests.Support (+12 more)
...
### Community 12 - "CompetitionSummary"
Cohesion: 0.07
...
Cohesion: 0.12
Nodes (26): aggregate, DropPolicy, ApplyWhenResultsAtLeast, ApplyWhenRoundsCompletedAtLeast, Dimension, DropCount, dropped, ImmutableArray (+18 more)

### Community 14 - ".New"
Cohesion: 0.10
Nodes (22): ImmutableArray, Round, PhaseDrawn, Store, Competition, DateTimeOffset, Fact, CompetitionFoldTests (+14 more)

### Community 15 - ".BuildDispatcher"
Cohesion: 0.10
Nodes (29): IQuery, IQueryHandler, CancellationToken, IClock, IEventStore, Task, RenamePerson, RenamePersonHandler (+21 more)

### Community 16 - "Soarscore.Application"
Cohesion: 0.06
Nodes (24): Soarscore.Infrastructure.Competitions, Soarscore.Application.Tests.Commands.Entries, Soarscore.Infrastructure.Tests, Soarscore.Infrastructure.CompetitionClasses, Soarscore.Infrastructure.People, Soarscore.Application.Queries.People, Soarscore.Infrastructure, Soarscore.Application.Tests.Shared.Entries (+16 more)

### Community 17 - "EntryId"
Cohesion: 0.09
Nodes (17): Guid, EntryId, Dictionary, Given, Group, HttpClient, HttpResponseMessage, List (+9 more)

### Community 18 - "CompetitionId"
Cohesion: 0.08
Nodes (41): ICommandHandler, CancellationToken, IClock, IEventStore, ImmutableArray, Task, FinaliseCompetition, FinaliseCompetitionHandler (+33 more)

### Community 19 - "CompetitionEvent"
Cohesion: 0.10
Nodes (27): PenaltyRecorded, DateTimeOffset, Group, Penalty, ReflightRuling, CompetitionEvent, CompetitorRegistered, CompetitorWithdrawn (+19 more)
...
Cohesion: 0.09
Nodes (18): CancellationToken, Entry, IEventStore, IReadOnlyDictionary, Task, EntryCollector, CancellationToken, IReadOnlyList (+10 more)
...
Cohesion: 0.09
Nodes (9): Soarscore.Application.Tests, Soarscore.Application.Tests.Commands.CompetitionClasses, Soarscore.Application.Queries.CompetitionClasses, Soarscore.Application.Tests.Shared.CompetitionClasses, Soarscore.Application.Shared.CompetitionClasses, Soarscore.Application.Commands.CompetitionClasses, Soarscore.Application.Tests.Queries.CompetitionClasses, Fact (+1 more)
...
Cohesion: 0.09
Nodes (21): DateOnly, Defect, Penalty, ReflightRuling, Result, TaskRoundCoordinate, Competition, AdoptedRules (+13 more)

### Community 32 - "Entry"
Cohesion: 0.07
Nodes (34): DateTimeOffset, Func, ImmutableArray, Penalty, PenaltyRecorded, Result, Annulment, At (+26 more)
...
Cohesion: 0.17
Nodes (17): KeyCollection, IEventStore, Competition, Dictionary, Entry, HashSet, HttpClient, IEnumerable (+9 more)

### Community 35 - "FlightOpened"
Cohesion: 0.20
Nodes (12): DateTimeOffset, Penalty, EntryAnnulled, EntryEvent, FlightOpened, MeasurementAmended, MeasurementCaptured, PenaltyRecorded (+4 more)
...
### Community 38 - "Then"
Cohesion: 0.12
Nodes (12): Then, DateTimeOffset, Dictionary, Given, Group, HttpClient, HttpResponseMessage, IReadOnlyList (+4 more)
...
Cohesion: 0.08
Nodes (35): GenEntry, GenFlight, Noise, PlacedEntry, Shape, Competition, Entry, ImmutableArray (+27 more)

### Community 47 - ".SeedOpenEntryWithFlight"
Cohesion: 0.15
Nodes (17): CancellationToken, IClock, IEventStore, Task, CaptureMeasurementHandler, Competition, TaskResolver, CancellationToken (+9 more)

### Community 48 - "DateTimeOffset"
Cohesion: 0.07
Nodes (35): ResolvedSchedule, Group, DateTimeOffset, Func, ImmutableArray, Finalisation, At, By (+27 more)

### Community 49 - "ScoringServicePropertyTests"
Cohesion: 0.14
...
### Community 59 - "Entries/TestDoubles.cs"
Cohesion: 0.11
...
Cohesion: 0.05
Nodes (39): MetricDefinition, DeclaredBeforeLaunch, Kind, Name, Precision, Unit, ImmutableArray, SeedF3K (+31 more)
...
### Community 63 - "FlagOrParam"
Cohesion: 0.17
Nodes (11): JsonSerializerOptions, ClassDefinitionHashing, Type, FlagOrParam, Literal, Ref, JsonSerializerOptions, Utf8JsonReader (+3 more)
...
Cohesion: 0.32
Nodes (10): PenaltyDefinition, Accrual, Effects, ExclusionGroups, PenaltyEffectSpec, RecordedPenalty, SelectedFlights, TaskResult (+2 more)

### Community 69 - "BindParameterDecideTests"
Cohesion: 0.21
...
Cohesion: 0.22
Nodes (14): IReadOnlyList, WebApplication, Queries, CancellationToken, IEventStore, Task, GetTaskRoundRecording, GetTaskRoundRecordingHandler (+6 more)
...
### Community 77 - ".Build"
Cohesion: 0.05
Nodes (51): ICommand, IHttpMaxRequestBodySizeFeature, WebApplication, Commands, IReadOnlyList, WebApplication, Composition, CancellationToken (+43 more)
...
### Community 84 - ".SeedScoredGroup"
Cohesion: 0.12
Nodes (21): CancellationToken, Entry, IEventStore, ImmutableArray, IReadOnlyDictionary, IReadOnlyList, Task, CompetitorTaskResultView (+13 more)

### Community 85 - ".CreateDispatcher"
Cohesion: 0.19
Nodes (15): IDispatcher, IReadOnlyList, PrescribedGroup, PrescribedRound, CancellationToken, Fact, Task, DrawAcceptanceEventStoreTests (+7 more)
...
Cohesion: 0.19
Nodes (16): CancellationToken, IClock, IEventStore, Task, RecordReflightRuling, RecordReflightRulingHandler, DateTimeOffset, SystemClock (+8 more)
...
Cohesion: 0.11
Nodes (19): Comparator, EqualTo, GreaterOrEqual, GreaterThan, LessOrEqual, LessThan, ImmutableArray, AllOf (+11 more)
...
### Community 96 - "Competition"
Cohesion: 0.16
Nodes (10): CompetitorRef, Competition, DateTimeOffset, Fact, InlineData, Theory, DrawAcceptanceDecideTests, Dictionary (+2 more)
...
Cohesion: 0.17
Nodes (11): Competitor, CompetitorNumber, Id, PersonRef, RegisteredAt, WithdrawnAt, DateTimeOffset, Fact (+3 more)
...
Cohesion: 0.08
Nodes (26): DrawOp, FieldOp, Op, Fact, Gen, Index, CompetitionFieldPropertyTests, FieldOp (+18 more)
...
Cohesion: 0.06
Nodes (42): DateTimeOffset, IClock, UtcNow, CancellationToken, IEventStore, Task, ClassDefinitionLoader, ClassDefinitionProjection (+34 more)
...
### Community 145 - "Design decisions — settled here, do not relitigate"
Cohesion: 0.09
...
Cohesion: 0.05
Nodes (42): actual, CompetitorModel, Actual, Model, FlightModel, MeasurementModel, model, Fact (+34 more)
...
Cohesion: 0.08
Nodes (25): ImmutableArray, PhaseDefinition, Drops, Ordinal, Promotion, Rounds, Tasks, Validity (+17 more)
...
Cohesion: 0.10
Nodes (18): CompositionKind, ChooseFromCatalogue, FixedSequence, DropDimension, ByRound, ByTask, PenaltyAccrual, OncePerAttempt (+10 more)
...
Cohesion: 0.09
Nodes (32): IParsable, CancellationToken, IClock, IEventStore, Task, RegisterCompetitor, RegisterCompetitorHandler, CancellationToken (+24 more)
...
Cohesion: 0.09
Nodes (30): TargetAssignment, AnyOrder, InOrder, None, BestNFlights, Count, RankByMetric, Targets (+22 more)
...
Cohesion: 0.12
Nodes (13): CompetitionProjection, AdoptedRules, AdoptedAt, Definition, SourceClassId, SourceVersion, Fact, Fact (+5 more)
...
### Community 210 - "Story — Model tie-break policy as class data"
Cohesion: 0.11
Nodes (18): Adoption checks 17–19 (the inventory grows by three), Decisions (pre-answered during flesh-out 2026-08-30; D1, D8, D10 and the, Engine design, Invariant T — the property, named here per CLAUDE.md (goes verbatim into, Known traps (pre-answered — do not reopen inside this story), Out of scope (restated for sign-off), Story invariant for sign-off, Story — Model tie-break policy as class data (+10 more)

### Community 211 - "Result"
Cohesion: 0.09
Nodes (21): IEndpointRouteBuilder, IEventStore, IResult, EndpointRouteBuilderExtensions, Func, IReadOnlyList, Result, Code (+13 more)
...
### Community 214 - ".BuildCompetition"
Cohesion: 0.18
...
### Community 244 - "CaptureMeasurementDecideTests"
Cohesion: 0.32
...
### Community 259 - "PrescribeDrawPropertyTests"
Cohesion: 0.29
...
### Community 287 - ".Rank"
Cohesion: 0.13
Nodes (17): Disqualified, FinalRankingKind, LastPhaseReplaces, SinglePhase, SplitByPromotion, ImmutableArray, RankingEngine, CompetitionResult (+9 more)
...
### Community 293 - "ScoringResultTypes.cs"
Cohesion: 0.22
Nodes (8): ImmutableArray, PenaltyApplication, PhaseScores, PreDropAggregate, RawPenaltyApplication, TaskResultState, NoResult, Valid
...
### Community 295 - "f3k-southern-fling/ladder.py"
Cohesion: 0.20
...
### Community 301 - "DecideFlightModel"
Cohesion: 0.32
...
### Community 304 - "Amendment"
Cohesion: 0.25
Nodes (8): Amendment, At, By, NewValue, Reason, DateTimeOffset, Gen, MeasurementDigestPropertyTests

### Community 305 - "PenaltyEnginePropertyTests"
Cohesion: 0.43
Nodes (4): Fact, Gen, ImmutableArray, PenaltyEnginePropertyTests

### Community 306 - ".New"
Cohesion: 0.11
Nodes (16): DateOnly, CompetitionCreated, Fact, InlineData, Theory, CompetitionDecideTests, Competition, Actual (+8 more)
...
Cohesion: 0.05
Nodes (38): IAsyncLifetime, PostgresDrawAcceptanceEventStoreTests, SqliteDrawAcceptanceEventStoreTests, PostgresEntryCaptureEventStoreTests, SqliteEntryCaptureEventStoreTests, DateTimeOffset, NameSearchTests, PostgresNameSearchTests (+30 more)

### Community 312 - "ParameterBindingPoint"
Cohesion: 0.33
Nodes (5): ParameterBindingPoint, BeforeFlying, CompetitionSetup, PerRound, Params

### Community 313 - "RoundingMode"
Cohesion: 0.29
Nodes (5): RoundingMode, Ceiling, HalfUp, Truncate, M

### Community 317 - "Mutation"
Cohesion: 0.29
...
Cohesion: 0.21
Nodes (9): Builder, Rows, LookupRow, LookupTerm, MetricRef, Rows, ImmutableArray, Rows (+1 more)

### Community 319 - "ReflightDestinationPropertyTests"
Cohesion: 0.43
Nodes (3): DateTimeOffset, Fact, ReflightDestinationPropertyTests

### Community 320 - "NZ ALES — Generally Applicable Rules"
Cohesion: 0.33
...
### Community 321 - "EntryEventJsonTests"
Cohesion: 0.47
...
### Community 324 - "Story — Permitted scopes on PenaltyDefinition (adoption-time scope hardening)"
Cohesion: 0.40
Nodes (4): Before starting, Story — Permitted scopes on PenaltyDefinition (adoption-time scope hardening), What, Why it matters

### Community 325 - "RulesAmendment"
Cohesion: 0.40
Nodes (5): RulesAmendment, At, By, Definition, Reason

### Community 326 - "SeedNzMAles200"
Cohesion: 0.50
...
Cohesion: 0.12
Nodes (22): CancellationToken, Guid, IReadOnlyList, Task, RecordedEvent, IDomainEvent, CancellationToken, Guid (+14 more)

### Community 332 - "SeedNzMNdc"
Cohesion: 0.50
Nodes (3): SeedNzMNdc, Definition, TaskD

### Community 333 - "2.5 CONTESTS"
Cohesion: 0.67
Nodes (3): 2.5.1 Contestants Meeting., 2.5.2 Round Identification., 2.5 CONTESTS

### Community 334 - "NumberOrParam"
Cohesion: 0.30
Nodes (8): Bands, NumberOrParam, Band, PiecewiseTerm, Bands, MetricRef, Origin, Bands
...
## Knowledge Gaps
- **2066 isolated node(s):** `context7`, `rider`, `$schema`, `.opencode/plugins/graphify.js`, `$(SoarscoreTargetFramework)` (+2061 more)
...
- **Why does `ClassDefinition` connect `ClassDefinition` to `FakeEntryQuery`, `ReflightingForAMissedRoundSteps`, `GetCompetition`, `CatalogueDrawPropertyTests`, `.CheckLimits`, `.BuildCompetition`, `.New`, `.BuildDispatcher`, `EntryId`, `CompetitionId`, `CompetitionEvent`, `MeasuredValue`, `.HandleAsync`, `ClosingACompetitionSteps`, `.New`, `GliderscoreFixture`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `Then`, `.Exact`, `.Of`, `.SeedOpenEntryWithFlight`, `ScoringServicePropertyTests`, `When`, `.SeedCompetition`, `FinaliseDecideTests`, `.ScoreGroup`, `.SeedOpenEntry`, `MetricDefinition`, `.ScoreCompetition`, `RecordEntryPenalty`, `PenaltyDefinition`, `BindParameterDecideTests`, `.SetUpAsync`, `.CompetitionAdopting`, `.Build`, `.BuildDrawnCompetition`, `.SeedOpenEntryWithFlight`, `.SeedScoredGroup`, `.CreateDispatcher`, `.Validate`, `SystemClock`, `Competition`, `CompetitionReplaceTaskRoundPropertyTests`, `PublishClassDefinition`, `.SeedCompetition`, `CompetitionFieldPropertyTests`, `PrescribeDrawDecideTests`, `.BuildDrawnCompetition`, `Soarscore.SeedData`, `.SeedCompetition`, `ClassDefinitionPublished`, `.AppendAsync`, `EntryModelBasedFoldTests`, `IStoreFixture`, `TaskDefinition`, `PhaseDefinition`, `BindParameterPropertyTests`, `CompetitorId`, `ClassDefinitionValidationPropertyTests`, `AdoptedRules`, `.BuildCompetition`, `SeeingWhatIsRecordedSteps`, `PrescribeDrawPropertyTests`, `.BaseDefinition`, `SeedF5K`, `.DrawnCompetitionAsync`, `.SeedCompetition`, `.TwoRoundCompetitionAsync`, `.Seed`, `.Rank`, `PromotionRule`, `SeedF3J`, `SeedF5J`, `.New`, `RulesAmendment`, `SeedNzMAles200`, `CreateCompetitionPropertyTests`, `SeedNzMNdc`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `CompetitorId` connect `CompetitorId` to `Soarscore.Domain.PublishedClassDefinition`, `FakeEntryQuery`, `ReflightingForAMissedRoundSteps`, `PrescribeDrawPropertyTests`, `.SeedCompetition`, `GetCompetition`, `CatalogueDrawPropertyTests`, `.BuildCompetition`, `CompetitionSummary`, `.New`, `.DrawnCompetitionAsync`, `CompetitionId`, `CompetitionEvent`, `EntryId`, `GroupId`, `.TwoRoundCompetitionAsync`, `IStoreFixture`, `EntryCapturePropertyTests`, `ClosingACompetitionSteps`, `.New`, `Competition`, `Entry`, `.Rank`, `IEventStore`, `AnnulEntryDecideTests`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `Then`, `AmendMeasurementDecideTests`, `.Exact`, `FlightOpened`, `OpenFlightDecideTests`, `PhaseDefinition`, `TaskRoundRecordingPropertyTests`, `DateTimeOffset`, `ScoringServicePropertyTests`, `FindEntries`, `.New`, `When`, `.SeedCompetition`, `FinaliseDecideTests`, `ReflightDestinationPropertyTests`, `.ScoreCompetition`, `RecordEntryPenalty`, `EntryEventJsonTests`, `.SetUpAsync`, `.Build`, `.BuildDrawnCompetition`, `.ComputeEntries`, `.SeedScoredGroup`, `.CreateDispatcher`, `.BuildCompetition`, `SystemClock`, `Competition`, `FakeEventStore`, `SeeingWhatIsRecordedSteps`, `.SeedCompetition`, `.BuildDrawnCompetition`, `CaptureMeasurementDecideTests`, `PrescribeDrawDecideTests`, `.BuildDrawnCompetition`, `RecordEntryPenaltyDecideTests`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `CompetitionId` connect `CompetitionId` to `Soarscore.Domain.PublishedClassDefinition`, `FakeEntryQuery`, `.LoadCurrentAsync`, `GetCompetition`, `ReflightingForAMissedRoundSteps`, `.SeedCompetition`, `DrawingACatalogueChoicePhaseSteps`, `CompetitionSummary`, `.AppendAsync`, `.DrawnCompetitionAsync`, `EntryId`, `.SeedCompetition`, `.TwoRoundCompetitionAsync`, `GroupId`, `.Seed`, `IStoreFixture`, `EntryCapturePropertyTests`, `.HandleAsync`, `ClosingACompetitionSteps`, `Competition`, `Entry`, `IEventStore`, `AnnulEntryDecideTests`, `ReflightingAGroupSteps`, `AcceptingTheDrawSteps`, `Then`, `AmendMeasurementDecideTests`, `.Exact`, `FlightOpened`, `OpenFlightDecideTests`, `CompetitorId`, `.SeedOpenEntryWithFlight`, `FindEntries`, `.New`, `When`, `.SeedCompetition`, `.SeedOpenEntry`, `EntryEventJsonTests`, `.SetUpAsync`, `.Build`, `.SeedOpenEntryWithFlight`, `.SeedScoredGroup`, `.CreateDispatcher`, `SystemClock`, `FakeEventStore`, `SeeingWhatIsRecordedSteps`, `PublishClassDefinition`, `CaptureMeasurementDecideTests`, `RecordEntryPenaltyDecideTests`?**
...
- **Should `Soarscore.Domain.PublishedClassDefinition` be split into smaller, more focused modules?**
  _Cohesion score 0.07741147741147741 - nodes in this community are weakly interconnected._
